...
CREATE TABLE `property` (
  ...
  KEY `fk_property_key_vnum` (`key_vnum`),
  KEY `fk_property_entrance` (`entrance`),
  CONSTRAINT `fk_property_entrance` FOREIGN KEY (`entrance`) REFERENCES `room` (`vnum`),
  CONSTRAINT `fk_property_key_vnum` FOREIGN KEY (`key_vnum`) REFERENCES `obj` (`vnum`),
