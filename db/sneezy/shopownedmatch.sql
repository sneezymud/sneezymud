...
CREATE TABLE `shopownedmatch` (
  ...
  `match_str` varchar(255) NOT NULL,
  `profit_buy` double DEFAULT NULL,
  `profit_sell` double DEFAULT NULL,
  `max_num` int(11) DEFAULT NULL,
  PRIMARY KEY (`shop_nr`,`match_str`),
  CONSTRAINT `fk_shopownedmatch_shop_nr` FOREIGN KEY (`shop_nr`) REFERENCES `shopowned` (`shop_nr`) ON DELETE CASCADE
