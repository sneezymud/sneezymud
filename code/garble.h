...
#define SPEECH_FLAG_NONVERBAL (SPEECH_FLAG_COMMUNE|SPEECH_FLAG_SIGN|SPEECH_FLAG_WRITE|SPEECH_FLAG_WIZNET)
#define SPEECH_FLAG_LOCAL     (SPEECH_FLAG_SAY|SPEECH_FLAG_ASK|SPEECH_FLAG_WHISPER|SPEECH_FLAG_SIGN)
#define SPEECH_FLAG_DIRECTED  (SPEECH_FLAG_TELL|SPEECH_FLAG_ASK|SPEECH_FLAG_WHISPER)
#define SPEECH_FLAG_NONWRITE  (SPEECH_FLAG_SAY|SPEECH_FLAG_ASK|SPEECH_FLAG_WHISPER|SPEECH_FLAG_TELL|SPEECH_FLAG_GROUPTELL|SPEECH_FLAG_COMMUNE|SPEECH_FLAG_SIGN|SPEECH_FLAG_SHOUT|SPEECH_FLAG_WIZNET)
