...
class SString : public CxxTest::TestSuite {
  public:
    ...
    void testTrim() {
      TS_ASSERT_EQUALS(sstring("LOREM IpSum dolor SIT aMeT").trim(),
    ...
    void testTrimLeft() {
      TS_ASSERT_EQUALS(sstring("LOREM IpSum dolor SIT aMeT").trimLeft(),
        "LOREM IpSum dolor SIT aMeT");
    ...
    void testTrimRight() {
      TS_ASSERT_EQUALS(sstring("LOREM IpSum dolor SIT aMeT").trimRight(),
        "LOREM IpSum dolor SIT aMeT");
      TS_ASSERT_EQUALS(
    ...
    void testDropLastWord() {
      TS_ASSERT_EQUALS(sstring("LOREM IpSum dolor SIT aMeT").dropLastWord(),
    ...
    void testLastWord() {
      TS_ASSERT_EQUALS(sstring("LOREM IpSum dolor SIT aMeT").lastWord(),
        "aMeT");
