...
int TBeing::doOrient() {
  ...
  act("You prepare your mount for a devastating charge.", FALSE, this, NULL,
    NULL, TO_CHAR);
  act("$n prepares $s his mount for a devastating charge!", FALSE, this, NULL,
    NULL, TO_ROOM);
