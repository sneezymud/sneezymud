...
bool TComponent::willMerge(TMergeable* tm) {
  ...
  if (!(tComp = dynamic_cast<TComponent*>(tm)) || tComp == this ||
...
void assign_component_placement() {
  ...
  component_placement.push_back(compPlace(BRIDGE_ROOM, -1, Mob::NONE,
    Obj::ITEM_RAINBOW_BRIDGE1, CACT_PLACE, 1, 100, HOUR_SUNRISE, HOUR_SUNSET,
    -1, -1, -1, -1, 1 << Weather::RAINY | 1 << Weather::LIGHTNING,
    "<p>$p slowly shimmers into existence!<1>", ""));
  component_placement.push_back(compPlace(BRIDGE_ROOM, -1, Mob::NONE,
    Obj::ITEM_RAINBOW_BRIDGE1, CACT_REMOVE, 1, 100, -1, -1, -1, -1, -1, -1,
    ~(1 << Weather::RAINY | 1 << Weather::LIGHTNING),
    "<p>$p slowly fades out of existence!<1>", ""));
  component_placement.push_back(compPlace(BRIDGE_ROOM, -1, Mob::NONE,
    Obj::ITEM_RAINBOW_BRIDGE1, CACT_REMOVE, 1, 100, HOUR_SUNSET, -1, -1, -1, -1,
    -1, -1, "<p>$p slowly fades out of existence!<1>", ""));
  // rainbow bridge 2
  component_placement.push_back(compPlace(BRIDGE_ROOM2, -1, Mob::NONE,
    Obj::ITEM_RAINBOW_BRIDGE2, CACT_PLACE, 1, 100, HOUR_SUNRISE, HOUR_SUNSET,
    -1, -1, -1, -1, 1 << Weather::RAINY | 1 << Weather::LIGHTNING,
    "<p>$p slowly shimmers into existence!<1>", ""));
  component_placement.push_back(compPlace(BRIDGE_ROOM2, -1, Mob::NONE,
    Obj::ITEM_RAINBOW_BRIDGE2, CACT_REMOVE, 1, 100, -1, -1, -1, -1, -1, -1,
    ~(1 << Weather::RAINY | 1 << Weather::LIGHTNING),
    "<p>$p slowly fades out of existence!<1>", ""));
  component_placement.push_back(compPlace(BRIDGE_ROOM2, -1, Mob::NONE,
    Obj::ITEM_RAINBOW_BRIDGE2, CACT_REMOVE, 1, 100, HOUR_SUNSET, -1, -1, -1, -1,
    -1, -1, "<p>$p slowly fades out of existence!<1>", ""));

  // cheval
  component_placement.push_back(
    compPlace(6101, -1, Mob::NONE, COMP_CHEVAL, CACT_PLACE, 9999, 65,
      HOUR_DAY_BEGIN, HOUR_DAY_END, -1, -1, -1, -1, (1 << Weather::RAINY),
      "<k>$p stupidly dives into the ground and lands on its back.<1>", ""));
  component_placement.push_back(compPlace(6101, -1, Mob::NONE, COMP_CHEVAL,
    CACT_REMOVE, -1, 100, HOUR_DAY_END, -1, -1, -1, -1, -1, -1,
    "<k>$p skitters away into the night.<1>", ""));
  component_placement.push_back(compPlace(6101, -1, Mob::NONE, COMP_CHEVAL,
    CACT_REMOVE, -1, 100, -1, -1, -1, -1, -1, -1, ~(1 << Weather::RAINY),
    "<k>$p flips over and flies away.<1>", ""));
  component_placement.push_back(
    compPlace(6104, -1, Mob::NONE, COMP_CHEVAL, CACT_PLACE, 9999, 65,
      HOUR_DAY_BEGIN, HOUR_DAY_END, -1, -1, -1, -1, (1 << Weather::RAINY),
      "<k>$p stupidly dives into the ground and lands on its back.<1>", ""));
  component_placement.push_back(compPlace(6104, -1, Mob::NONE, COMP_CHEVAL,
    CACT_REMOVE, -1, 100, HOUR_DAY_END, -1, -1, -1, -1, -1, -1,
    "<k>$p skitters away into the night.<1>", ""));
  component_placement.push_back(compPlace(6104, -1, Mob::NONE, COMP_CHEVAL,
    CACT_REMOVE, -1, 100, -1, -1, -1, -1, -1, -1, ~(1 << Weather::RAINY),
    "<k>$p flips over and flies away.<1>", ""));
  component_placement.push_back(
    compPlace(6108, -1, Mob::NONE, COMP_CHEVAL, CACT_PLACE, 9999, 65,
      HOUR_DAY_BEGIN, HOUR_DAY_END, -1, -1, -1, -1, (1 << Weather::RAINY),
      "<k>$p stupidly dives into the ground and lands on its back.<1>", ""));
  component_placement.push_back(compPlace(6108, -1, Mob::NONE, COMP_CHEVAL,
    CACT_REMOVE, -1, 100, HOUR_DAY_END, -1, -1, -1, -1, -1, -1,
    "<k>$p skitters away into the night.<1>", ""));
  component_placement.push_back(compPlace(6108, -1, Mob::NONE, COMP_CHEVAL,
    CACT_REMOVE, -1, 100, -1, -1, -1, -1, -1, -1, ~(1 << Weather::RAINY),
    "<k>$p flips over and flies away.<1>", ""));
  component_placement.push_back(
    compPlace(6200, -1, Mob::NONE, COMP_CHEVAL, CACT_PLACE, 9999, 65,
      HOUR_DAY_BEGIN, HOUR_DAY_END, -1, -1, -1, -1, (1 << Weather::RAINY),
      "<k>$p stupidly dives into the ground and lands on its back.<1>", ""));
  component_placement.push_back(compPlace(6200, -1, Mob::NONE, COMP_CHEVAL,
    CACT_REMOVE, -1, 100, HOUR_DAY_END, -1, -1, -1, -1, -1, -1,
    "<k>$p skitters away into the night.<1>", ""));
  component_placement.push_back(compPlace(6200, -1, Mob::NONE, COMP_CHEVAL,
    CACT_REMOVE, -1, 100, -1, -1, -1, -1, -1, -1, ~(1 << Weather::RAINY),
  ...
  component_placement.push_back(
    compPlace(6205, -1, Mob::NONE, COMP_CHEVAL, CACT_PLACE, 9999, 65,
      HOUR_DAY_BEGIN, HOUR_DAY_END, -1, -1, -1, -1, (1 << Weather::RAINY),
      "<k>$p stupidly dives into the ground and lands on its back.<1>", ""));
  component_placement.push_back(compPlace(6205, -1, Mob::NONE, COMP_CHEVAL,
    CACT_REMOVE, -1, 100, HOUR_DAY_END, -1, -1, -1, -1, -1, -1,
    "<k>$p skitters away into the night.<1>", ""));
  component_placement.push_back(compPlace(6205, -1, Mob::NONE, COMP_CHEVAL,
    CACT_REMOVE, -1, 100, -1, -1, -1, -1, -1, -1, ~(1 << Weather::RAINY),
  ...
  component_placement.push_back(
    compPlace(6211, -1, Mob::NONE, COMP_CHEVAL, CACT_PLACE, 9999, 65,
      HOUR_DAY_BEGIN, HOUR_DAY_END, -1, -1, -1, -1, (1 << Weather::RAINY),
      "<k>$p stupidly dives into the ground and lands on its back.<1>", ""));
  component_placement.push_back(compPlace(6211, -1, Mob::NONE, COMP_CHEVAL,
    CACT_REMOVE, -1, 100, HOUR_DAY_END, -1, -1, -1, -1, -1, -1,
    "<k>$p skitters away into the night.<1>", ""));
  component_placement.push_back(compPlace(6211, -1, Mob::NONE, COMP_CHEVAL,
    CACT_REMOVE, -1, 100, -1, -1, -1, -1, -1, -1, ~(1 << Weather::RAINY),
    "<k>$p flips over and flies away.<1>", ""));
  component_placement.push_back(
    compPlace(6220, -1, Mob::NONE, COMP_CHEVAL, CACT_PLACE, 9999, 65,
      HOUR_DAY_BEGIN, HOUR_DAY_END, -1, -1, -1, -1, (1 << Weather::RAINY),
      "<k>$p stupidly dives into the ground and lands on its back.<1>", ""));
  component_placement.push_back(compPlace(6220, -1, Mob::NONE, COMP_CHEVAL,
    CACT_REMOVE, -1, 100, HOUR_DAY_END, -1, -1, -1, -1, -1, -1,
    "<k>$p skitters away into the night.<1>", ""));
  component_placement.push_back(compPlace(6220, -1, Mob::NONE, COMP_CHEVAL,
    CACT_REMOVE, -1, 100, -1, -1, -1, -1, -1, -1, ~(1 << Weather::RAINY),
  ...
  // color spray
  component_placement.push_back(
    compPlace(11328, -1, Mob::NONE, COMP_COLOR_SPRAY, CACT_PLACE, 9999, 65,
      HOUR_DAY_BEGIN, HOUR_DAY_END, -1, -1, -1, -1, (1 << Weather::RAINY),
      "<B>A small stone nearby begins to sparkle and glow from the kiss of a "
      "rainbow.<1>",
      ""));
  component_placement.push_back(compPlace(11328, -1, Mob::NONE,
    COMP_COLOR_SPRAY, CACT_REMOVE, -1, 100, HOUR_DAY_END, -1, -1, -1, -1, -1,
    -1, "<b>$p dulls and fades away as the night approaches.<1>", ""));
  component_placement.push_back(compPlace(11328, -1, Mob::NONE,
    COMP_COLOR_SPRAY, CACT_REMOVE, -1, 100, -1, -1, -1, -1, -1, -1,
    ~(1 << Weather::RAINY), "<b>$p dulls and fades away.<1>", ""));

  component_placement.push_back(
    compPlace(1008, 1015, Mob::NONE, COMP_COLOR_SPRAY, CACT_PLACE, 9999, 65,
      HOUR_DAY_BEGIN, HOUR_DAY_END, -1, -1, -1, -1, (1 << Weather::RAINY),
      "<B>A small stone nearby begins to sparkle and glow from the kiss of a "
      "rainbow.<1>",
  ...
  component_placement.push_back(compPlace(1008, 1015, Mob::NONE,
    ...
    ~(1 << Weather::RAINY), "<b>$p dulls and fades away.<1>", ""));
  component_placement.push_back(
    compPlace(11368, -1, Mob::NONE, COMP_COLOR_SPRAY, CACT_PLACE, 9999, 65,
      HOUR_DAY_BEGIN, HOUR_DAY_END, -1, -1, -1, -1, (1 << Weather::RAINY),
      "<B>A small stone nearby begins to sparkle and glow from the kiss of a "
      "rainbow.<1>",
      "<y>A beautiful rainbow streaks across the sky.<1>"));
  ...
  component_placement.push_back(compPlace(11368, -1, Mob::NONE,
    ...
    ~(1 << Weather::RAINY), "<b>$p dulls and fades away.<1>", ""));
  component_placement.push_back(
    compPlace(1018, 1023, Mob::NONE, COMP_COLOR_SPRAY, CACT_PLACE, 9999, 65,
      HOUR_DAY_BEGIN, HOUR_DAY_END, -1, -1, -1, -1, (1 << Weather::RAINY),
      "<B>A small stone nearby begins to sparkle and glow from the kiss of a "
      "rainbow.<1>",
      ""));
  ...
  component_placement.push_back(
    compPlace(7510, 7512, Mob::NONE, COMP_COLOR_SPRAY, CACT_PLACE, 9999, 65,
      HOUR_DAY_BEGIN, HOUR_DAY_END, -1, -1, -1, -1, (1 << Weather::RAINY),
      "<B>A small stone nearby begins to sparkle and glow from the kiss of a "
      "rainbow.<1>",
      "<y>A beautiful rainbow streaks across the sky.<1>"));
  ...
  component_placement.push_back(
    compPlace(11324, -1, Mob::NONE, COMP_COLOR_SPRAY, CACT_PLACE, 9999, 65,
      HOUR_DAY_BEGIN, HOUR_DAY_END, -1, -1, -1, -1, (1 << Weather::RAINY),
      "<B>A small stone nearby begins to sparkle and glow from the kiss of a "
      "rainbow.<1>",
      "<y>A beautiful rainbow streaks across the sky.<1>"));
  ...
  component_placement.push_back(compPlace(7514, -1, Mob::NONE, COMP_ACID_BLAST,
    CACT_PLACE | CACT_UNIQUE, -1, 60, -1, -1, -1, -1, -1, -1, -1,
    "Drops of clear liquid drip from the ceiling and collect in a forgotten "
    "decanter.",
    "", SOUND_WATER_DROP, 5));
  ...
  component_placement.push_back(
    compPlace(6798, -1, Mob::NONE, COMP_SAND_BLAST, CACT_PLACE, 9999, 50,
  ...
  component_placement.push_back(compPlace(6798, -1, Mob::NONE, COMP_SAND_BLAST,
    CACT_REMOVE, -1, 100, -1, -1, -1, -1, -1, -1,
    (1 << Weather::RAINY | Weather::SNOWY | Weather::LIGHTNING),
    "Moisture hangs heavily in the air as bad weather approaches.", ""));
  component_placement.push_back(
    compPlace(7524, -1, Mob::NONE, COMP_SAND_BLAST, CACT_PLACE, 9999, 50,
      HOUR_DAY_BEGIN, HOUR_DAY_END, -1, -1, -1, -1, (1 << Weather::CLOUDLESS),
      "The extreme heat from the sun dries and cracks the $g.",
      "The blazing sun blisters the $g."));
  component_placement.push_back(compPlace(7524, -1, Mob::NONE, COMP_SAND_BLAST,
    CACT_REMOVE, -1, 100, -1, -1, -1, -1, -1, -1,
    (1 << Weather::RAINY | Weather::SNOWY | Weather::LIGHTNING),
    "Moisture hangs heavily in the air as bad weather approaches.", ""));
  component_placement.push_back(
    compPlace(9110, -1, Mob::NONE, COMP_SAND_BLAST, CACT_PLACE, 9999, 50,
      HOUR_DAY_BEGIN, HOUR_DAY_END, -1, -1, -1, -1, (1 << Weather::CLOUDLESS),
      "The extreme heat from the sun dries and cracks the $g.",
      "The blazing sun blisters the $g."));
  component_placement.push_back(compPlace(9110, -1, Mob::NONE, COMP_SAND_BLAST,
    CACT_REMOVE, -1, 100, -1, -1, -1, -1, -1, -1,
    (1 << Weather::RAINY | Weather::SNOWY | Weather::LIGHTNING),
    "Moisture hangs heavily in the air as bad weather approaches.", ""));
  component_placement.push_back(
    compPlace(9114, -1, Mob::NONE, COMP_SAND_BLAST, CACT_PLACE, 9999, 50,
      HOUR_DAY_BEGIN, HOUR_DAY_END, -1, -1, -1, -1, (1 << Weather::CLOUDLESS),
      "The extreme heat from the sun dries and cracks the $g.",
      "The blazing sun blisters the $g."));
  component_placement.push_back(compPlace(9114, -1, Mob::NONE, COMP_SAND_BLAST,
    CACT_REMOVE, -1, 100, -1, -1, -1, -1, -1, -1,
    (1 << Weather::RAINY | Weather::SNOWY | Weather::LIGHTNING),
    "Moisture hangs heavily in the air as bad weather approaches.", ""));
  component_placement.push_back(
    compPlace(9118, -1, Mob::NONE, COMP_SAND_BLAST, CACT_PLACE, 9999, 50,
      HOUR_DAY_BEGIN, HOUR_DAY_END, -1, -1, -1, -1, (1 << Weather::CLOUDLESS),
      "The extreme heat from the sun dries and cracks the $g.",
      "The blazing sun blisters the $g."));
  component_placement.push_back(compPlace(9118, -1, Mob::NONE, COMP_SAND_BLAST,
    CACT_REMOVE, -1, 100, -1, -1, -1, -1, -1, -1,
    (1 << Weather::RAINY | Weather::SNOWY | Weather::LIGHTNING),
    "Moisture hangs heavily in the air as bad weather approaches.", ""));
  component_placement.push_back(
    compPlace(9157, -1, Mob::NONE, COMP_SAND_BLAST, CACT_PLACE, 9999, 50,
      HOUR_DAY_BEGIN, HOUR_DAY_END, -1, -1, -1, -1, (1 << Weather::CLOUDLESS),
      "The extreme heat from the sun dries and cracks the $g.",
      "The blazing sun blisters the $g."));
  component_placement.push_back(compPlace(9157, -1, Mob::NONE, COMP_SAND_BLAST,
    CACT_REMOVE, -1, 100, -1, -1, -1, -1, -1, -1,
    (1 << Weather::RAINY | Weather::SNOWY | Weather::LIGHTNING),
    "Moisture hangs heavily in the air as bad weather approaches.", ""));
  component_placement.push_back(
    compPlace(9163, 9164, Mob::NONE, COMP_SAND_BLAST, CACT_PLACE, 9999, 50,
      HOUR_DAY_BEGIN, HOUR_DAY_END, -1, -1, -1, -1, (1 << Weather::CLOUDLESS),
      "The extreme heat from the sun dries and cracks the $g.",
      "The blazing sun blisters the $g."));
  component_placement.push_back(compPlace(9163, 9164, Mob::NONE,
    COMP_SAND_BLAST, CACT_REMOVE, -1, 100, -1, -1, -1, -1, -1, -1,
    (1 << Weather::RAINY | Weather::SNOWY | Weather::LIGHTNING),
    "Moisture hangs heavily in the air as bad weather approaches.", ""));
  component_placement.push_back(
    compPlace(9170, -1, Mob::NONE, COMP_SAND_BLAST, CACT_PLACE, 9999, 50,
      HOUR_DAY_BEGIN, HOUR_DAY_END, -1, -1, -1, -1, (1 << Weather::CLOUDLESS),
      "The extreme heat from the sun dries and cracks the $g.",
      "The blazing sun blisters the $g."));
  component_placement.push_back(compPlace(9170, -1, Mob::NONE, COMP_SAND_BLAST,
    CACT_REMOVE, -1, 100, -1, -1, -1, -1, -1, -1,
    (1 << Weather::RAINY | Weather::SNOWY | Weather::LIGHTNING),
    "Moisture hangs heavily in the air as bad weather approaches.", ""));
  component_placement.push_back(
    compPlace(12641, 12643, Mob::NONE, COMP_SAND_BLAST, CACT_PLACE, 9999, 50,
      HOUR_DAY_BEGIN, HOUR_DAY_END, -1, -1, -1, -1, 1 << Weather::CLOUDLESS,
      "The extreme heat from the sun dries and cracks the $g.",
      "The blazing sun blisters the $g."));
  ...
  component_placement.push_back(
    compPlace(12795, 12799, Mob::NONE, COMP_SAND_BLAST, CACT_PLACE, 9999, 50,
      HOUR_DAY_BEGIN, HOUR_DAY_END, -1, -1, -1, -1, 1 << Weather::CLOUDLESS,
      "The extreme heat from the sun dries and cracks the $g.",
      "The blazing sun blisters the $g."));
  ...
  component_placement.push_back(compPlace(10990, 10992, Mob::NONE,
    COMP_STONE_SKIN, CACT_PLACE | CACT_UNIQUE, 9999, 15, -1, -1, -1, -1, -1, -1,
    -1, "A gust of wind exposes $p.", ""));

  // A dryad's footprint [stealth] //
  component_placement.push_back(compPlace(7829, -1, Mob::NONE, COMP_STEALTH,
    CACT_PLACE | CACT_UNIQUE, 9999, 80, -1, -1, -1, -1, -1, -1,
    ~(1 << Weather::RAINY | 1 << Weather::SNOWY), "", ""));
  component_placement.push_back(
    compPlace(7829, -1, Mob::NONE, COMP_STEALTH, CACT_REMOVE, -1, 100, -1, -1,
      -1, -1, -1, -1, (1 << Weather::RAINY | 1 << Weather::SNOWY), "", ""));

  // A prism of condensation [concealment] //
  // created during daylight rain, destroyed by sun
  // nighttime has no effect on destruction
  component_placement.push_back(
    compPlace(2712, 2717, Mob::NONE, COMP_CLOUD_OF_CONCEAL,
      CACT_PLACE | CACT_UNIQUE, 9999, 80, HOUR_DAY_BEGIN, HOUR_DAY_END, -1, -1,
      -1, -1, (1 << Weather::RAINY), "Raindrops slowly fall from the leaves.",
      "The falling rain gathers on the foliage around you."));

  component_placement.push_back(compPlace(2712, 2717, Mob::NONE,
    COMP_CLOUD_OF_CONCEAL, CACT_REMOVE, -1, 100, HOUR_DAY_BEGIN, HOUR_DAY_END,
    -1, -1, -1, -1, (1 << Weather::CLOUDLESS),
    "The bright heat from the sun warms the air around you.", ""));

  component_placement.push_back(
    compPlace(10101, 10159, Mob::NONE, COMP_CLOUD_OF_CONCEAL,
      CACT_PLACE | CACT_UNIQUE, 9999, 80, HOUR_DAY_BEGIN, HOUR_DAY_END, -1, -1,
      -1, -1, (1 << Weather::RAINY), "Raindrops slowly fall from the leaves.",
      "The falling rain gathers on the foliage around you."));
  ...
  component_placement.push_back(compPlace(22480, -1, Mob::NONE,
    COMP_DISPEL_INVIS, CACT_PLACE, 40, 90, -1, -1, -1, -1, -1, -1, -1, "", ""));

  // A bit of brain coral [telepathy] //
  component_placement.push_back(
    compPlace(4300, 4399, Mob::NONE, COMP_TELEPATHY, CACT_PLACE | CACT_UNIQUE,
      9999, 10, 12, 25, -1, -1, -1, -1, -1, "$p washes up onto shore.",
      "The shallow waters churn, kicking up sediment and debris."));
  component_placement.push_back(compPlace(4300, 4399, Mob::NONE, COMP_TELEPATHY,
    CACT_REMOVE, -1, 100, 25, -1, -1, -1, -1, -1, -1,
    "The waterline recedes as the tides change.", ""));

  component_placement.push_back(
    compPlace(14111, 14115, Mob::NONE, COMP_TELEPATHY, CACT_PLACE | CACT_UNIQUE,
      9999, 10, 40, 2, -1, -1, -1, -1, -1, "$p washes up onto shore.",
      "The shallow waters churn kicking up sediment and debris."));

  component_placement.push_back(compPlace(14111, 14115, Mob::NONE,
    COMP_TELEPATHY, CACT_REMOVE, -1, 100, 2, -1, -1, -1, -1, -1, -1,
    "The waterline recedes as the tides change.", ""));

  // A jar of whale grease [fumble] //
  component_placement.push_back(compPlace(1293, -1, 1389, COMP_FUMBLE,
    CACT_PLACE, 9999, 80, -1, -1, -1, -1, -1, -1, -1, "", ""));

  component_placement.push_back(compPlace(2794, -1, 2773, COMP_FUMBLE,
    CACT_PLACE, 9999, 80, -1, -1, -1, -1, -1, -1, -1, "", ""));
  // A piece of cloud stone [conjure air elemental] //
  component_placement.push_back(compPlace(11000, 11017, Mob::NONE,
    COMP_CONJURE_AIR, CACT_PLACE | CACT_UNIQUE, 9999, 60, -1, -1, -1, -1, -1,
    -1, (1 << Weather::CLOUDY | 1 << Weather::RAINY),
    "Heavy winds buffet the clouds, sending $p across the $g.",
    "Howling winds scream in your ears."));

  component_placement.push_back(
    compPlace(11000, 11017, Mob::NONE, COMP_CONJURE_AIR, CACT_REMOVE, -1, 100,
      -1, -1, -1, -1, -1, -1, ~(1 << Weather::CLOUDY | 1 << Weather::RAINY),
      "The winds begin to die down somewhat.", ""));

  // A bit of cloud foam [fly] //
  component_placement.push_back(compPlace(11000, 11017, Mob::NONE, COMP_FLIGHT,
    CACT_PLACE | CACT_UNIQUE, 9999, 40, -1, -1, -1, -1, -1, -1,
    (1 << Weather::RAINY), "The moist air creates $p on the $g.",
    "The $g becomes heavy with moisture."));

  component_placement.push_back(compPlace(11000, 11017, Mob::NONE, COMP_FLIGHT,
    CACT_REMOVE, -1, 100, -1, -1, -1, -1, -1, -1, (1 << Weather::CLOUDY),
    "The clouds firm up as the rain dissipates.", ""));

  // Some liquid brimstone [hellfire] //
  component_placement.push_back(compPlace(9994, -1, 9917, COMP_HELLFIRE,
    CACT_PLACE | CACT_UNIQUE, 9999, 90, -1, -1, -1, -1, -1, -1, -1, "", ""));
  component_placement.push_back(compPlace(7515, -1, Mob::NONE, COMP_HELLFIRE,
    CACT_PLACE | CACT_UNIQUE, 9999, 70, -1, -1, -1, -1, -1, -1, -1,
  ...
  component_placement.push_back(compPlace(3401, 3449, Mob::NONE,
    Obj::BROWN_MUSHROOM, CACT_PLACE, 9999, 10, 5, -1, -1, -1, -1, -1, -1,
...
void do_components(int situ) {
  ...
  for (i = 0; i < component_placement.size(); i++) {
    if ((value = real_object(component_placement[i].number)) < 0) {
      vlogf(LOG_MISC,
        format("Bad component (%d, %d)") % i % component_placement[i].number);
      continue;
    }
    ...
    if (component_placement[i].room2 == -1)
      ...
      do {
        l_room =
          ::number(component_placement[i].room1, component_placement[i].room2);
        j++;
    ...
    if ((rp = real_roomp(l_room))) {
      ...
      if (component_placement[i].weather != -1) {
        if (!IS_SET(component_placement[i].weather,
              (1 << Weather::getWeather(*rp))))
          continue;
      }
      ...
      if (IS_SET(component_placement[i].place_act, CACT_PLACE)) {
          ...
          if (IS_SET(component_placement[i].place_act, CACT_UNIQUE)) {
            ...
            if (component_placement[i].mob) {
              ...
              for (StuffIter it = rp->stuff.begin();
                   it != rp->stuff.end() && (m = *it); ++it) {
                TMonster* tmon = dynamic_cast<TMonster*>(m);
                if (!tmon)
                  continue;
                if (!tmon->isPc() &&
                    (tmon->mobVnum() == component_placement[i].mob)) {
                  for (StuffIter it = tmon->stuff.begin();
                       it != tmon->stuff.end(); ++it) {
        ...
        if (placed && *component_placement[i].message && !rp->stuff.empty()) {
          ...
          if (component_placement[i].sound != SOUND_OFF)
            rp->playsound(component_placement[i].sound, SOUND_TYPE_NOISE, 100,
              5, component_placement[i].sound_loop);
        }
        ...
        found = 0;
        for (t_room = component_placement[i].room1;
             (t_room <= component_placement[i].room2 ||
               t_room == component_placement[i].room1) &&
                ...
                if (!tmon->isPc() &&
                  ...
                  for (StuffIter it = tmon->stuff.begin();
                    ...
                    if (tobj->objVnum() == component_placement[i].number) {
                      ...
                      delete tobj;
                      vlogf(LOG_SILENT,
                        format("Removing object %d from mob (room %d)") %
                          component_placement[i].number % t_room);
                      continue;
                    }
                  }
                }
        ...
        vlogf(LOG_MISC,
          format("No direction specified on component placement (%d)") % i);
      }
    } else {
      vlogf(LOG_MISC,
        format("No room specified on component placement (%d)") % i);
    }
  }
}
...
void buildComponentArray() {
  ...
  CompInfo.push_back(compInfo(SPELL_SUFFOCATE, "You heave $p at $N.",
    "$n heaves $p at $N.", "$n heaves $p at you.",
    "You heave $p over your head.", "$n heaves $p over $s head.", "", ""));
  ...
  CompInfo.push_back(compInfo(SPELL_FEATHERY_DESCENT, "You fling $p at $N.",
    "$n flings $p at $N.", "$n flings $p at you.", "You fling $p at yourself.",
    "$n flings $p at $mself.", "", ""));
  ...
  CompInfo.push_back(compInfo(SPELL_DETECT_MAGIC, "You toss $p onto $N.",
    "$n tosses $p onto $N.", "$n tosses $p onto you.",
    "You toss $p on yourself.", "$n tosses $p onto $mself.", "", ""));
  CompInfo.push_back(
    compInfo(SPELL_DISPEL_MAGIC, "", "", "", "You squeeze $p tightly.",
      "$n squeezes $p.", "You squeeze $p tightly.", "$n squeezes $p."));
  CompInfo.push_back(compInfo(SPELL_CHASE_SPIRIT, "", "", "", "You swallow $p.",
    "$n swallows $p.", "You swallow $p.", "$n swallows $p."));
  ...
  CompInfo.push_back(compInfo(SPELL_VOODOO, "", "", "",
    "You taste $p and spit it out.", "$n tastes $p and then $e spits it out.",
    "You taste $p and spit it out.", "$n tastes $p and then $e spits it out."));
  CompInfo.push_back(compInfo(SPELL_DANCING_BONES, "", "", "",
    "You blow $p into the air.", "$n blows $p into the air.",
    "You blow $p into the air.", "$n blows $p into the air."));
  ...
  CompInfo.push_back(
    compInfo(SPELL_GRANITE_FISTS, "You tightly squeeze $p as you stare at $N.",
  ...
  CompInfo.push_back(compInfo(SPELL_METEOR_SWARM,
    ...
    "You toss $p at yourself.  The stone floats skywards before it can hit "
    "you.",
    "$n tosses $p at $mself.  The stone floats skywards before it can hit $m.",
    "", ""));
  CompInfo.push_back(compInfo(SPELL_PEBBLE_SPRAY, "", "", "",
    "You press $p to the $g.", "$n presses $p to the $g.", "", ""));
  CompInfo.push_back(compInfo(SPELL_FLATULENCE, "", "", "",
    "You quickly eat $p.", "$n quickly eats $p.", "", ""));
  CompInfo.push_back(compInfo(SPELL_SAND_BLAST, "", "", "",
    "You pour a portion of sand from $p.", "$n pours a bit of sand from $p.",
    "", ""));
  CompInfo.push_back(
    compInfo(SPELL_LAVA_STREAM, "", "", "", "You press $p between your hands.",
  ...
  CompInfo.push_back(compInfo(SPELL_STONE_SKIN, "You rub $p upon $N.",
    "$n rubs $p on $N.", "$n rubs $p on you.", "You rub $p on yourself.",
    "$n rubs $p on $mself.", "", ""));
  CompInfo.push_back(compInfo(SPELL_TRAIL_SEEK, "You touch $p to $N's nose.",
    "$n touches $p to $N's nose.", "$n touches $p to your nose.",
    "You touch $p to your nose.", "$n touches $p to $s nose.", "", ""));
  CompInfo.push_back(
    compInfo(SPELL_LEVITATE, "You uncork $p and hold it beneath $N's nose.",
      "$n uncorks $p and holds it beneath $N's nose.",
      "$n uncorks $p and holds it beneath your nose.",
      "You uncork $p and sniff it.", "$n uncorks $p and sniffs it.", "", ""));
  CompInfo.push_back(compInfo(SPELL_CONJURE_EARTH, "", "", "",
    "You crush $p in your hand.", "$n crushes $p in $s hand.", "", ""));
  ...
  CompInfo.push_back(compInfo(SPELL_STUPIDITY, "You repeat $p and look at $N.",
    "$n repeats $p and looks at $N.", "$n repeats $p while looking at you.",
    "You repeat $p and close your eyes.", "$n repeats $p and closes $s eyes.",
    "", ""));
  CompInfo.push_back(
    compInfo(SPELL_FLAMING_SWORD, "You grip $p, slashing at the air before $N.",
  ...
  CompInfo.push_back(compInfo(SPELL_FIREBALL, "", "", "",
    "You scatter $p into the air.", "$n scatters $p into the air.", "", ""));
  CompInfo.push_back(compInfo(SPELL_HELLFIRE, "", "", "",
    "You pour $p into your palm.", "$n pours $p into your palm.", "", ""));
  CompInfo.push_back(compInfo(SPELL_CONJURE_FIRE, "", "", "",
    "You touch $p to your forehead.", "$n touches $p to $s forehead.", "", ""));
  CompInfo.push_back(compInfo(SPELL_FLAMING_FLESH, "You apply $p to $N.",
    "$n applies $p to $N.", "$n applies $p to you.",
    "You apply $p to yourself.", "$n applies $p to $mself.", "", ""));
  ...
  CompInfo.push_back(compInfo(SPELL_BLAST_OF_FURY,
    "You lick $p and spit it at $N.", "$n licks $p and spits it at $N.",
    "$n licks $p and spits it at you.", "You lick $p and start to drool.",
    "$n licks $p and drools on $mself.", "", ""));
  CompInfo.push_back(compInfo(SPELL_ENERGY_DRAIN, "You wave $p at $N.",
    "$n waves $p at $N.", "$n waves $p at you.", "You wave $p at yourself.",
    "$n waves $p at $mself.", "", ""));
  CompInfo.push_back(compInfo(SPELL_LICH_TOUCH, "You fling $p at $N.",
    "$n flings $p at $N.", "$n flings $p at you.", "You fling $p at yourself.",
    "$n flings $p at $mself.", "", ""));
  CompInfo.push_back(compInfo(SPELL_SQUISH, "You squeeze $p tightly.",
    "$n squeezes $p tightly.", "$n squeezes $p tightly.",
    "You squeeze $p tightly.", "$n squeezes $p tightly.", "", ""));
  ...
  CompInfo.push_back(compInfo(SPELL_VAMPIRIC_TOUCH,
    "You consume $p and spit it on $N.", "$n consumes $p and spits it on $N.",
    "$n consumes $p and spits it on you.",
    "You consume $p and accidentally swallow it.",
    "$n consumes $p and swallows it down.", "", ""));
  CompInfo.push_back(
    compInfo(SPELL_BLOOD_BOIL, "You spit $p at $N.", "$n spits $p at $N.",
      "$n spits $p at you.", "You swallow $p and start to drool.",
      "$n swallows $p and drools on $mself.", "", ""));
  CompInfo.push_back(compInfo(SPELL_LIFE_LEECH, "You throw $p onto $N's chest.",
    "$n throws $p onto $N's chest.", "$n throws $p onto your chest!",
    "You fumble $p and it latches on to you.",
    "$n fumbles $p and it latches tightly to $s chest.", "", ""));
  CompInfo.push_back(compInfo(SPELL_ATOMIZE, "You blow $p at $N.",
    "$n blows $p at $N.", "$n blows $p at you.", "You blow $p at yourself.",
    "$n blows $p at $mself.", "", ""));
  CompInfo.push_back(compInfo(SPELL_DEATHWAVE, "You blow $p at $N.",
    "$n blows $p at $N.", "$n blows $p at you.", "You blow $p at yourself.",
    "$n blows $p at $mself.", "", ""));
  ...
  CompInfo.push_back(compInfo(SPELL_ACID_BLAST, "", "", "", "You uncork $p.",
    "$n uncorks $p.", "", ""));
  CompInfo.push_back(
    compInfo(SPELL_ANIMATE, "", "", "", "You toss $p into the pile of armor.",
      "$n tosses $p into the pile of armor.", "", ""));
  CompInfo.push_back(compInfo(SPELL_CONTROL_UNDEAD, "", "", "",
    "You toss $p on the ground.", "$n tosses $p on the ground.", "", ""));
  CompInfo.push_back(compInfo(SPELL_SHIELD_OF_MISTS,
    "You masticate $p and spit it at $N.",
    "$n masticates $p and spits it at $N.",
    "$n masticates $p and spits it at you.", "You chew $p and swallow it down.",
    "$n chews $p and swallows it down.", "", ""));
  CompInfo.push_back(compInfo(SPELL_SORCERERS_GLOBE,
    "You twirl $p in front of $N.", "$n twirls $p in front of $N.",
    "$n twirls $p in front of you.", "You twirl $p in front of yourself.",
    "$n twirls $p in front of $mself.", "", ""));
  CompInfo.push_back(
    compInfo(SPELL_BIND, "You drape $p over a finger and point at $N.",
  ...
  CompInfo.push_back(compInfo(SPELL_TELEPORT,
    "You crumble $p and toss it at $N.", "$n crumbles $p and tosses it at $N.",
  ...
  CompInfo.push_back(compInfo(SPELL_FIND_FAMILIAR,
    ...
    ""));
#endif
  CompInfo.push_back(compInfo(SPELL_SENSE_LIFE, "You touch $p to $N's head.",
    "$n touches $p to $N's head.", "$n touches $p to your head.",
    "You touch $p to your head.", "$n touches $p to $s head.", "", ""));
  CompInfo.push_back(
    compInfo(SPELL_SENSE_LIFE_SHAMAN, "You touch $p to $N's head.",
      "$n touches $p to $N's head.", "$n touches $p to your head.",
      "You touch $p to your head.", "$n touches $p to $s head.", "", ""));
  CompInfo.push_back(compInfo(SPELL_FARLOOK, "", "", "", "You look into $p.",
    "$n looks into $p.", "", ""));
  CompInfo.push_back(compInfo(SPELL_SILENCE, "You unleash $p at $N.",
    "$n unleashes $p at $N.", "$n unleashes $p at you.",
    "You unleash $p upon yourself.", "$n unleashes $p at $mself.", "", ""));
  CompInfo.push_back(compInfo(SPELL_STEALTH, "You place $p on $N's sole.",
    "$n places $p on $N's sole.", "$n places $p on your sole.",
    "You place $p on your sole.", "$n places $p on $s sole.", "", ""));
  CompInfo.push_back(
    compInfo(SPELL_CALM, "You hold up $p at $N.", "$n holds up $p at $N.",
      "$n holds up $p at you.", "You hold up $p.", "$n holds up $p.", "", ""));
  CompInfo.push_back(compInfo(SPELL_ENSORCER,
    "You tie $p in a knot while thinking of $N.", "$n ties $p in a knot.",
    "$n ties $p in a knot.", "You tie $p in a knot while thinking of yourself.",
    "$n ties $p in a knot.", "", ""));
  CompInfo.push_back(
    compInfo(SPELL_INTIMIDATE, "You flick $p at $N.", "$n flicks $p at $N.",
      "$n flicks $p at you.", "You rub $p on your face? YUCK!",
      "$n rubs $p on $s face! What a dweeb!", "", ""));
  CompInfo.push_back(compInfo(SPELL_FEAR, "You throw $p at $N.",
    "$n throws $p at $N.", "$n throws $p at you.",
    "You throw $p on the ground.", "$n throws $p on the ground.", "", ""));
  CompInfo.push_back(compInfo(SPELL_INVISIBILITY, "You douse $N with $p.",
    "$n douses $N with $p.", "$n douses you with $p.",
    "You douse yourself with $p.", "$n douses $mself with $p.", "", ""));
  ...
  CompInfo.push_back(compInfo(SPELL_DETECT_INVISIBLE, "You toss $p at $N.",
    "$n tosses $p at $N.", "$n tosses $p at you.", "You toss $p on yourself.",
    "$n tosses $p on $mself.", "", ""));
  CompInfo.push_back(compInfo(SPELL_DETECT_SHADOW, "You sprinkle $p on $N.",
    "$n sprinkles $p on $N.", "$n sprinkles $p on you.",
    "You sprinkle $p on yourself.", "$n sprinkles $p on $mself.", "", ""));
  CompInfo.push_back(compInfo(SPELL_DISPEL_INVISIBLE, "You scatter $p near $N.",
    "$n scatters $p near $N.", "$n scatters $p near you.",
    "You scatter $p on the $g.", "$n scatters $p on the $g at $s feet.", "",
    ""));
  CompInfo.push_back(compInfo(SPELL_TELEPATHY, "", "", "",
    "You touch $p to your forehead.", "$n touches $p to $s forehead.", "", ""));
  CompInfo.push_back(compInfo(SPELL_ROMBLER, "", "", "", "You stretch out $p.",
    "$n stretches out $p.", "", ""));
  CompInfo.push_back(compInfo(SPELL_RAZE, "You toss $p at $N.",
  ...
  CompInfo.push_back(compInfo(SPELL_POLYMORPH, "", "", "",
    "You wave $p over your head.", "$n waves $p over $s head.", "", ""));
  CompInfo.push_back(compInfo(SPELL_ACCELERATE, "You shake $p at $N.",
    "$n shakes $p at $N.", "$n shakes $p at you.", "You shake $p at yourself.",
    "$n shakes $p at $mself.", "", ""));
  CompInfo.push_back(compInfo(SPELL_HASTE, "You shake $p at $N.",
    "$n shakes $p at $N.", "$n shakes $p at you.", "You shake $p at yourself.",
    "$n shakes $p at $mself.", "", ""));
  CompInfo.push_back(
    compInfo(SPELL_SLUMBER, "You blow $p upon $N.", "$n blows $p upon $N.",
      "$n blows $p upon you.", "You inhale $p.", "$n inhales $p.", "", ""));
  CompInfo.push_back(
    compInfo(SPELL_FUMBLE, "You lather with $p and point at $N.",
  ...
  CompInfo.push_back(compInfo(SPELL_FAERIE_FOG, "", "", "", "You squeeze $p.",
    "$n squeezes $p.", "", ""));
  CompInfo.push_back(
    compInfo(SPELL_ICY_GRIP, "You clutch $p, shaking it at $N.",
      "$n clutches $p, shaking it at $N.", "$n clutches $p, shaking it at you.",
      "You clutch $p, shaking it at no one in particular.",
      "$n clutches $p, shaking it at no one in particular.", "", ""));
  CompInfo.push_back(compInfo(SPELL_WATERY_GRAVE, "You toss $p at $N.",
    "$n tosses $p at $N.", "$n tosses $p at you.", "You toss $p at yourself.",
    "$n tosses $p at $mself.", "", ""));
  CompInfo.push_back(compInfo(SPELL_ARCTIC_BLAST, "", "", "",
    "You breathe through $p.", "$n breathes through $p.", "", ""));
  CompInfo.push_back(compInfo(SPELL_ICE_STORM, "", "", "", "You shatter $p.",
    "$n shatters $p.", "", ""));
  ...
  CompInfo.push_back(compInfo(SPELL_ENHANCE_WEAPON, "", "", "",
    "You toss $p into the air.", "$n tosses $p into the air.",
    "You toss $p into the air and wave $N through it.",
    "$n tosses $p into the air and waves $N through it."));
  CompInfo.push_back(compInfo(SPELL_FLY, "You smear $p upon $N.",
    "$n smears $p on $N.", "$n smears $p upon you.",
    "You smear $p upon yourself.", "$n smears $p on $mself.", "", ""));
  CompInfo.push_back(compInfo(SKILL_BARKSKIN, "You smear $p upon $N.",
    "$n smears $p on $N.", "$n smears $p upon you.",
    "You smear $p upon yourself.", "$n smears $p on $mself.", "", ""));
  ...
  CompInfo.push_back(compInfo(SPELL_STICKS_TO_SNAKES, "", "", "",
    "You wave $p over your head.", "$n waves $p over $s head.", "", ""));
  CompInfo.push_back(compInfo(SPELL_LIVING_VINES, "You squeeze $p at $N.",
    "$n squeezes $p in $N's direction.", "$n squeezes $p in your direction.",
    "You squeeze $p at yourself.", "$n squeezes $p.", "", ""));
  CompInfo.push_back(compInfo(SPELL_HYPNOSIS, "You shake $p in $N's face.",
    "$n shakes $p.", "$n shakes $p.", "You shake $p in your own face.",
    "$n shakes $p.", "", ""));
  CompInfo.push_back(compInfo(SPELL_CHEVAL, "", "", "", "You swallow $p.",
    "$n swallows $p.", "", ""));
  CompInfo.push_back(
    compInfo(SPELL_CELERITE, "", "", "", "You eat $p.", "$n eats $p.", "", ""));
  CompInfo.push_back(compInfo(SPELL_CLARITY, "", "", "",
    "You put a few drops of $p in your eyes.",
    "$n put a few drops of $p in $s eyes.", "", ""));
  CompInfo.push_back(compInfo(SPELL_ENLIVEN, "You squeeze $p at $N.",
    "$n squeezes $p at $N.", "$n squeezes $p at you.",
    "You squeeze $p at yourself.", "$n squeezes $p at $mself.", "", ""));
...
#if 1
  CompInfo.push_back(compInfo(SPELL_EARTHMAW, "You grind $p into the ground.",
    "$n grinds $p into the ground.", "$n grinds $p into the ground.",
    "You drive $p into the ground.", "$n drives $p into the ground.", "", ""));
  CompInfo.push_back(
    compInfo(SPELL_CREEPING_DOOM, "You uncork $p blow it in $N's direction.",
  ...
  CompInfo.push_back(compInfo(SPELL_FERAL_WRATH, "", "", "",
    "You thrust $p into your palm.", "$n thrusts $p into $s palm.", "", ""));
  CompInfo.push_back(compInfo(SPELL_SKY_SPIRIT,
    "You toss some seeds from $p at $N.", "$n tosses some seeds from $p at $N.",
    "$n tosses some seeds from $p at you.",
    "You toss some seeds from $p into the air.",
    "$n tosses some seeds from $p into the air.", "", ""));
#endif
  CompInfo.push_back(compInfo(SKILL_BEAST_SOOTHER, "You coat $N with $p.",
    "$n coats $N with $p.", "$n coats you with $p.",
    "You coat yourself with $p.", "$n coats $mself with $p.", "", ""));
  CompInfo.push_back(compInfo(SKILL_TRANSFIX, "You smear $N with $p.",
    "$n smears $N with $p.", "$n smears you with $p.",
    "You smear yourself with $p.", "$n smears $mself with $p", "", ""));
  CompInfo.push_back(compInfo(SKILL_BEAST_SUMMON, "", "", "",
    "You rattle $p over your head.", "$n rattles $p over $s head.", "", ""));
  CompInfo.push_back(compInfo(SPELL_SHAPESHIFT, "", "", "",
    "You sip $p and quickly spit it out.",
    "$n sips $p and quickly spits it out.", "", ""));
  CompInfo.push_back(
    compInfo(SKILL_BEAST_CHARM, "You crumple $p and toss it at $N.",
  ...
  CompInfo.push_back(compInfo(SKILL_BEFRIEND_BEAST, "You point $p at $N.",
    "$n points $p in $N's direction.", "$n points $p in your direction.",
    "You point $p at yourself.", "$n points $p at $mself.", "", ""));
  CompInfo.push_back(compInfo(SPELL_DJALLA, "You smear $p on $N's forehead.",
    "$n smears $p on $N's forehead.", "$n smears $p on your forehead.",
    "You smear $p on your forehead.", "$n smears $p on $s forehead.", "", ""));
  CompInfo.push_back(compInfo(SPELL_LEGBA, "You smear $p on $N's forehead.",
    "$n smears $p on $N's forehead.", "$n smears $p on your forehead.",
    "You smear $p on your forehead.", "$n smears $p on $s forehead.", "", ""));
  ...
  CompInfo.push_back(compInfo(SPELL_GARMULS_TAIL, "You smear $p on $N.",
    "$n smears $p on $N.", "$n smears $p on you.", "You smear $p on your skin.",
  ...
  CompInfo.push_back(compInfo(SPELL_ROOT_CONTROL,
    ...
    "$n takes a drop from $p and throws it on the $g.", "", ""));
  CompInfo.push_back(
    compInfo(SPELL_TREE_WALK, "", "", "", "You ignite $p and inhale the fumes.",
      "$n ignites $p and inhales the fumes.", "", ""));
  CompInfo.push_back(compInfo(SPELL_PLASMA_MIRROR, "", "", "",
    "You twirl $p about yourself.", "$n twirls $p about $mself.", "", ""));
  CompInfo.push_back(compInfo(SPELL_AQUALUNG, "You apply $p to $N's face.",
    "$n applies $p to $N's face.", "$n applies $p to your face.",
    "You apply $p to your face.", "$n applies $p to $s face.", "", ""));
  ...
  CompInfo.push_back(compInfo(SPELL_ENTHRALL_SPECTRE, "", "", "",
    "You sprinkle $p on the ground.", "$n sprinkles $p on the ground.", "",
    ""));
  CompInfo.push_back(
    compInfo(SPELL_ENTHRALL_GHAST, "", "", "", "You sprinkle $p on the ground.",
      "$n sprinkles $p on the ground.", "", ""));
  CompInfo.push_back(
    compInfo(SPELL_ENTHRALL_GHOUL, "", "", "", "You sprinkle $p on the ground.",
      "$n sprinkles $p on the ground.", "", ""));
  CompInfo.push_back(
    compInfo(SPELL_ENTHRALL_DEMON, "", "", "", "You sprinkle $p on the ground.",
      "$n sprinkles $p on the ground.", "", ""));
  ...
  CompInfo.push_back(compInfo(SPELL_CREATE_DIAMOND_GOLEM, "", "", "",
    "You throw $p into the air and it disappears!",
    "$n throws $p into the air and it disappears!", "", ""));
  CompInfo.push_back(compInfo(SPELL_HEALING_GRASP, "You apply $p to $N's eyes.",
    "$n applies $p to $N's eyes.", "$n applies $p to your eyes.",
    "You apply $p to your eyes.", "$n applies $p to $s eyes.", "", ""));
  ...
  if (!db.query("select vnum, val2, val3 from obj where type=%i",
        mapFileToItemType(ITEM_COMPONENT))) {
  ...
  while (db.fetchRow()) {
    ...
    if (spell != TYPE_UNDEFINED && (((usage & COMP_SPELL) != 0))) {
      for (j = 0; j < CompInfo.size(); j++) {
        if (CompInfo[j].spell_num == spell) {
          if (CompInfo[j].comp_num == -1 || vnum < CompInfo[j].comp_num) {
...
int TComponent::getComponentCharges() const { return charges; }

void TComponent::setComponentCharges(int n) { charges = n; }

void TComponent::addToComponentCharges(int n) { charges += n; }

spellNumT TComponent::getComponentSpell() const { return comp_spell; }

void TComponent::setComponentSpell(spellNumT n) { comp_spell = n; }

unsigned int TComponent::getComponentType() const { return comp_type; }

void TComponent::setComponentType(unsigned int num) { comp_type = num; }

void TComponent::addComponentType(unsigned int num) { comp_type |= num; }

void TComponent::remComponentType(unsigned int num) { comp_type &= ~num; }
...
bool TComponent::sellMeCheck(TBeing* ch, TMonster* keeper, int num,
  ...
  db.query(
    "select val0 from rent where owner_type='shop' and owner=%i and vnum=%i",
    shop_nr, objVnum());
...
int TComponent::componentNumSell(TBeing* ch, TMonster* keeper, int shop_nr,
  TThing* sub, int num) {
  int rc;
...
// returns DELETE_THIS, VICT (ch), ITEM(sub)
int TComponent::componentSell(TBeing* ch, TMonster* keeper, int shop_nr,
  TThing* sub) {
  int rc;
...
void TComponent::boottimeInit() {
  ...
  // init component info
  if (getComponentSpell() != TYPE_UNDEFINED && (isComponentType(COMP_SPELL))) {
    for (j = 0; j < CompInfo.size(); j++) {
      if (CompInfo[j].spell_num == getComponentSpell()) {
        if (CompInfo[j].comp_num == -1 || objVnum() < CompInfo[j].comp_num) {
...
void TComponent::decayMe() {
  ...
  if ((tm = dynamic_cast<TMonster*>(parent)) && tm->isShopkeeper())
    return;

  // decay if it doesn't have a parent (lying on the ground)
  // or if the parent is not spellbag
  // or random chance
  if (!parent || !dynamic_cast<TSpellBag*>(parent) || (!::number(0, 50))) {
...
sstring TComponent::statObjInfo() const {
  ...
  if (getComponentSpell() <= TYPE_UNDEFINED) {
    ...
    buf =
      format("Spell for : %d (%s)\n\r") % getComponentSpell() %
      ((discArray[getComponentSpell()] && discArray[getComponentSpell()]->name)
...
bool TComponent::objectRepair(TBeing* ch, TMonster* repair,
  silentTypeT silent) {
  if (!silent) {
...
void TComponent::lowCheck() {
  if (!isname("component", name)) {
    vlogf(LOG_LOW, format("Component without COMPONENT in name (%s : %d)") %
                     getName() % objVnum());
  }
...
void TComponent::findSomeComponent(TComponent** comp_gen,
  TComponent** spell_comp, TComponent** comp_brew, spellNumT which, int type) {
  int dink;
  if (type == 1)
    dink = COMP_POTION;
  else if (type == 2)
...
int TComponent::putSomethingIntoContainer(TBeing* ch, TOpenContainer* cont) {
  ...
  if (false) {
    ...
    for (StuffIter it = cont->stuff.begin();
         it != cont->stuff.end() && (t = *it); ++it) {
      // Basically find another component of the same type that is:
      // Same VNum.
      // Has a cost greater than 0 (ignore comps from leveling)
...
sstring TComponent::getNameForShow(bool useColor, bool useName,
...
compInfo::compInfo(spellNumT sn, const char* tc, const char* to, const char* tv,
  const char* ts, const char* tr, const char* tso, const char* tro) :
  comp_num(-1),
  spell_num(sn),
  to_caster(tc),
  to_other(to),
...
void TComponent::purchaseMe(TBeing* ch, TMonster* keeper, int cost,
  int shop_nr) {
  TShopOwned tso(shop_nr, keeper, ch);
  tso.doBuyTransaction(cost, getName(), TX_BUYING, this);
}

void TComponent::sellMeMoney(TBeing* ch, TMonster* keeper, int cost,
  int shop_nr) {
  TShopOwned tso(shop_nr, keeper, ch);
...
int TComponent::buyMe(TBeing* ch, TMonster* tKeeper, int tNum, int tShop) {
  ...
  if ((ch->getCarriedVolume() + getTotalVolume()) > ch->carryVolumeLimit()) {
    ch->sendTo(
      format("%s: You can not carry that much volume.\n\r") % fname(name));
    return -1;
  }
  ...
  if (tNum > 100) {
    tKeeper->doTell(ch->getName(),
      format("I will sell no more than 100 charges of %s at a time.") %
        getName());
    tNum = 100;
    tCost = shopPrice(tNum, tShop, tChr, ch);
  }
...
int TComponent::sellMe(TBeing* ch, TMonster* tKeeper, int tShop, int num) {
  ...
  if (max_num == 0) {
    ...
    tKeeper->doTell(ch->getName(),
      format("I'll buy no more than %d charge%s of %s.") % (max_num - charges) %
        (max_num - charges > 1 ? "s" : "") % getName());
    return false;
  }

  // check for existing given item
  // review: this should not be needed - shops cant be given objs, and shops
  // dont use inventory
  for (StuffIter it = tKeeper->stuff.begin(); it != tKeeper->stuff.end();
       ++it) {
    if (((*it)->number == number) &&
        !((*it)->getName().empty() && !getName().empty() &&
          (*it)->getName() == getName())) {
  ...
  obj_flags.cost =
    getComponentCharges() * ppu;  // why doesn't addToComponentCharges do this?
  ...
  if (!rent_id) {
    ...
    db.query(
      "update rent set val0=%i where rent_id=%i and owner_type='shop' and "
      "owner=%i and vnum=%i",
...
void TComponent::valueMe(TBeing* ch, TMonster* keeper, int shop_nr, int num) {
  ...
  if (willbuy) {
    ...
    buf =
      format("Normally, I'd give you %d talens for %s!") % price % getName();
  }
