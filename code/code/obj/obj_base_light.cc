...
void TBaseLight::addToLightAmt(int n) { amtLight += n; }

void TBaseLight::setLightAmt(int n) { amtLight = n; }

int TBaseLight::getLightAmt() const { return amtLight; }

void TBaseLight::addToMaxBurn(int n) { maxBurn += n; }

void TBaseLight::setMaxBurn(int n) { maxBurn = n; }

int TBaseLight::getMaxBurn() const { return maxBurn; }

void TBaseLight::addToCurBurn(int n) { curBurn += n; }

void TBaseLight::setCurBurn(int n) { curBurn = n; }
