...
toolTypeT TTool::getToolType() const { return tool_type; }

void TTool::setToolType(toolTypeT r) { tool_type = r; }

int TTool::getToolUses() const { return tool_uses; }

void TTool::setToolUses(int r) { tool_uses = r; }
...
int TTool::getToolMaxUses() const { return max_tool_uses; }

void TTool::setToolMaxUses(int r) { max_tool_uses = r; }

void TTool::addToToolMaxUses(int r) { max_tool_uses += r; }
...
sstring TTool::statObjInfo() const {
  ...
  sprintf(buf, "Tool type: %d, Strength: %d, Max: %d", getToolType(),
