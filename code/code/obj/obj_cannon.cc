    ...
    case CMD_TASK_CONTINUE:
      ...
      switch (ch->task->timeLeft) {
        case 5:
          ...
          act(buf, false, ch, nullptr, cannon, TO_CHAR);
          buf = format("$n clears out the barrel of %s.") % cannon->shortDescr;
          act(buf, false, ch, nullptr, cannon, TO_ROOM);
