...
class compPlace {
  public:
    ...
    compPlace(int r, int r2, int m, int mn, int pa, int mx, int v, short h1,
      short h2, short m1, short m2, short d1, short d2, int w, const char* msg,
      const char* gm, soundNumT snt = SOUND_OFF, unsigned int sl = 1) :
      room1(r),
      room2(r2),
      mob(m),
      number(mn),
...
class compInfo {
  public:
    ...
    compInfo(spellNumT sn, const char* tc, const char* to, const char* tv,
...
class TComponent : public TMergeable {
  ...
  public:
    ...
    virtual void valueMe(TBeing* ch, TMonster* keeper, int shop_nr,
      int num = 1);
