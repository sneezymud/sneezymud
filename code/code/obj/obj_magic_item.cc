...
sstring TMagicItem::displayFourValues() {
  ...
  sprintf(tString + strlen(tString),
    "Current values : Lvl: %d Learn: %d %d %d %d", getMagicLevel(),
    getMagicLearnedness(), x2, x3, x4);
...
int TMagicItem::getMagicLevel() const { return magic_level; }

void TMagicItem::setMagicLearnedness(int num) { magic_learnedness = num; }

int TMagicItem::getMagicLearnedness() const { return magic_learnedness; }
