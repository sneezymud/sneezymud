...
const char * const File::BUG       = "../mutable/txt/bugs";      /*         'bug'      */
...
const char * const File::IDEA      = "../mutable/txt/ideas"; /* for the 'idea'-command */
...
const char * const File::TYPO      = "../mutable/txt/typos";     /*         'typo'     */
const char * const File::WIZLIST   = "../mutable/txt/wizlist";   /* for WIZLIST   */
