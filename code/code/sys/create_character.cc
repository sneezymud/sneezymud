...
TTraits traits[MAX_TRAITS + 1] = {{0, 0, "", "", 0, 0},
  ...
  {TOG_IS_ASTHMATIC, 8, "asthma", "You have asthma and thus are easily winded.",
    0, 0},
  {TOG_IS_MUTE, 5, "mute",
  ...
  {TOG_IS_NECROPHOBIC, 5, "necrophobia",
    "You have necrophobia and are terrified at the sight of dead things.", 0,
    0},
  {TOG_IS_ALCOHOLIC, 5, "alcoholism",
    "You are an alcoholic and feel a constant urge to drink booze.", 0, 0},
  {TOG_HAS_TOURETTES, 1, "tourettes", "You involuntarily insult other people.",
    0, 1},
  ...
  {TOG_HAS_NIGHTVISION, -8, "nightvision", "You have excellent nightvision.", 0,
    0},
  {TOG_PSIONICIST, -100, "psionics", "You have innate psionic abilities.", 0,
    1},
  {TOG_FAE_TOUCHED, 0, "fae-touched",
    "You gain random bonus stats, but gain experience at half speed.\n\r       "
    " (requires one level 50 character of your current race)",
    1, 1}};

// the list of available territories for a race
territoryT humanTerr[] = {HOME_TER_HUMAN_URBAN, HOME_TER_HUMAN_VILLAGER,
  HOME_TER_HUMAN_PLAINS, HOME_TER_HUMAN_RECLUSE, HOME_TER_HUMAN_HILL,
  HOME_TER_HUMAN_MOUNTAIN, HOME_TER_HUMAN_FOREST, HOME_TER_HUMAN_MARINER};
territoryT elfTerr[] = {HOME_TER_ELF_URBAN, HOME_TER_ELF_TRIBE,
  HOME_TER_ELF_PLAINS, HOME_TER_ELF_SNOW, HOME_TER_ELF_RECLUSE,
  HOME_TER_ELF_WOOD, HOME_TER_ELF_SEA};
territoryT dwarfTerr[] = {HOME_TER_DWARF_URBAN, HOME_TER_DWARF_VILLAGER,
  HOME_TER_DWARF_RECLUSE, HOME_TER_DWARF_HILL, HOME_TER_DWARF_MOUNTAIN};
territoryT gnomeTerr[] = {HOME_TER_GNOME_URBAN, HOME_TER_GNOME_VILLAGER,
  HOME_TER_GNOME_HILL, HOME_TER_GNOME_SWAMP};
territoryT ogreTerr[] = {HOME_TER_OGRE_VILLAGER, HOME_TER_OGRE_PLAINS,
  HOME_TER_OGRE_HILL};
territoryT hobbitTerr[] = {HOME_TER_HOBBIT_URBAN, HOME_TER_HOBBIT_SHIRE,
  HOME_TER_HOBBIT_GRASSLANDS, HOME_TER_HOBBIT_HILL, HOME_TER_HOBBIT_WOODLAND,
  HOME_TER_HOBBIT_MARITIME};
territoryT goblinTerr[] = {HOME_TER_GOBLIN_URBAN, HOME_TER_GOBLIN_VILLAGER,
  HOME_TER_GOBLIN_RECLUSE, HOME_TER_GOBLIN_MOUNTAIN, HOME_TER_GOBLIN_FOREST};
territoryT gnollTerr[] = {HOME_TER_GNOLL_VILLAGER, HOME_TER_GNOLL_PLAINS,
  HOME_TER_GNOLL_HILL, HOME_TER_GNOLL_FOREST, HOME_TER_GNOLL_MARINER};
territoryT troglodyteTerr[] = {HOME_TER_TROG_VILLAGER, HOME_TER_TROG_PLAINS,
  HOME_TER_TROG_HILL, HOME_TER_TROG_MOUNTAIN};
territoryT orcTerr[] = {HOME_TER_ORC_URBAN, HOME_TER_ORC_VILLAGER,
  HOME_TER_ORC_RECLUSE, HOME_TER_ORC_MOUNTAIN, HOME_TER_ORC_FOREST};
territoryT frogmanTerr[] = {HOME_TER_FROGMAN_VILLAGER, HOME_TER_FROGMAN_PLAINS,
  HOME_TER_FROGMAN_MOUNTAIN, HOME_TER_FROGMAN_FOREST};
territoryT fishmanTerr[] = {HOME_TER_FISHMAN_URBAN, HOME_TER_FISHMAN_VILLAGER,
  HOME_TER_FISHMAN_RECLUSE, HOME_TER_FISHMAN_MOUNTAIN, HOME_TER_FISHMAN_FOREST,
  HOME_TER_FISHMAN_MARINER};
territoryT birdmanTerr[] = {HOME_TER_BIRDMAN_URBAN, HOME_TER_BIRDMAN_VILLAGER,
...
TPlayerRace nannyRaces[] = {
  ...
  {RACE_HUMAN, "Human", 0, humanTerr, cElements(humanTerr), Room::NEWBIE,
    "help/territory help human", 0},
  {RACE_GNOME, "Gnome", 0, gnomeTerr, cElements(gnomeTerr), Room::NEWBIE,
    "help/territory help gnome", 0},
  {RACE_ELVEN, "Elf", 0, elfTerr, cElements(elfTerr), Room::NEWBIE,
    "help/territory help elf", 0},
  {RACE_OGRE, "Ogre", 0, ogreTerr, cElements(ogreTerr), Room::NEWBIE,
    "help/territory help ogre", 0},
  {RACE_DWARF, "Dwarf", 0, dwarfTerr, cElements(dwarfTerr), Room::NEWBIE,
    "help/territory help dwarf", 0},
  {RACE_HOBBIT, "Hobbit", 0, hobbitTerr, cElements(hobbitTerr), Room::NEWBIE,
    "help/territory help hobbit", 0},

  // extended races
  {RACE_GOBLIN, "Goblin", 0, goblinTerr, cElements(goblinTerr), Room::GH_INN,
    "help/territory help goblin", 1},
  {RACE_GNOLL, "Gnoll", 0, gnollTerr, cElements(gnollTerr), Room::GH_INN,
    "help/territory help gnoll", 0},
  {RACE_TROG, "Troglodyte", 0, troglodyteTerr, cElements(troglodyteTerr),
    Room::GH_INN, "help/territory help troglodyte", 0},
  {RACE_ORC, "Orc", 0, orcTerr, cElements(orcTerr), Room::GH_INN,
    "help/territory help orc", 1},

  // advanced races
  {RACE_FROGMAN, "Bullywug", 1, frogmanTerr, cElements(frogmanTerr),
    Room::BULLYWUG_INN, "help/territory help bullywug", 0},
  {RACE_FISHMAN, "Kalysian", 1, fishmanTerr, cElements(fishmanTerr),
    Room::KALYSIA_INN, "help/territory help kalysian", 0},
  {RACE_BIRDMAN, "Aarakocra", 1, birdmanTerr, cElements(birdmanTerr),
...
TStatGroup combatStats[3] = {{'S', STAT_STR, "(%sS%s)%strength%s       ",
                               "(S)trength affects your ability to manipulate "
                               "weight and your combat damage."},
...
TStatGroup utilityStats[3] = {
  ...
  {'K', STAT_KAR, "(%sK%s)%sarma%s          ", "(K)arma affects your luck."}};

// holds all of the seperate stat groups together
TStatGroup* statGroups[4] = {combatStats, combat2Stats, mentalStats,
  utilityStats};
const sstring statGroupNames[4] = {"power", "grace", "mental", "utility"};

// description strings so we can talk about a particular stat and how good the
// player is
const sstring statDescPos[MAX_STATS] = {"strong", "brawny", "healthy",
  "coordinated", "graceful", "smart", "wise", "attentive", "observant",
  "charming", "lucky", "fast", "", ""};
const sstring statDescNeg[MAX_STATS] = {"weak", "feeble", "sickly", "clumsy",
  "akward", "dumb", "foolish", "distracted", "oblivious", "charmless",
  "unlucky", "slow", "", ""};
const sstring statAmountAdj[10] = {"", "a tiny bit", "very slightly",
  "slightly", "somewhat", "fairly", "very", "extremely", "exceptionally",
  "astoundingly"};
...
typedef struct _TNannyState {
    connectStateT state;
    int menu;
    connectStateT (*nannyInputFunction)(Descriptor* desc, sstring& output,
      const sstring input);
...
#define NANNY_MENU_BASE_HBK \
  (NANNY_MENU_BASE_H | NANNY_MENU_BPAD | NANNY_MENU_FRWD)
#define NANNY_MENU_BASE_HK \
  (NANNY_MENU_BASE_H | NANNY_MENU_BACK | NANNY_MENU_FRWD)
#define NANNY_MENU_BASE_HD \
  (NANNY_MENU_BASE_H | NANNY_MENU_BACK | NANNY_MENU_DPAD)
...
void bonusStatPoints::clear() { total = combat = combat2 = learn = util = 0; }

void Descriptor::zeroChosenStats() { character->chosenStats.zero(); }
...
connectStateT nannyName_input(Descriptor* desc, sstring& output,
  ...
  else  // the name is set
  {
    ...
    return desc->connected == CON_CREATION_NAME ? CON_CREATION_DISCLAIM1
...
void nannyDisclaimer_output(Descriptor* desc) {
  const static sstring disclaimers[] = {"objdata/books/disclaimer.1",
    "objdata/books/disclaimer.2", "objdata/books/disclaimer.3"};
  ...
  if (!file_to_sstring(disclaimers[whichDis].c_str(), str))
    str = format("Error: failed to load file %s.  Please contact an admin.") %
...
connectStateT nannyMultiplaywarn_input(Descriptor* desc, sstring& output,
  const sstring input) {
  ...
  if (choice == "Y") {
    ...
    output =
      "\n\rI'm sorry, you MUST agree to the terms and conditions of our "
      "rules\n\r";
    output += format(
                "before we allow you to play a character on %s. Please "
                "reconsider\n\r") %
              MUD_NAME;
...
void nannyMultiplaywarn_output(Descriptor* desc) {
  ...
  desc->writeToQ(
    ...
    "\n\r");
  desc->writeToQ(
    "*  Multiplay is now permitted, up to the allowable limit of characters  "
    "*\n\r");
  desc->writeToQ(
    "*  online (which can be raised through quests). Have fun.               "
    "*\n\r");
  desc->writeToQ(
    "*************************************************************************"
    "\n\r");
  desc->writeToQ("\n\r\n\r");
  desc->writeToQ(
    "Do you agree to the above terms and conditions regarding the rules? "
    "[Y/N]\n\r");
}

// lets a player choose a particular class
// add multiclass support later
// currently, no classes have any race/hometerrain restrictions so this makes it
// easy
connectStateT nannyClass_input(Descriptor* desc, sstring& output,
  const sstring input) {
  ...
  while (class_limit > 0) {
    ...
    if (!(iChoice >= 0 && iChoice < MAX_CLASSES &&
          classInfo[iChoice].enabled)) {
...
void nannyClass_output(Descriptor* desc) {
  ...
  if (desc->account->flags & TAccount::ALLOW_TRIPLECLASS)
    sbuf +=
      "Your account is tripleclass enabled!\n\rYou can choose one, two or "
      "three classes by entering two or three numbers, space "
      "separated.\n\r\n\r";
  else if (desc->account->flags & TAccount::ALLOW_DOUBLECLASS)
    sbuf +=
      "Your account is doubleclass enabled!\n\rYou can choose one or two "
      "classes by entering two numbers, space separated.\n\r\n\r";
...
void nannyReset_output(Descriptor* desc) {
  desc->writeToQ(
    "Applying default settings to this character...\n\rYou may then customize "
    "these settings to your liking.\n\r");
}

// clears the character before launchpad
connectStateT nannyReset_input(Descriptor* desc, sstring& output,
  const sstring input) {
  // basic stuff
...
connectStateT nannyHand_input(Descriptor* desc, sstring& output,
  const sstring input) {
  if (!input.empty()) {
...
void nannyHand_output(Descriptor* desc) {
  desc->writeToQ(
    "Now you get to pick your handedness. The hand you pick as your "
    "primary\n\r");
  desc->writeToQ(
    "hand will be the strongest, and be able to do more things than your\n\r");
  desc->writeToQ(
    format("secondary hand.  Your character is currently %shanded.\n\r") %
    (desc->character->isRightHanded() ? "Right" : "Left"));
  desc->writeToQ("Pick your primary hand:\n\r1. Right\n\r2. Left\n\r");
}

// sets the sex of the char
connectStateT nannySex_input(Descriptor* desc, sstring& output,
  const sstring input) {
  if (!input.empty()) {
...
void nannySex_output(Descriptor* desc) {
  desc->writeToQ(
    format("Please choose your gender.  You are currently %s.\n\r") %
...
int setNannyRaces(int* races, int cRaces, int num50s, Descriptor* desc) {
  int cOut = 0;
  for (int iRace = 0; iRace < (int)cElements(nannyRaces) && cOut < cRaces;
       iRace++)
...
void nannyRace_output(Descriptor* desc) {
  desc->writeToQ(
    "Please pick one of the following races.\n\rYour current race selection is "
    "marked with an 'X'.\n\r\n\r");
  ...
  desc->writeToQ(
    "Among other factors, race will majorly affect your stats,\n\r");
  desc->writeToQ(
    "immunities, racial skills, and the supply of available equipment.\n\r");
}

// sets player race
connectStateT nannyRace_input(Descriptor* desc, sstring& output,
  const sstring input) {
  if (!input.empty()) {
    int num50any = numFifties(RACE_NORACE, false, desc->account->name);
    int iChoice = convertTo<int>(input) - 1;
    ...
    if (iChoice >= 0 && iChoice < cRaces) {
      ...
      desc->character->player.hometerrain =
        nannyRaces[races[iChoice]].territories[0];
...
void nannyTerritory_output(Descriptor* desc) {
  ...
  desc->writeToQ(
    format("Please pick one of the following homelands for your %s.\n\rYour "
           "current homeland selection is marked with an 'X'.\n\r\n\r") %
    nannyRaces[iRace].name);

  for (int iTerr = 0; iTerr < nannyRaces[iRace].cTerritories; iTerr++) {
    terrString += format("[%c] %2i. %-24s") %
                  (desc->character->player.hometerrain ==
                        nannyRaces[iRace].territories[iTerr]
                      ? 'X'
                      : ' ') %
                  (iTerr + 1) %
                  home_terrains[nannyRaces[iRace].territories[iTerr]];
    if (iTerr % 2)
      terrString += "\n\r";
  }
  ...
  desc->writeToQ(
    "\n\rYour choice of homeland will slightly impact the statistics of your "
    "character.\n\r");
}

// sets player territory
connectStateT nannyTerritory_input(Descriptor* desc, sstring& output,
  const sstring input) {
  if (!input.empty()) {
    int iRace = 0;
    int iChoice = convertTo<int>(input) - 1;
    ...
    if (iChoice >= 0 && iChoice < nannyRaces[iRace].cTerritories) {
      desc->character->player.hometerrain =
        nannyRaces[iRace].territories[iChoice];
      output = format("Okay Homeland set to %s.") %
               home_terrains[nannyRaces[iRace].territories[iChoice]];
      return CON_CREATION_LAUNCHPAD;
    }
    output = "Invalid Choice!";
  }
...
// returns true if the character can be allowed to enter the game with these
// settings
bool nannyLaunchpad_allowdone(Descriptor* desc, sstring& output) {
  bool perma = desc->character->hasQuestBit(TOG_PERMA_DEATH_CHAR);
  int num50race =
    numFifties(desc->character->getRace(), perma, desc->account->name);
  int num50any = numFifties(RACE_NORACE, false, desc->account->name);
  int iRace;
  ...
  if (nannyRaces[iRace].num50any > num50any) {
    output =
      format("The %s race requires more level 50 characters than you have.") %
      nannyRaces[iRace].name;
    return false;
  }
  ...
  for (int iTrait = 1; iTrait < MAX_TRAITS + 1; iTrait++)
    if (desc->character->hasQuestBit(traits[iTrait].tog)) {
      if (traits[iTrait].num50any > num50any) {
        output =
          format(
            "The %s trait requires more level 50 characters than you have.") %
          traits[iTrait].name;
        return false;
      } else if (traits[iTrait].num50race > num50race) {
        output =
          format("The %s trait requires more level 50%s %ss than you have.") %
          traits[iTrait].name % (perma ? " perma-death" : "") %
          nannyRaces[iRace].name;
        return false;
      } else if (nannyRaces[iRace].disableTrait == iTrait) {
        output = format("The %s trait is not allowed for %ss.") %
                 traits[iTrait].name % nannyRaces[iRace].name;
        return false;
      }
    }
  ...
  if (extra < 0) {
    output =
      format("You have over-spent your stat customizations by %d points.") %
      (-extra);
    return false;
  }
...
connectStateT nannyLaunchpad_input(Descriptor* desc, sstring& output,
  const sstring input) {
  if (input == "1")
...
void nannyLaunchpad_output(Descriptor* desc) {
  ...
  // first, ensure that bonus points have been split out into their categories
  // properly
  ...
  // Name
  desc->writeToQ(
    "Below are your current character settings.\n\rChoose a number to "
  ...
  if (nannyLaunchpad_allowdone(desc, output))
    desc->writeToQ(
      format(
        "\n\rChoose %sD%s to complete character creation and enter the game.") %
      desc->red() % desc->norm());
  else
...
void nannyTraits_output(Descriptor* desc) {
  ...
  buf =
    "You may choose some distinct traits for your character if you wish.\n\r";
  buf +=
    "You will receive bonus (or penalty) points to apply to your "
    "statistics.\n\r";
  buf +=
    "Traits you have selected are marked with an 'X', unavailable have a "
    "'*'.\n\r\n\r";
  ...
  for (int i = startval; i <= endval; ++i) {
    ...
    if (desc->character->hasQuestBit(traits[i].tog))
      check = 'X';
             ...
             nannyRaces[iRace].disableTrait == i)
      check = '*';
    buf += format("[%c] %2i. %-12s (%3i points)\n\r        %s\n\r") % check %
           i % traits[i].name % traits[i].points % traits[i].desc;
  }
...
connectStateT nannyTraits_input(Descriptor* desc, sstring& output,
  ...
  if (input.empty() || iTrait < 1 || iTrait > MAX_TRAITS) {
    ...
    output =
      format(
        "Invalid Choice! %d L50 character%s needed for %s (race-specific).") %
      traits[iTrait].num50race %
      (traits[iTrait].num50race > 1 ? "s are" : " is") % traits[iTrait].name;
  } else if (traits[iTrait].num50any > num50any) {
    output = format("Invalid Choice! %d L50 character%s needed for %s.") %
             traits[iTrait].num50any %
             (traits[iTrait].num50any > 1 ? "s are" : " is") %
             traits[iTrait].name;
  } else {
...
void nannyStatRules_output(Descriptor* desc) {
  ...
  output +=
    format("Welcome to the %s stat customization process.\n\r") % MUD_NAME;
  output +=
    "All changes apply on top of your existing stats given your race and "
    "homeland.\n\r";
  output +=
    "REALIZE THAT A ZERO STAT IS THE NORMAL AMOUNT FOR YOU RACE AND "
    "HOMELAND.\n\r";
  output +=
    "Your stats are split into four groups: power and grace, mental, and "
    "utility.\n\r";
  output +=
    "Each group has 3 characteristics which can have points distributed in the "
    "group.\n\r";
  output +=
    "Also, each individual stat may only be modified up or down at most 25 "
    "points.\n\r";
...
void nannyStats_output(Descriptor* desc) {
  ...
  desc->writeToQ(
    format("Your current %s characteristics are: \n\r\n\r") % statsName);
  ...
  for (int iStat = 0; iStat < 3; iStat++) {
    ...
    int realStatAmount = desc->getRacialStat(stats[iStat].stat) +
                         desc->getTerritoryStat(stats[iStat].stat) + statAmount;
    realStatAmount -= 100;
    const sstring* statDesc = realStatAmount < 0 ? statDescNeg : statDescPos;
    int iAdj = max(realStatAmount, -realStatAmount) / cElements(statAmountAdj);

    output += format(stats[iStat].shortName) % desc->cyan() % desc->norm() %
              desc->cyan() % desc->norm();
    ...
    if (iAdj < 1)
      ...
      output +=
        format("(%s %s)") % statAmountAdj[iAdj] % statDesc[stats[iStat].stat];
    else
  ...
  desc->writeToQ(format("\n\rYou have %d free %s stat points.\n\r") %
                 (bonusPoints[iGroup] - totalStats) % statsName);
  ...
  // print dynamic menus
  if (!canLeave)
    desc->writeToQ(format("\n\rYou cannot finish customizing %s until you have "
                          "spent your %d points.") %
                   statsName % (bonusPoints[iGroup] - totalStats));
  desc->writeToQ(
    format("\n\rType %s?%s to see a help file for help on this choice.") %
    desc->red() % desc->norm());
  if (canLeave && desc->connected < CON_CREATION_CUSTOMIZE_UTIL)
    desc->writeToQ(format("\n\rType %sC%s to continue on to the next menu.") %
                   desc->red() % desc->norm());
  if (canLeave && desc->connected >= CON_CREATION_CUSTOMIZE_UTIL)
    desc->writeToQ(
      format("\n\rType %sC%s to finish and go to the main character menu.") %
      desc->red() % desc->norm());
  if (canLeave && desc->connected > CON_CREATION_CUSTOMIZE_COMBAT)
    desc->writeToQ(format("\n\rType %s/%s to go back to the previous menu.") %
                   desc->red() % desc->norm());
  if (canLeave && desc->connected <= CON_CREATION_CUSTOMIZE_COMBAT)
    desc->writeToQ(
      format("\n\rType %s/%s to go back to the main character menu.") %
      desc->red() % desc->norm());
}

// customize stats (this has to use its own custom menu to prevent leaving the
// stage with negative stats
connectStateT nannyStats_input(Descriptor* desc, sstring& output,
  const sstring input) {
  int iGroup = desc->connected - CON_CREATION_CUSTOMIZE_COMBAT;
  int bonusPoints[4] = {desc->bonus_points.combat, desc->bonus_points.combat2,
    desc->bonus_points.learn, desc->bonus_points.util};
  ...
  if (!canLeave)
    output = format(
               "\n\rYou cannot finish customizing %s until you have spent your "
               "%d points.") %
             statsName % (bonusPoints[iGroup] - totalStats);
  ...
  if (!input.empty() && input.length() < 7 &&  // 7 randomly chosen for sanity
    ...
    if (stat == STAT_EXT || amount == 0) {
      ...
      output =
        "You cannot adjust your stat customizations by more than +/- 25 "
        "points.";
    } else {
    ...
    return (desc->connected == CON_CREATION_CUSTOMIZE_UTIL)
             ? CON_CREATION_LAUNCHPAD
             : (connectStateT)(desc->connected + 1);
  else if (canLeave && input.upper() == "/")
    return (desc->connected == CON_CREATION_CUSTOMIZE_COMBAT)
             ? CON_CREATION_LAUNCHPAD
             : (connectStateT)(desc->connected - 1);
...
void nannyDone_output(Descriptor* desc) {
  sstring output =
    "Congratulations, you have finished the character creation process.\n\r";
  output += format(
              "If you are a newcomer to %s, %stake a minute to read this "
              "screen%s.\n\r\n\r") %
            MUD_NAME % desc->orange() % desc->norm();

  output +=
    "Upon connecting, you will want to check your initial terminal "
    "options.\n\r";
  output +=
    "Know that the game will automatically set some of these options for "
    "you.\n\r";
  output += "These include: prompts, toggles, terminal size, color.\n\r";
  output +=
    "Your initial settings are just defaults and you can change them "
    "easily.\n\r";
  output += format(
              "Good help files to read are <%sTOGGLE%s>, <%sPROMPT%s> and "
              "<%sCOLOR%s>.\n\r") %
            desc->orange() % desc->norm() % desc->orange() % desc->norm() %
            desc->orange() % desc->norm();
  output += format(
              "You should also %sread the newbie guide%s and %swear your "
              "equipment%s.\n\r") %
            desc->orange() % desc->norm() % desc->orange() % desc->norm();

  output +=
    "For further orientation, use the help system, newbie helpers and immortal "
    "staff.\n\r";
  output +=
    "Check the SneezyMUD website's Help section for more: "
    "http://www.sneezymud.org\n\r";
  output +=
    "In contacting immortals, be aware that our immortal staff is not\n\r";
  output +=
    "allowed to help you discover The World.  However, they are allowed\n\r";
  output +=
    "and encouraged to help you with command problems and general "
    "orientation.\n\r\n\r";

  output +=
    "You may also wish to check out our web site, forums and newsletter.\n\r";
  output +=
    format("The staff of %s hope that you enjoy your stay.\n\r") % MUD_NAME;
...
connectStateT nannyCode_input(Descriptor* desc, sstring& output,
  const sstring input) {
  if (input.length() == 24) {
    sstring buf = "";
    ...
    nannyTerritory_input(desc, buf,
      format("%i") % GET_BITS_CORRECT(other, 6, 3));
    output += buf + "\n\r";
    buf = "";
    ...
    nannySex_input(desc, buf,
      format("%i") % (GET_BITS_CORRECT(other, 10, 1) + 1));
    output += buf + "\n\r";
    buf = "";

    nannyHand_input(desc, buf,
      format("%i") % (GET_BITS_CORRECT(other, 11, 1) + 1));
    output += buf + "\n\r";
    buf = "";
    ...
    nannyStats_input(desc, buf,
      format("%+is") % (GET_BITS_CORRECT(stats1, 5, 6) - 25));
    nannyStats_input(desc, buf,
      format("%+ib") % (GET_BITS_CORRECT(stats1, 11, 6) - 25));
    nannyStats_input(desc, buf,
      format("%+ic") % (GET_BITS_CORRECT(stats1, 17, 6) - 25));

    desc->connected = CON_CREATION_CUSTOMIZE_COMBAT2;
    nannyStats_input(desc, buf,
      format("%+id") % (GET_BITS_CORRECT(stats1, 23, 6) - 25));
    nannyStats_input(desc, buf,
      format("%+ia") % (GET_BITS_CORRECT(stats2, 5, 6) - 25));
    nannyStats_input(desc, buf,
      format("%+is") % (GET_BITS_CORRECT(stats3, 23, 6) - 25));

    desc->connected = CON_CREATION_CUSTOMIZE_LEARN;
    nannyStats_input(desc, buf,
      format("%+ii") % (GET_BITS_CORRECT(stats2, 11, 6) - 25));
    nannyStats_input(desc, buf,
      format("%+iw") % (GET_BITS_CORRECT(stats2, 17, 6) - 25));
    nannyStats_input(desc, buf,
      format("%+if") % (GET_BITS_CORRECT(stats2, 23, 6) - 25));

    desc->connected = CON_CREATION_CUSTOMIZE_UTIL;
    nannyStats_input(desc, buf,
      format("%+ip") % (GET_BITS_CORRECT(stats3, 5, 6) - 25));
    nannyStats_input(desc, buf,
      format("%+ic") % (GET_BITS_CORRECT(stats3, 11, 6) - 25));
    nannyStats_input(desc, buf,
      format("%+ik") % (GET_BITS_CORRECT(stats3, 17, 6) - 25));
  }
  return CON_CREATION_LAUNCHPAD;
}
...
// Note: this array should match the entries from CON_CREATION_START to
// CON_CREATION_MAX It should only be used by creation_nanny
TNannyState creationNannyData[CON_CREATION_MAX - CON_CREATION_START] = {
  ...
  {CON_CREATION_LAUNCHPAD, NANNY_MENU_BASE, nannyLaunchpad_input,
    nannyLaunchpad_output, ""},
  ...
  // customize sex
  {CON_CREATION_SEX, NANNY_MENU_BASE_HB, nannySex_input, nannySex_output,
    "help/gender"},

  // customize hand (and you're gonna need it)
  {CON_CREATION_HANDS, NANNY_MENU_BASE_HB, nannyHand_input, nannyHand_output,
    "help/handedness"},

  // customize race & homeland
  {CON_CREATION_RACE, NANNY_MENU_BASE_HBK, nannyRace_input, nannyRace_output,
    "help/races overview"},
  {CON_CREATION_HOMETERRAIN, NANNY_MENU_BASE_HD, nannyTerritory_input,
    nannyTerritory_output, "+"},

  // customize class
  {CON_CREATION_CLASS, NANNY_MENU_BASE_HB, nannyClass_input, nannyClass_output,
    "help/classes overview"},

  // customize traits
  {CON_CREATION_TRAITS1, NANNY_MENU_BASE_HBK, nannyTraits_input,
    nannyTraits_output, "help/traits overview"},
  {CON_CREATION_TRAITS2, NANNY_MENU_BASE_HK, nannyTraits_input,
    nannyTraits_output, "help/traits overview"},
  {CON_CREATION_TRAITS3, NANNY_MENU_BASE_HD, nannyTraits_input,
    nannyTraits_output, "help/traits overview"},
  ...
  {CON_CREATION_CUSTOMIZE_COMBAT2, NANNY_MENU_BASE_HNOS, nannyStats_input,
    nannyStats_output, "help/characteristics overview"},
  {CON_CREATION_CUSTOMIZE_LEARN, NANNY_MENU_BASE_HNOS, nannyStats_input,
    nannyStats_output, "help/characteristics overview"},
  {CON_CREATION_CUSTOMIZE_UTIL, NANNY_MENU_BASE_HNOS, nannyStats_input,
    nannyStats_output, "help/characteristics overview"},
...
int Descriptor::creation_nanny(sstring arg) {
  ...
  // any processing that needs to happen before every character creation state
  // goes here

  // process the state input
  sstring output;
  sstring input = arg.trim().upper().word(0);
  TNannyState* nannyState =
    &(creationNannyData[connected - CON_CREATION_START]);
  ...
  if (input == "~" && nannyState->menu & NANNY_MENU_DISC)
    ...
    connected = CON_CREATION_LAUNCHPAD;
  else if (input == "?" && (nannyState->menu & NANNY_MENU_HELP ||
                             nannyState->menu & NANNY_MENU_HNOS)) {
    const sstring* phelpFile = &(nannyState->helpFile);
    if (*phelpFile ==
        "+")  // SPECIAL CASE: helpfile is a lookup for a race territory file
      for (int iRace = 0; iRace < (int)cElements(nannyRaces); iRace++)
  ...
  // any processing that needs to happen after every character creation state
  // goes here
