...
class Config {
  private:
    ...
    // Enables automatic generation of repossession mobs based on item
    // max-exist. Not extremely popular, but a good way to get item overturn.
    ...
    // shops tend to get a lot of goods that strictly speaking aren't
    // isSimilar() slightly damaged, depreciated, etc. We can eliminate this by
    // turning this on.  Any item not perfect will get deleted.
  ...
  public:
    ...
    static bool ForceMultiplayCompliance() {
      return FORCE_MULTIPLAY_COMPLIANCE;
    }
