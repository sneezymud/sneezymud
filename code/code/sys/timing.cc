...
void TTiming::start() { gettimeofday(&tv_start, &tz); }

void TTiming::end() { gettimeofday(&tv_end, &tz); }

double TTiming::getStart() { return to_secs(tv_start); }

double TTiming::getEnd() { return to_secs(tv_end); }
