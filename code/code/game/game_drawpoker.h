...
class DrawPokerGame : public CardGame {
  private:
    ...
    int scores[6],    // Total earned for each player.
      ...
      iplay, nextCard, nextPlayer, initialPlayer, totalPlayers, anteCosts[2],
      bidCosts[2], lastAnte;
    bool game, inuse[6], silentBets, csilentBets, discarded[6], isbidding,
      usenewbie;
  ...
  public:
    ...
    bool getPlayers(const TBeing*, TBeing**, TBeing**, TBeing**, TBeing**,
      TBeing**) const;
