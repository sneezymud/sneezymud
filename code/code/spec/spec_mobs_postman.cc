...
sstring randommessage(sstring from) {
  ...
  sentences.push_back(
    "I have become hopelessly in debt playing a local gambling game known as "
    "'%s'.");
  sentences.push_back(
    "A youngster said to me today, '%s %s %s'.  I don't comprehend.");
  sentences.push_back("How have your first few days on the new job been?");
  sentences.push_back(
    "I received the package and will send the talens immediately.");
  ...
  sentences.push_back(
    "I took a girl home last night and pounded her %s, if you know what I "
    "mean.");
  sentences.push_back(
    "Have you ever had a woman suck on your %s?  Man that's hot.");
  sentences.push_back("My lover was killed by a robber recently.");
  sentences.push_back(
    "I won several thousand talens playing Hi-Lo at the casino, but then spent "
    "it all on hookers and booze.");
  sentences.push_back(
    "After having drinks with the escort at Kavod's, I took her back to the "
    "Roaring Lion...");
  sentences.push_back(
    "Do you know of a good ointment for this rash on my crotch?");
