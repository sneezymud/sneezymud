...
const int SPEC_TRAINER_DEIKHAN_MARTIAL = 122;
const int SPEC_TRAINER_MOUNTED = 123;
const int SPEC_TRAINER_DEIKHAN_GUARDIAN = 124;
const int SPEC_TRAINER_DEIKHAN_ABSOLUTION = 125;
const int SPEC_TRAINER_DEIKHAN_VENGEANCE = 126;
...
extern int MageThiefGuildMaster(TBeing*, cmdTypeT, const char*, TMonster*,
  TObj*);
extern int DeikhanGuildMaster(TBeing*, cmdTypeT, const char*, TMonster*,
  TObj* o);
...
extern int heroFaerie(TBeing* ch, cmdTypeT cmd, const char* arg,
  TMonster* myself, TObj*, bool login = false);
extern int heroFaerie(TBeing* ch, cmdTypeT cmd, const char* arg,
...
extern int engraver(TBeing* ch, cmdTypeT cmd, const char* arg, TMonster* me,
  TObj* o);
extern int tailor(TBeing* ch, cmdTypeT cmd, const char* arg, TMonster* me,
  TObj* o);
extern int blacksmith(TBeing* ch, cmdTypeT cmd, const char* arg, TMonster* me,
  TObj* o);
extern int customizer(TBeing* ch, cmdTypeT cmd, const char* arg, TMonster* me,
  TObj* o, customizerType custtype);
