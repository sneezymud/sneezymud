...
int ofManyPotions(TBeing* vict, cmdTypeT cmd, const char* arg, TObj* o, TObj*) {
  ...
  if (which < 65) {  // 0-64, 65% of the time
    ...
    switch (::number(0, 2)) {
      case 0:
        liq = LIQ_POT_CELERITE;
        break;
      case 1:
        liq = LIQ_POT_BONE_BREAKER;
        break;
      case 2:
        liq = LIQ_POT_DETECT_MAGIC;
        break;
    }
  } else {  // 99, 1% of the time
    switch (::number(0, 2)) {
      case 0:
        liq = LIQ_POISON_VIOLET_FUNGUS;
        break;
      case 1:
        liq = LIQ_POT_QUICKSILVER;
        break;
      case 2:
        liq = LIQ_POT_YOUTH;
        break;
