...
int tattooArtist(TBeing* ch, cmdTypeT cmd, const char* arg, TMonster* myself,
  ...
  const char* tattoos[] = {"A tattoo of a <r>twisting oriental red dragon.<1>",
    ...
    "A tattoo of the word '<k>LOVE<1>'.", "A tattoo of the word '<k>HATE<1>'.",
    ...
    "A tattoo of the underlying <w>skeleton<1>.", "A tattoo of a <k>cross<1>.",
    "A tattoo of an <k>upside down cross<1>.", "A tattoo of a dagger.",
  ...
  if (cmd == CMD_LIST) {
    myself->doTell(ch->getName(),
      "I charge 10000 talens for a tattoo.  They are permanent.");
