...
class spellInfo {
  ...
  public:
    spellInfo(skillUseClassT styp, discNumT discipline, discNumT assDiscipline,
      statTypeT modifierStat, const char* n, taskDiffT cast_diff, lag_t l,
      positionTypeT pos, manaCostT mana, lifeforceCostT lifeforce,
      pietyCostT align, unsigned int t, symbolStressT h, const char* fa,
      const char* far, const char* fas, const char* fasr, discStartT starting,
      discLearnT learning, discStartDoT learnDoStarting,
      discLearnDoT learningDoAmt, discStartDoT secLearnDoStart,
