...
enum race_t {
  ...
  /*  49 */ RACE_REPTILE, /*  50 */
  RACE_UNCERT,
  /*  51 */ RACE_VAMPIREBAT, /*  52 */
  RACE_OCTOPUS,
  /*  53 */ RACE_CRUSTACEAN, /*  54 */
  RACE_MOSS,
  /*  55 */ RACE_BOVINE, /*  56 */
  RACE_GOAT,
  /*  57 */ RACE_SHEEP, /*  58 */
  ...
  /* 101 */ RACE_GORGON, /* 102 */
  RACE_KOBOLD,
  /* 103 */ RACE_BASILISK, /* 104 */
  RACE_LIZARD_MAN,
  /* 105 */ RACE_CENTAUR, /* 106 */
  RACE_GOPHER,
  /* 107 */ RACE_LAMIA, /* 108 */
  RACE_SAHUAGIN,
  /* 109 */ RACE_BAT, /* 110 */
  ...
  /* 113 */ RACE_BAANTA, /* 114 */
  RACE_GNOLL,
  /* 115 */ RACE_HOBGOBLIN, /* 116 */
  RACE_MIMIC,
  /* 117 */ RACE_MEDUSA, /* 118 */
  RACE_PENGUIN,
  /* 119 */ RACE_OSTRICH, /* 120 */
  RACE_TROG,
  /* 121 */ RACE_COATL, /* 122 */
  RACE_SIMAL,
  /* 123 */ RACE_WYVELIN, /* 124 */
  RACE_FLYINSECT,
  /* 125 */ RACE_RATMEN, /* 126 */
...
// these are regular toggles from toggle.h, but ever being from that race
...
class Race {
  ...
  public:
    ...
    int getBaseArmor()
      const;  // gets the basic armor class of this race (usually 1000)

    int getGarbles()
      const;  // gets the garbles which members of this race have by default

    void applyToggles(TBeing* character)
      const;  // applies toggles common to all members of this race to character
