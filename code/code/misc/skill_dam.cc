  ...
  switch (skill) {
    ...
    case SPELL_ENERGY_DRAIN:
      ...
      dam = genericDam(victim, this, skill, DISC_MAGE, level, adv_learn,
        2.05 * HARD_TO_FIND_COMPONENT, REDUCE_YES, !isPc(), TRIM_NO);
      break;
    case SPELL_DUST_STORM:
    case SPELL_PEBBLE_SPRAY:
    case SPELL_LAVA_STREAM:
      dam = genericDam(victim, this, skill, DISC_MAGE, level, adv_learn, 2.05,
        REDUCE_YES, !isPc(), TRIM_NO);
      break;
    case SPELL_TORNADO:
      dam = genericDam(victim, this, skill, DISC_MAGE, level, adv_learn,
        2.05 * OUTDOOR_ONLY, REDUCE_YES, !isPc(), TRIM_NO);
      break;
    ...
    case SPELL_METEOR_SWARM:
      ...
      dam = genericDam(victim, this, skill, DISC_MAGE, level, adv_learn,
        2.25 * HAS_SAVING_THROW * OUTDOOR_ONLY, REDUCE_YES, !isPc(), TRIM_NO);
      break;
    case SPELL_HARM:
    ...
    case SPELL_FLAMESTRIKE:
      dam = genericDam(victim, this, skill, DISC_CLERIC, level, adv_learn,
        1.667 * HAS_SAVING_THROW, REDUCE_YES, !isPc(), TRIM_NO);
    ...
    case SPELL_STORMY_SKIES:
      dam = genericDam(victim, this, skill, DISC_SHAMAN, level, adv_learn,
        2.15 * HARD_TO_FIND_COMPONENT * NEED_RAIN_SNOW_LIGHTNING, REDUCE_YES,
        !isPc(), TRIM_NO);
      break;
    ...
    case SPELL_LICH_TOUCH:
      dam = genericDam(victim, this, skill, DISC_SHAMAN, level, adv_learn,
        2.15 * HARD_TO_FIND_COMPONENT, REDUCE_YES, !isPc(), TRIM_NO);
      break;
    case SPELL_DISTORT:
    ...
    case SPELL_LIFE_LEECH:
      dam = genericDam(victim, this, skill, DISC_SHAMAN, level, adv_learn,
        2.15 * HAS_SAVING_THROW, REDUCE_YES, !isPc(), TRIM_NO);
      break;
      ///////////////////////
      // END SHAMAN STUFF
      ///////////////////////
    ...
    case SPELL_WITHER_LIMB:
      ...
      dam = genericDam(victim, this, skill, DISC_CLERIC, level, adv_learn,
        1.667 / 5.0, REDUCE_YES, !isPc(), TRIM_NO);
      break;
