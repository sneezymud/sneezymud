...
bool TBeing::isTripleClass() const { return NumClasses(getClass()) >= 3; }
...
const sstring TBeing::getProfName() const {
  sstring buf;
...
void TBeing::setClass(unsigned short num) { player.Class = num; }
