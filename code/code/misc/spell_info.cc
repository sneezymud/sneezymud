...
// disc_deikhan
  ...
  discArray[SKILL_KICK_DEIKHAN] = new spellInfo(SKILL_DEIKHAN, DISC_DEIKHAN, DISC_DEIKHAN_MARTIAL, "kick", TASK_EASY, LAG_3, POSITION_STANDING, MANA_0, LIFEFORCE_0, PRAY_0, 0, SYMBOL_STRESS_0, "", "", "", "", START_1, LEARN_5, START_DO_1, LEARN_DO_1, START_DO_NO, LEARN_DO_NO, LEARN_DIFF_SKILLS, 0.0, 0, 0);
  ...
  discArray[SPELL_REMOVE_CURSE_DEIKHAN] = new spellInfo(SPELL_DEIKHAN, DISC_DEIKHAN, DISC_DEIKHAN_GUARDIAN, "remove curse", TASK_EASY, LAG_3, POSITION_SITTING, MANA_0, LIFEFORCE_0, PRAY_100, TAR_CHAR_ROOM | TAR_OBJ_INV | TAR_OBJ_EQUIP | TAR_OBJ_ROOM, SYMBOL_STRESS_25, "", "", "", "", START_27, LEARN_5, START_DO_30, LEARN_DO_5, START_DO_NO, LEARN_DO_NO, LEARN_DIFF_PRAYERS, 0.04, COMP_GESTURAL | COMP_VERBAL, 0);

<<<<<<< HEAD
  discArray[SPELL_CURSE_DEIKHAN] = new spellInfo(SPELL_DEIKHAN, DISC_DEIKHAN, DISC_DEIKHAN_WRATH, "curse", TASK_EASY, LAG_3, POSITION_FIGHTING, MANA_0, LIFEFORCE_0, PRAY_050, TAR_CHAR_ROOM | TAR_OBJ_ROOM | TAR_OBJ_INV | TAR_OBJ_EQUIP | TAR_VIOLENT | TAR_FIGHT_VICT, SYMBOL_STRESS_15, "You don't feel damned anymore.", "", "", "", START_51, LEARN_10, START_DO_10, LEARN_DO_2, START_DO_NO, LEARN_DO_NO, LEARN_DIFF_PRAYERS, 0.05, COMP_GESTURAL | COMP_VERBAL , 0);
=======
  discArray[SPELL_CURSE_DEIKHAN] = new spellInfo(SPELL_DEIKHAN, DISC_DEIKHAN, DISC_DEIKHAN_VENGEANCE, "curse", TASK_NORMAL, LAG_3, POSITION_FIGHTING, MANA_0, LIFEFORCE_0, PRAY_050, TAR_CHAR_ROOM | TAR_OBJ_ROOM | TAR_OBJ_INV | TAR_OBJ_EQUIP | TAR_VIOLENT | TAR_FIGHT_VICT, SYMBOL_STRESS_15, "You don't feel damned anymore.", "", "", "", START_51, LEARN_10, START_DO_10, LEARN_DO_2, START_DO_NO, LEARN_DO_NO, LEARN_DIFF_PRAYERS, 0.05, COMP_GESTURAL | COMP_VERBAL , 0);
>>>>>>> rename deikhan wrath to vengeance

  discArray[SKILL_RESCUE_DEIKHAN] = new spellInfo(SKILL_DEIKHAN, DISC_DEIKHAN, DISC_DEIKHAN_MARTIAL, "rescue", TASK_EASY, LAG_2, POSITION_CRAWLING, MANA_0, LIFEFORCE_0, PRAY_0, 0, SYMBOL_STRESS_0, "", "", "", "", START_11, LEARN_2, START_DO_10, LEARN_DO_1, START_DO_NO, LEARN_DO_NO, LEARN_DIFF_SKILLS, 0.15, 0, 0);

  discArray[SKILL_SMITE] = new spellInfo(SKILL_DEIKHAN, DISC_DEIKHAN, DISC_DEIKHAN_MARTIAL, "smite", TASK_NORMAL, LAG_3, POSITION_STANDING, MANA_0, LIFEFORCE_0, PRAY_0, 0, SYMBOL_STRESS_0, "Your deity empowers you to smite once more.", "", "", "", START_51, LEARN_2, START_DO_50, LEARN_DO_3, START_DO_NO, LEARN_DO_NO, LEARN_DIFF_SKILLS, 0.0, 0, 0);

<<<<<<< HEAD
  discArray[SPELL_INFECT_DEIKHAN] = new spellInfo(SPELL_DEIKHAN, DISC_DEIKHAN, DISC_DEIKHAN_WRATH, "infect", TASK_EASY, LAG_3, POSITION_SITTING, MANA_0, LIFEFORCE_0, PRAY_150, TAR_CHAR_ROOM | TAR_FIGHT_VICT | TAR_VIOLENT | TAR_SELF_NONO, SYMBOL_STRESS_40, "", "", "", "", START_63, LEARN_8, START_DO_20, LEARN_DO_5, START_DO_NO, LEARN_DO_NO, LEARN_DIFF_PRAYERS, 0.04, COMP_GESTURAL | COMP_VERBAL, 0);
=======
  discArray[SPELL_INFECT_DEIKHAN] = new spellInfo(SPELL_DEIKHAN, DISC_DEIKHAN, DISC_DEIKHAN_VENGEANCE, "infect", TASK_DIFFICULT, LAG_3, POSITION_SITTING, MANA_0, LIFEFORCE_0, PRAY_150, TAR_CHAR_ROOM | TAR_FIGHT_VICT | TAR_VIOLENT | TAR_SELF_NONO, SYMBOL_STRESS_40, "", "", "", "", START_63, LEARN_8, START_DO_20, LEARN_DO_5, START_DO_NO, LEARN_DO_NO, LEARN_DIFF_PRAYERS, 0.04, COMP_GESTURAL | COMP_VERBAL, 0);
>>>>>>> rename deikhan wrath to vengeance

  discArray[SPELL_CURE_DISEASE_DEIKHAN] = new spellInfo(SPELL_DEIKHAN, DISC_DEIKHAN, DISC_DEIKHAN_CURES, "cure disease", TASK_EASY, LAG_4, POSITION_SITTING, MANA_0, LIFEFORCE_0, PRAY_450, TAR_CHAR_ROOM | TAR_FIGHT_SELF, SYMBOL_STRESS_50, "", "", "", "", START_30, LEARN_5, START_DO_40, LEARN_DO_5, START_DO_NO, LEARN_DO_NO, LEARN_DIFF_PRAYERS, 0.02, COMP_GESTURAL | COMP_VERBAL, 0);

  discArray[SPELL_CREATE_FOOD_DEIKHAN] = new spellInfo(SPELL_DEIKHAN, DISC_DEIKHAN, DISC_DEIKHAN_GUARDIAN, "create food", TASK_TRIVIAL, LAG_1, POSITION_CRAWLING, MANA_0, LIFEFORCE_0, PRAY_025, TAR_IGNORE, SYMBOL_STRESS_5, "", "", "", "", START_11, LEARN_10, START_DO_40, LEARN_DO_2, START_DO_NO, LEARN_DO_NO, LEARN_DIFF_PRAYERS, 0.0, COMP_GESTURAL | COMP_VERBAL, 0);

  discArray[SPELL_CREATE_WATER_DEIKHAN] = new spellInfo(SPELL_DEIKHAN, DISC_DEIKHAN, DISC_DEIKHAN_GUARDIAN, "create water", TASK_TRIVIAL, LAG_2, POSITION_CRAWLING, MANA_0, LIFEFORCE_0, PRAY_025, TAR_OBJ_INV, SYMBOL_STRESS_5, "", "", "", "", START_11, LEARN_10, START_DO_40, LEARN_DO_5, START_DO_NO, LEARN_DO_NO, LEARN_DIFF_PRAYERS, 0.0, COMP_GESTURAL | COMP_VERBAL | SPELL_TASKED | SPELL_TASKED_EVERY, 0);
...
=======
  discArray[SPELL_POISON_DEIKHAN] = new spellInfo(SPELL_DEIKHAN, DISC_DEIKHAN, DISC_DEIKHAN_VENGEANCE, "poison", TASK_NORMAL, LAG_3, POSITION_SITTING, MANA_0, LIFEFORCE_0, PRAY_100, TAR_CHAR_ROOM | TAR_OBJ_INV | TAR_FIGHT_VICT | TAR_VIOLENT | TAR_FIGHT_VICT | TAR_SELF_NONO, SYMBOL_STRESS_45, "You feel much healthier.", "The color returns to $n's cheeks.", "", "", START_59, LEARN_10, START_DO_30, LEARN_DO_2, START_DO_NO, LEARN_DO_NO, LEARN_DIFF_PRAYERS, 0.02, COMP_GESTURAL | COMP_VERBAL, 0);
>>>>>>> rename deikhan wrath to vengeance
  ...
  discArray[SPELL_HEAL_CRITICAL_DEIKHAN] = new spellInfo(SPELL_DEIKHAN, DISC_DEIKHAN, DISC_DEIKHAN_CURES, "heal critical", TASK_EASY, LAG_2, POSITION_SITTING, MANA_0, LIFEFORCE_0, PRAY_200, TAR_CHAR_ROOM | TAR_FIGHT_SELF, SYMBOL_STRESS_25, "", "", "", "", START_76, LEARN_5, START_DO_20, LEARN_DO_2, START_DO_NO, LEARN_DO_NO, LEARN_DIFF_PRAYERS, 0.04, COMP_GESTURAL | COMP_VERBAL | SPELL_TASKED | SPELL_TASKED_EVERY, 0);
...
// disc_deikhan_cures
  ...
  discArray[SKILL_LAY_HANDS] = new spellInfo(SKILL_DEIKHAN, DISC_DEIKHAN_CURES, DISC_DEIKHAN_CURES, "lay hands", TASK_EASY, LAG_1, POSITION_STANDING, MANA_0, LIFEFORCE_0, PRAY_0, 0, SYMBOL_STRESS_0, "", "", "", "", START_1, LEARN_3, START_DO_35, LEARN_DO_2, START_DO_NO, LEARN_DO_NO, LEARN_DIFF_SKILLS, 0.4, 0, 0);

// disc_vengeance_deikhan

  discArray[SPELL_HARM_DEIKHAN] = new spellInfo(SPELL_DEIKHAN, DISC_DEIKHAN_VENGEANCE, DISC_DEIKHAN_VENGEANCE, "harm", TASK_NORMAL, LAG_3, POSITION_SITTING, MANA_0, LIFEFORCE_0, PRAY_250, TAR_CHAR_ROOM | TAR_FIGHT_VICT | TAR_SELF_NONO | TAR_VIOLENT , SYMBOL_STRESS_50, "", "", "", "", START_26, LEARN_4, START_DO_20, LEARN_DO_2, START_DO_NO, LEARN_DO_NO, LEARN_DIFF_PRAYERS, 0.06, COMP_GESTURAL | COMP_VERBAL, 0);

<<<<<<< HEAD
  discArray[SPELL_NUMB_DEIKHAN] = new spellInfo(SPELL_DEIKHAN, DISC_DEIKHAN_WRATH, DISC_DEIKHAN_WRATH, "numb", TASK_EASY, LAG_2, POSITION_SITTING, MANA_0, LIFEFORCE_0, PRAY_100, TAR_CHAR_ROOM | TAR_FIGHT_VICT | TAR_VIOLENT | TAR_SELF_NONO, SYMBOL_STRESS_30, "", "", "", "", START_1, LEARN_4, START_DO_40, LEARN_DO_5, START_DO_NO, LEARN_DO_NO, LEARN_DIFF_PRAYERS, 0.05, COMP_GESTURAL | COMP_VERBAL, 0);
=======
  discArray[SPELL_NUMB_DEIKHAN] = new spellInfo(SPELL_DEIKHAN, DISC_DEIKHAN_VENGEANCE, DISC_DEIKHAN_VENGEANCE, "numb", TASK_DANGEROUS, LAG_2, POSITION_SITTING, MANA_0, LIFEFORCE_0, PRAY_100, TAR_CHAR_ROOM | TAR_FIGHT_VICT | TAR_VIOLENT | TAR_SELF_NONO, SYMBOL_STRESS_30, "", "", "", "", START_1, LEARN_4, START_DO_40, LEARN_DO_5, START_DO_NO, LEARN_DO_NO, LEARN_DIFF_PRAYERS, 0.05, COMP_GESTURAL | COMP_VERBAL, 0);
>>>>>>> rename deikhan wrath to vengeance

  discArray[SPELL_EARTHQUAKE_DEIKHAN] = new spellInfo(SPELL_DEIKHAN, DISC_DEIKHAN_VENGEANCE, DISC_DEIKHAN_VENGEANCE, "earthquake", TASK_DIFFICULT, LAG_4, POSITION_SITTING, MANA_0, LIFEFORCE_0, PRAY_500, TAR_AREA | TAR_IGNORE | TAR_VIOLENT, SYMBOL_STRESS_90, "", "", "", "", START_51, LEARN_4, START_DO_20, LEARN_DO_2, START_DO_NO, LEARN_DO_NO, LEARN_DIFF_PRAYERS, 0.04, COMP_GESTURAL | COMP_VERBAL, 0);

  discArray[SPELL_CALL_LIGHTNING_DEIKHAN] = new spellInfo(SPELL_DEIKHAN, DISC_DEIKHAN_VENGEANCE, DISC_DEIKHAN_VENGEANCE, "call lightning", TASK_DIFFICULT, LAG_2, POSITION_SITTING, MANA_0, LIFEFORCE_0, PRAY_350, TAR_CHAR_ROOM | TAR_VIOLENT | TAR_FIGHT_VICT | TAR_SELF_NONO , SYMBOL_STRESS_50, "", "", "", "", START_76, LEARN_4, START_DO_20, LEARN_DO_2, START_DO_NO, LEARN_DO_NO, LEARN_DIFF_PRAYERS, 0.06, COMP_GESTURAL | COMP_VERBAL, 0);
