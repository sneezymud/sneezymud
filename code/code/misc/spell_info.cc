...
// disc_deikhan
  ...
  discArray[SPELL_HARM_SERIOUS_DEIKHAN] = new spellInfo(SPELL_DEIKHAN, DISC_DEIKHAN, DISC_DEIKHAN_ABSOLUTION, "harm serious", TASK_NORMAL, LAG_3, POSITION_SITTING, MANA_0, LIFEFORCE_0, PRAY_150, TAR_CHAR_ROOM | TAR_SELF_NONO | TAR_FIGHT_VICT | TAR_VIOLENT , SYMBOL_STRESS_20, "", "", "", "", START_39, LEARN_8, START_DO_20, LEARN_DO_2, START_DO_NO, LEARN_DO_NO, LEARN_DIFF_PRAYERS, 0.02, COMP_GESTURAL | COMP_VERBAL, 0);
