...
// disc_martial_deikhan
  ...
  discArray[SKILL_2H_SPEC_DEIKHAN] = new spellInfo(SKILL_DEIKHAN, DISC_DEIKHAN_MARTIAL, DISC_DEIKHAN_MARTIAL, "2h specialization", TASK_NORMAL, LAG_0, POSITION_CRAWLING, MANA_0, LIFEFORCE_0, PRAY_0, 0, SYMBOL_STRESS_0, "", "", "", "", START_1, LEARN_4, START_DO_1, LEARN_DO_1, START_DO_NO, LEARN_DO_NO, LEARN_DIFF_UNUSUAL, 0.0, 0, 0);
