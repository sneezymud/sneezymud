...
>>>>>>> update smite
  ...
  discArray[SKILL_DIVINE_GRACE] = new spellInfo(SPELL_DEIKHAN, DISC_DEIKHAN_GUARDIAN, DISC_DEIKHAN_GUARDIAN, "divine grace", TASK_NORMAL,LAG_0, POSITION_DEAD, MANA_0, LIFEFORCE_0, PRAY_0, 0, SYMBOL_STRESS_0, "", "","","", START_1, LEARN_1, START_DO_NO, LEARN_DO_NO, START_DO_NO, LEARN_DO_NO, LEARN_DIFF_SKILLS, 0.0, 0, 0);

  discArray[SKILL_DIVINE_RESCUE] = new spellInfo(SPELL_DEIKHAN, DISC_DEIKHAN_GUARDIAN, DISC_DEIKHAN_GUARDIAN, "divine rescue", TASK_NORMAL,LAG_0, POSITION_DEAD, MANA_0, LIFEFORCE_0, PRAY_0, 0, SYMBOL_STRESS_0, "", "","","", START_40, LEARN_5, START_DO_NO, LEARN_DO_NO, START_DO_NO, LEARN_DO_NO, LEARN_DIFF_SKILLS, 0.0, 0, 0);
