...
// disc_deikhan
  ...
  discArray[SPELL_REMOVE_CURSE_DEIKHAN] = new spellInfo(SPELL_DEIKHAN, DISC_DEIKHAN, DISC_DEIKHAN_AEGIS, "remove curse", TASK_EASY, LAG_3, POSITION_SITTING, MANA_0, LIFEFORCE_0, PRAY_100, TAR_CHAR_ROOM | TAR_OBJ_INV | TAR_OBJ_EQUIP | TAR_OBJ_ROOM, SYMBOL_STRESS_25, "", "", "", "", START_27, LEARN_5, START_DO_30, LEARN_DO_5, START_DO_NO, LEARN_DO_NO, LEARN_DIFF_PRAYERS, 0.04, COMP_GESTURAL | COMP_VERBAL, 0);
