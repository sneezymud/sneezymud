...
// disc_murder
  discArray[SKILL_GARROTTE] = new spellInfo(SKILL_THIEF, DISC_MURDER, DISC_MURDER, STAT_EXT, "garrotte", TASK_NORMAL, LAG_3, POSITION_CRAWLING, MANA_0, LIFEFORCE_0, PRAY_0, 0, SYMBOL_STRESS_0, "", "", "", "", START_1, LEARN_3, START_DO_1, LEARN_DO_2, START_DO_NO, LEARN_DO_NO, LEARN_DIFF_SKILLS, 0.0, 0, 0);
