...
// disc_air
  ...
  discArray[SKILL_PIERCE_RESIST] = new spellInfo(SKILL_MAGE_TYPES, DISC_AIR, DISC_AIR, STAT_INT, "pierce resistances", TASK_NORMAL, LAG_0, POSITION_RESTING, MANA_0, LIFEFORCE_0, PRAY_0, 0, SYMBOL_STRESS_0, "", "", "", "", START_75, LEARN_10, START_DO_55, LEARN_DO_5, START_DO_NO, LEARN_DO_NO, LEARN_DIFF_UNUSUAL, 0.0, SPELL_IGNORE_POSITION, 0);
...
// disc_alchemy
  ...
  discArray[SKILL_SCRIBE] = new spellInfo(SKILL_MAGE, DISC_ALCHEMY, DISC_ALCHEMY, STAT_EXT, "scribe", TASK_NORMAL, LAG_0, POSITION_STANDING, MANA_0, LIFEFORCE_0, PRAY_0, 0, SYMBOL_STRESS_0, "", "", "", "", START_1, LEARN_1, START_DO_1, LEARN_DO_5, START_DO_NO, LEARN_DO_NO, LEARN_DIFF_SPELLS, 0.0, 0, 0);
...
// disc_warrior
  discArray[SKILL_SLAM] = new spellInfo(SKILL_WARRIOR, DISC_WARRIOR, DISC_SOLDIERING, STAT_STR, "slam", TASK_EASY, LAG_2, POSITION_STANDING, MANA_0, LIFEFORCE_0, PRAY_0, 0, SYMBOL_STRESS_0, "", "", "", "", START_50, LEARN_5, START_DO_50, LEARN_DO_5, START_DO_NO, LEARN_DO_NO, LEARN_DIFF_SKILLS, 0.0, 0, 0);
  ...
  discArray[SKILL_RALLY] = new spellInfo(SKILL_WARRIOR, DISC_WARRIOR, DISC_BRAWLING, STAT_CHA, "rally", TASK_NORMAL, LAG_0, POSITION_CRAWLING, MANA_0, LIFEFORCE_0, PRAY_0, 0, SYMBOL_STRESS_0, "Your motivation to continue the battle diminishes as the effects from the <C>rallying cry<z> leave you.", "", "", "", START_1, LEARN_4, START_DO_10, LEARN_DO_2, START_DO_NO, LEARN_DO_NO, LEARN_DIFF_UNUSUAL, 0.0, 0, 0);
...
// disc_brawling
  ...
  discArray[SKILL_HEADBUTT] = new spellInfo(SKILL_WARRIOR, DISC_BRAWLING, DISC_BRAWLING, STAT_STR, "headbutt", TASK_NORMAL, LAG_4, POSITION_CRAWLING, MANA_0, LIFEFORCE_0, PRAY_0, 0, SYMBOL_STRESS_0, "", "", "", "", START_41, LEARN_5, START_DO_1, LEARN_DO_2, START_DO_NO, LEARN_DO_NO, LEARN_DIFF_SKILLS, 0.0, 0, 0);

  discArray[SKILL_KNEESTRIKE] = new spellInfo(SKILL_WARRIOR, DISC_BRAWLING, DISC_BRAWLING, STAT_STR, "kneestrike", TASK_NORMAL, LAG_4, POSITION_STANDING, MANA_0, LIFEFORCE_0, PRAY_0, 0, SYMBOL_STRESS_0, "", "", "", "", START_60, LEARN_4, START_DO_1, LEARN_DO_2, START_DO_NO, LEARN_DO_NO, LEARN_DIFF_SKILLS, 0.0, 0, 0);
  ...
  discArray[SKILL_TRIP] = new spellInfo(SKILL_WARRIOR, DISC_BRAWLING, DISC_BRAWLING, STAT_DEX, "trip", TASK_NORMAL, LAG_3, POSITION_CRAWLING, MANA_0, LIFEFORCE_0, PRAY_0, 0, SYMBOL_STRESS_0, "", "", "", "", START_1, LEARN_5, START_DO_1, LEARN_DO_1, START_DO_NO, LEARN_DO_NO, LEARN_DIFF_SKILLS, 0.0, 0, 0);


  discArray[SKILL_BODYSLAM] = new spellInfo(SKILL_WARRIOR, DISC_BRAWLING, DISC_BRAWLING, STAT_STR, "bodyslam", TASK_DIFFICULT, LAG_4, POSITION_CRAWLING, MANA_0, LIFEFORCE_0, PRAY_0, 0, SYMBOL_STRESS_0, "", "", "", "", START_30, LEARN_4, START_DO_10, LEARN_DO_1, START_DO_NO, LEARN_DO_NO, LEARN_DIFF_SKILLS, 0.0, 0, 0);
...
// disc_martial_deikhan
  ...
  discArray[SKILL_SHOCK_CAVALRY] = new spellInfo(SKILL_DEIKHAN, DISC_DEIKHAN_MARTIAL, DISC_DEIKHAN_MARTIAL, STAT_CHA, "shock cavalry", TASK_NORMAL, LAG_0, POSITION_DEAD, MANA_0, LIFEFORCE_0, PRAY_0, 0, SYMBOL_STRESS_0, "", "", "", "", START_50, LEARN_4, START_DO_NO, LEARN_DO_NO, START_DO_NO, LEARN_DO_NO, LEARN_DIFF_UNUSUAL, 0.0, 0, 0);
  
  discArray[SKILL_ORIENT] = new spellInfo(SKILL_DEIKHAN, DISC_DEIKHAN_MARTIAL, DISC_DEIKHAN_MARTIAL, STAT_CHA, "orient mount", TASK_NORMAL, LAG_3, POSITION_SITTING, MANA_0, LIFEFORCE_0, PRAY_0, 0, SYMBOL_STRESS_0, "", "", "", "", START_26, LEARN_2, START_DO_1, LEARN_DO_1, START_DO_NO, LEARN_DO_NO, LEARN_DIFF_SKILLS, 0.0, 0, 0);
...
// disc_thief
  ...
  discArray[SKILL_KICK] = new spellInfo(SKILL_THIEF, DISC_THIEF, DISC_THIEF_FIGHT, STAT_STR, "kick", TASK_EASY, LAG_3, POSITION_STANDING, MANA_0, LIFEFORCE_0, PRAY_0, 0, SYMBOL_STRESS_0, "", "", "", "", START_1, LEARN_5, START_DO_1, LEARN_DO_1, START_DO_NO, LEARN_DO_NO, LEARN_DIFF_SKILLS, 0.0, 0, 0);
...
// disc_adventuring
  ...
  discArray[SKILL_WIZARDRY] = new spellInfo(SKILL_MAGE, DISC_WIZARDRY, DISC_WIZARDRY, STAT_EXT, "wizardry", TASK_EASY, LAG_0, POSITION_SLEEPING, MANA_0, LIFEFORCE_0, PRAY_0, 0, SYMBOL_STRESS_0, "", "", "", "", START_1, LEARN_1, START_DO_NO, LEARN_DO_NO, START_DO_NO, LEARN_DO_NO, LEARN_DIFF_UNUSUAL, 0.0, 0, 0);
...
// disc_theology
  ...
  discArray[SKILL_RITUALISM] = new spellInfo(SKILL_SHAMAN, DISC_RITUALISM, DISC_RITUALISM, STAT_EXT, "ritualism", TASK_EASY, LAG_0, POSITION_SLEEPING, MANA_0, LIFEFORCE_0, PRAY_0, 0, SYMBOL_STRESS_0, "", "", "", "", START_1, LEARN_1, START_DO_NO, LEARN_DO_NO, START_DO_NO, LEARN_DO_NO, LEARN_DIFF_UNUSUAL, 0.0, 0, 0);
  ...
  discArray[SKILL_BREW] = new spellInfo(SKILL_SHAMAN, DISC_SHAMAN_ALCHEMY, DISC_SHAMAN_ALCHEMY, STAT_EXT, "brew", TASK_EASY, LAG_0, POSITION_STANDING, MANA_0, LIFEFORCE_0, PRAY_0, 0, SYMBOL_STRESS_0, "", "", "", "", START_1, LEARN_1, START_DO_1, LEARN_DO_5, START_DO_NO, LEARN_DO_NO, LEARN_DIFF_UNUSUAL, 0.0, 0, 0);
...
// disc_theology
  ...
  discArray[SKILL_KINETIC_WAVE] = new spellInfo(SKILL_GENERAL, DISC_PSIONICS, DISC_PSIONICS, STAT_INT, "kinetic wave", TASK_EASY, LAG_3, POSITION_STANDING, MANA_40, LIFEFORCE_0, PRAY_0, 0, SYMBOL_STRESS_0, "", "", "", "", START_80, LEARN_5, START_DO_1, LEARN_DO_1, START_DO_NO, LEARN_DO_NO, LEARN_DIFF_SKILLS, 0.0, 0, 0);
