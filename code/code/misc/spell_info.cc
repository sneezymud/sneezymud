...
// disc_deikhan
  ...
  discArray[SKILL_AURA_MIGHT] = new spellInfo(SKILL_DEIKHAN, DISC_DEIKHAN, DISC_DEIKHAN_MARTIAL, "aura of might", TASK_NORMAL, LAG_2, POSITION_SITTING, MANA_0, LIFEFORCE_0, PRAY_0, 0, SYMBOL_STRESS_0, "You stop projecting an aura of might.", "", "", "", START_70, LEARN_4, START_DO_NO, LEARN_DO_NO, START_DO_NO, LEARN_DO_NO, LEARN_DIFF_SKILLS, 0.0, 0, 0);

  discArray[SKILL_AURA_REGENERATION] = new spellInfo(SKILL_DEIKHAN, DISC_DEIKHAN, DISC_DEIKHAN_ABSOLUTION, "aura of regeneration", TASK_NORMAL, LAG_2, POSITION_SITTING, MANA_0, LIFEFORCE_0, PRAY_0, 0, SYMBOL_STRESS_0, "You stop projecting an aura of regeneration.", "", "", "", START_30, LEARN_4, START_DO_NO, LEARN_DO_NO, START_DO_NO, LEARN_DO_NO, LEARN_DIFF_SKILLS, 0.0, 0, 0);
...
// disc_guardian_deikhan
  ...
  discArray[SKILL_AURA_GUARDIAN] = new spellInfo(SKILL_DEIKHAN, DISC_DEIKHAN_GUARDIAN, DISC_DEIKHAN_GUARDIAN, "aura of the guardian", TASK_NORMAL, LAG_2, POSITION_SITTING, MANA_0, LIFEFORCE_0, PRAY_0, 0, SYMBOL_STRESS_0, "You stop projecting an aura of the guardian.", "", "", "", START_30, LEARN_4, START_DO_NO, LEARN_DO_NO, START_DO_NO, LEARN_DO_NO, LEARN_DIFF_SKILLS, 0.0, 0, 0);

// disc_absolution_deikhan

  discArray[SPELL_REFRESH_DEIKHAN] = new spellInfo(SPELL_DEIKHAN, DISC_DEIKHAN_ABSOLUTION, DISC_DEIKHAN_ABSOLUTION, "refresh", TASK_EASY, LAG_2, POSITION_SITTING, MANA_0, LIFEFORCE_0, PRAY_100, TAR_CHAR_ROOM | TAR_FIGHT_SELF, SYMBOL_STRESS_20, "", "", "", "", START_1, LEARN_5, START_DO_20, LEARN_DO_2, START_DO_NO, LEARN_DO_NO, LEARN_DIFF_PRAYERS, 0.02, COMP_GESTURAL | COMP_VERBAL, 0);
...
// disc_vengeance_deikhan
  ...
  discArray[SKILL_AURA_VENGEANCE] = new spellInfo(SKILL_DEIKHAN, DISC_DEIKHAN_VENGEANCE, DISC_DEIKHAN_VENGEANCE, "aura of vengeance", TASK_NORMAL, LAG_2, POSITION_SITTING, MANA_0, LIFEFORCE_0, PRAY_0, 0, SYMBOL_STRESS_0, "You stop projecting an aura of vengeance.", "", "", "", START_10, LEARN_4, START_DO_NO, LEARN_DO_NO, START_DO_NO, LEARN_DO_NO, LEARN_DIFF_SKILLS, 0.0, 0, 0);
