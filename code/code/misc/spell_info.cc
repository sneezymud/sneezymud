...
// disc_deikhan
  ...
  discArray[SKILL_BASH_DEIKHAN] = new spellInfo(SKILL_DEIKHAN, DISC_DEIKHAN, DISC_DEIKHAN_FIGHT, "bash-deikhan", TASK_EASY, LAG_3, POSITION_CRAWLING, MANA_0, LIFEFORCE_0, PRAY_0, 0, SYMBOL_STRESS_0, "", "", "", "", START_1, LEARN_5, START_DO_1, LEARN_DO_1, START_DO_NO, LEARN_DO_NO, LEARN_DIFF_SKILLS, 0.0, 0, 0);
  ...
  discArray[SKILL_RESCUE_DEIKHAN] = new spellInfo(SKILL_DEIKHAN, DISC_DEIKHAN, DISC_DEIKHAN_FIGHT, "rescue", TASK_EASY, LAG_2, POSITION_CRAWLING, MANA_0, LIFEFORCE_0, PRAY_0, 0, SYMBOL_STRESS_0, "", "", "", "", START_11, LEARN_2, START_DO_10, LEARN_DO_1, START_DO_NO, LEARN_DO_NO, LEARN_DIFF_SKILLS, 0.15, 0, 0);
  ...
  discArray[SKILL_DISARM_DEIKHAN] = new spellInfo(SKILL_DEIKHAN, DISC_DEIKHAN, DISC_DEIKHAN_FIGHT, "disarm", TASK_EASY, LAG_2, POSITION_CRAWLING, MANA_0, LIFEFORCE_0, PRAY_0, 0, SYMBOL_STRESS_0, "", "", "", "", START_35, LEARN_3, START_DO_10, LEARN_DO_1, START_DO_NO, LEARN_DO_NO, LEARN_DIFF_SKILLS, 0.0, 0, 0);
...
// disc_fight_deikhan
  ...
  discArray[SKILL_SWITCH_DEIKHAN] = new spellInfo(SKILL_DEIKHAN, DISC_DEIKHAN_FIGHT, DISC_DEIKHAN_FIGHT, "switch opponents", TASK_EASY, LAG_2, POSITION_CRAWLING, MANA_0, LIFEFORCE_0, PRAY_0, 0, SYMBOL_STRESS_0, "", "", "", "", START_21, LEARN_3, START_DO_10, LEARN_DO_1, START_DO_NO, LEARN_DO_NO, LEARN_DIFF_UNUSUAL, 0.0, 0, 0);

  discArray[SKILL_RETREAT_DEIKHAN] = new spellInfo(SKILL_DEIKHAN, DISC_DEIKHAN_FIGHT, DISC_DEIKHAN_FIGHT, "retreat", TASK_EASY, LAG_0, POSITION_CRAWLING, MANA_0, LIFEFORCE_0, PRAY_0, 0, SYMBOL_STRESS_0, "", "", "", "", START_65, LEARN_3, START_DO_1, LEARN_DO_1, START_DO_NO, LEARN_DO_NO, LEARN_DIFF_UNUSUAL, 0.0, 0, 0);

  discArray[SKILL_SHOVE_DEIKHAN] = new spellInfo(SKILL_DEIKHAN, DISC_DEIKHAN_FIGHT, DISC_DEIKHAN_FIGHT, "shove", TASK_EASY, LAG_3, POSITION_CRAWLING, MANA_0, LIFEFORCE_0, PRAY_0, 0, SYMBOL_STRESS_0, "", "", "", "", START_33, LEARN_3, START_DO_20, LEARN_DO_1, START_DO_NO, LEARN_DO_NO, LEARN_DIFF_SKILLS, 0.0, 0, 0);
