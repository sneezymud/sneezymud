...
// disc_monk
  ...
  discArray[SKILL_CHI] = new spellInfo(SKILL_MONK, DISC_MONK, DISC_MEDITATION_MONK, STAT_INT, "chi", TASK_NORMAL, LAG_4, POSITION_CRAWLING, MANA_0, LIFEFORCE_0, PRAY_0, 0, SYMBOL_STRESS_0, "You feel your inner chi recharge.", "", "You feel your chi running low.", "", START_1, LEARN_1, START_DO_1, LEARN_DO_1, START_DO_NO, LEARN_DO_NO, LEARN_DIFF_SKILLS, 0.0, 0, 0);
