...
// disc_advanced_adventuring
  ...
  discArray[SKILL_ENCAMP] = new spellInfo(SKILL_GENERAL, DISC_ADVANCED_ADVENTURING, DISC_ADVANCED_ADVENTURING, STAT_EXT, "encamp", TASK_EASY, LAG_0, POSITION_CRAWLING, MANA_0, LIFEFORCE_0, PRAY_0, 0, SYMBOL_STRESS_0, "", "", "", "", START_26, LEARN_2, START_DO_1, LEARN_DO_2, START_DO_NO, LEARN_DO_NO, LEARN_DIFF_SKILLS, 0.0, 0, 0);
