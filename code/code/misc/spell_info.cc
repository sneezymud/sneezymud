...
// disc_cleric
  ...
  discArray[SPELL_HOLY_SMITE] = new spellInfo(SPELL_CLERIC, DISC_CLERIC, DISC_WRATH, STAT_WIS, "holy smite", TASK_NORMAL, LAG_3, POSITION_SITTING, MANA_0, LIFEFORCE_0, PRAY_100, TAR_CHAR_ROOM | TAR_FIGHT_VICT | TAR_SELF_NONO | TAR_VIOLENT, SYMBOL_STRESS_10, "", "", "", "", START_1, LEARN_10, START_DO_60, LEARN_DO_5, START_DO_NO, LEARN_DO_NO, LEARN_DIFF_PRAYERS, 0.01, COMP_GESTURAL | COMP_VERBAL, 0);

  discArray[SPELL_IMPROVED_SMITE] = new spellInfo(SKILL_CLERIC, DISC_CLERIC, DISC_WRATH, STAT_WIS, "improved smite", TASK_NORMAL, LAG_3, POSITION_SITTING, MANA_0, LIFEFORCE_0, PRAY_100, TAR_CHAR_ROOM | TAR_SELF_NONO | TAR_FIGHT_VICT | TAR_VIOLENT , SYMBOL_STRESS_10, "", "", "", "", START_40, LEARN_10, START_DO_50, LEARN_DO_5, START_DO_NO, LEARN_DO_NO, LEARN_DIFF_PRAYERS, 0.02, COMP_GESTURAL | COMP_VERBAL, 0);
