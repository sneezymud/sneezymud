...
// disc_deikhan
  ...
  discArray[SKILL_AURA_MIGHT] = new spellInfo(SKILL_DEIKHAN, DISC_DEIKHAN, DISC_DEIKHAN_FIGHT, "aura of might", TASK_NORMAL, LAG_2, POSITION_SITTING, MANA_0, LIFEFORCE_0, PRAY_0, 0, SYMBOL_STRESS_0, "You stop projecting an aura of might.", "", "", "", START_70, LEARN_4, START_DO_NO, LEARN_DO_NO, START_DO_NO, LEARN_DO_NO, LEARN_DIFF_SKILLS, 0.0, 0, 0);
  
  discArray[SKILL_AURA_REGENERATION] = new spellInfo(SKILL_DEIKHAN, DISC_DEIKHAN, DISC_DEIKHAN_FIGHT, "aura of regeneration", TASK_NORMAL, LAG_2, POSITION_SITTING, MANA_0, LIFEFORCE_0, PRAY_0, 0, SYMBOL_STRESS_0, "You stop projecting an aura of regeneration.", "", "", "", START_30, LEARN_4, START_DO_NO, LEARN_DO_NO, START_DO_NO, LEARN_DO_NO, LEARN_DIFF_SKILLS, 0.0, 0, 0);
