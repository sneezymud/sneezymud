...
// disc_deikhan_cures
  ...
  discArray[SKILL_LAY_HANDS] = new spellInfo(SKILL_DEIKHAN, DISC_DEIKHAN_CURES, DISC_DEIKHAN_CURES, "lay hands", TASK_NORMAL, LAG_1, POSITION_STANDING, MANA_0, LIFEFORCE_0, PRAY_0, 0, SYMBOL_STRESS_0, "", "", "", "", START_1, LEARN_3, START_DO_35, LEARN_DO_2, START_DO_NO, LEARN_DO_NO, LEARN_DIFF_SKILLS, 0.4, 0, 0);
...
// disc_adventuring
  ...
  discArray[SKILL_TOUGHNESS] = new spellInfo(SKILL_GENERAL, DISC_DEFENSE, DISC_DEFENSE, "toughness", TASK_NORMAL, LAG_0, POSITION_SITTING, MANA_0, LIFEFORCE_0, PRAY_0, 0, SYMBOL_STRESS_0, "", "", "", "", START_1, LEARN_1, START_DO_1, LEARN_DO_1, START_DO_NO, LEARN_DO_NO, LEARN_DIFF_UNUSUAL, 0.0, 0, 0);

  // disc_offense

  discArray[SKILL_ADVANCED_OFFENSE] = new spellInfo(SKILL_GENERAL, DISC_OFFENSE, DISC_OFFENSE, "advanced offense", TASK_NORMAL, LAG_0, POSITION_SITTING, MANA_0, LIFEFORCE_0, PRAY_0, 0, SYMBOL_STRESS_0, "", "", "", "", START_1, LEARN_1, START_DO_1, LEARN_DO_1, START_DO_NO, LEARN_DO_NO, LEARN_DIFF_UNUSUAL, 0.0, 0, 0);

  discArray[SKILL_INEVITABILITY] = new spellInfo(SKILL_GENERAL, DISC_OFFENSE, DISC_OFFENSE, "inevitability", TASK_NORMAL, LAG_0, POSITION_SITTING, MANA_0, LIFEFORCE_0, PRAY_0, 0, SYMBOL_STRESS_0, "", "", "", "", START_1, LEARN_1, START_DO_1, LEARN_DO_1, START_DO_NO, LEARN_DO_NO, LEARN_DIFF_UNUSUAL, 0.0, 0, 0);
