...
const unsigned int Garble::SPEECH_FLAG_GROUPTELL =
  (1 << Garble::SPEECH_GROUPTELL);
...
const unsigned int Garble::SPEECH_FLAG_ROOMDESC =
  (1 << Garble::SPEECH_ROOMDESC);
const unsigned int Garble::SPEECH_FLAG_EMOTE = (1 << Garble::SPEECH_EMOTE);

const unsigned int Garble::SPEECH_FLAG_VERBAL =
  (SPEECH_FLAG_SAY | SPEECH_FLAG_ASK | SPEECH_FLAG_WHISPER | SPEECH_FLAG_TELL |
    SPEECH_FLAG_SHOUT);
const unsigned int Garble::SPEECH_FLAG_VERBALEM =
  (SPEECH_FLAG_VERBAL | SPEECH_FLAG_EMOTE);
const unsigned int Garble::SPEECH_FLAG_NONVERBAL =
  (SPEECH_FLAG_COMMUNE | SPEECH_FLAG_SIGN | SPEECH_FLAG_WRITE |
    SPEECH_FLAG_WIZNET | SPEECH_FLAG_GROUPTELL | SPEECH_FLAG_EMOTE);
const unsigned int Garble::SPEECH_FLAG_LOCAL =
  (SPEECH_FLAG_SAY | SPEECH_FLAG_ASK | SPEECH_FLAG_WHISPER | SPEECH_FLAG_SIGN |
    SPEECH_FLAG_EMOTE);
const unsigned int Garble::SPEECH_FLAG_DIRECTED =
  (SPEECH_FLAG_TELL | SPEECH_FLAG_ASK | SPEECH_FLAG_WHISPER);
const unsigned int Garble::SPEECH_FLAG_NONWRITE =
  (SPEECH_FLAG_SAY | SPEECH_FLAG_ASK | SPEECH_FLAG_WHISPER | SPEECH_FLAG_TELL |
    SPEECH_FLAG_GROUPTELL | SPEECH_FLAG_COMMUNE | SPEECH_FLAG_SIGN |
    SPEECH_FLAG_SHOUT | SPEECH_FLAG_WIZNET | SPEECH_FLAG_EMOTE);
...
Garble GarbleData[Garble::TYPE_MAX] = {
  {"innuendo", "Makes the character end sentences, if you know what I mean",
    false, Garble::SCOPE_EVERYONE, garble_innuendo, Garble::SPEECH_FLAG_VERBAL},
  {"excited", "Makes the character end phrases with exclamations!!", false,
    Garble::SCOPE_EVERYONE, garble_excited, Garble::SPEECH_FLAG_VERBAL},
  {"sign", "Applies to signing, if the character's skill level < maxed", true,
    Garble::SCOPE_EVERYONE, garble_sign, Garble::SPEECH_FLAG_SIGN},
  {"ghost", "Makes the character talk OOooooo scary!", false,
    Garble::SCOPE_EVERYONE, garble_ghost, Garble::SPEECH_FLAG_VERBALEM},
  {"wahwah", "Makes the character cry like a little baby", false,
    Garble::SCOPE_EVERYONE, garble_wahwah, Garble::SPEECH_FLAG_VERBALEM},
  {"blahblah", "Interjects blah blah into the player's shouts", false,
    Garble::SCOPE_EVERYONE, garble_blahblah, Garble::SPEECH_FLAG_SHOUT},
  {"drunk", "Makes the character talk (and view room) drunkenly", true,
    Garble::SCOPE_EVERYONEANDSELF, garble_drunk,
    Garble::SPEECH_FLAG_VERBAL | Garble::SPEECH_FLAG_ROOMDESC},
  {"pg13out",
    "Makes the character tone down their swear words (to other people)", true,
    Garble::SCOPE_INDIVIDUAL, garble_PG13filter, Garble::SPEECH_FLAG_NONWRITE},
  {"pg13all", "Makes the character not get or say any swear words", true,
    Garble::SCOPE_EVERYONE, garble_PG13filter, Garble::SPEECH_FLAG_NONWRITE},
  {"glubglub", "Makes the character say glub glub", true,
    Garble::SCOPE_EVERYONE, garble_glubglub, Garble::SPEECH_FLAG_VERBALEM},
  {"pirate", "Makes the character talk like a pirate", false,
    Garble::SCOPE_EVERYONE, garble_pirate, Garble::SPEECH_FLAG_VERBAL},
  {"freshprince", "Makes the character do the fresh prince of Brightmoon rap",
    false, Garble::SCOPE_EVERYONE, garble_freshprince, Garble::SPEECH_FLAG_SAY},
  {"fishtalk", "Makes the character talk like they are a fish to non-fish",
    false, Garble::SCOPE_INDIVIDUAL, garble_fishtalk,
    Garble::SPEECH_FLAG_VERBALEM},
  {"lolcats", "Makes the character do a lolcats talk (used for gnolls)", false,
    Garble::SCOPE_INDIVIDUAL, garble_lolcats, Garble::SPEECH_FLAG_VERBALEM},
  {"vampire", "Makes the character talk like a vampire", false,
    Garble::SCOPE_EVERYONE, garble_vampire, Garble::SPEECH_FLAG_VERBALEM},
  {"igor", "Makes the character talk like an igor", false,
    Garble::SCOPE_EVERYONE, garble_igor, Garble::SPEECH_FLAG_VERBALEM},
  {"olddrunk", "Makes the character talk in the old-school drunk code", false,
    Garble::SCOPE_EVERYONEANDSELF, garble_olddrunk,
    Garble::SPEECH_FLAG_VERBAL | Garble::SPEECH_FLAG_ROOMDESC},
  {"irish", "Makes the character talk with an irish accent", false,
    Garble::SCOPE_EVERYONE, garble_irish, Garble::SPEECH_FLAG_VERBALEM},
  {"trolltalk", "Makes the character talk like a troll to non-trolls", false,
    Garble::SCOPE_INDIVIDUAL, garble_trolltalk, Garble::SPEECH_FLAG_VERBALEM},
  {"frogtalk", "Makes the character talk like a frogman to non-frogs", false,
    Garble::SCOPE_INDIVIDUAL, garble_frogtalk, Garble::SPEECH_FLAG_VERBALEM},
  {"birdtalk", "Makes the character talk like an aarakocra to non-aarakocra",
    false, Garble::SCOPE_INDIVIDUAL, garble_birdtalk,
    Garble::SPEECH_FLAG_VERBALEM},
  {"gutter",
    "Makes the character talk a bit cockney (used for goblins and orcs)", false,
    Garble::SCOPE_INDIVIDUAL, garble_gutter, Garble::SPEECH_FLAG_VERBALEM},
  {"trogtalk", "Makes the character talk like a troglodyte to non-trogs", false,
    Garble::SCOPE_INDIVIDUAL, garble_trogtalk, Garble::SPEECH_FLAG_VERBALEM},
  {"crazyfrog", "Like frogtalk, except it effects rooms as well", false,
    Garble::SCOPE_EVERYONEANDSELF, garble_frogtalk,
    Garble::SPEECH_FLAG_VERBALEM | Garble::SPEECH_FLAG_ROOMDESC},
};
...
// toggling off an automatic will turn it off, unless they are in a situation
// where they'd get it on automatically (like say they were drunk and you
// toggled off garble_trunk)
int TBeing::toggleGarble(Garble::TYPE garble) {
  ...
  if ((my_garbleFlags & Garble::TYPE_FLAG_PG13OUT) && desc &&
      !IS_SET(desc->autobits, AUTO_PG13))
    SET_BIT(desc->autobits, AUTO_PG13);
  else if (!(my_garbleFlags & Garble::TYPE_FLAG_PG13OUT) && desc &&
           IS_SET(desc->autobits, AUTO_PG13))
    REMOVE_BIT(desc->autobits, AUTO_PG13);

  if ((my_garbleFlags & Garble::TYPE_FLAG_BLAHBLAH) &&
      !hasQuestBit(TOG_BLAHBLAH))
    setQuestBit(TOG_BLAHBLAH);
  else if (!(my_garbleFlags & Garble::TYPE_FLAG_BLAHBLAH) &&
           hasQuestBit(TOG_BLAHBLAH))
...
sstring TBeing::garble(TBeing* to, const sstring& arg,
  ...
  for (int iGarble = 0; !garbled.empty() && iGarble < Garble::TYPE_MAX;
       iGarble++) {
    ...
    // skip if this speechtype doesnt match the given garble's set of
    // speechtypes
...
sstring garble_PG13filter(TBeing* from, TBeing* to, const sstring& arg,
  ...
  for (int i = 0; !arg.word(i).empty(); ++i) {
    word = arg.word(i);
    for (int j = 0; j < 24; j++)  // up to but excluding "ass" (otherwise you
                                  // can't say 'class', 'assist', 'seabass')
    {
...
sstring garble_olddrunk(TBeing* from, TBeing* to, const sstring& arg,
  ...
  // if this garble was applied without us being drunk, assume an average
  // drunkenness
  if (chance < 9)
    chance = 15;
...
sstring garble_innuendo(TBeing* from, TBeing* to, const sstring& arg,
  ...
  sstring::size_type st =
    arg.find_last_not_of("?!,./;:'\"]}[{\\|=+-_`~@#$%^&*()");
  if (st != sstring::npos)
    buf.erase(st + 1);
...
sstring garble_pirate(TBeing* from, TBeing* to, const sstring& arg,
  ...
  for (unsigned int iReplace = 0; iReplace < cElements(pirate_replace);) {
    ...
    if (pirate_replace[iReplace][0].length() <
        pirate_replace[iReplace][1].length())
      garble.resize(garble.size() + pirate_replace[iReplace][1].length() -
                      pirate_replace[iReplace][0].length(),
        ' ');

    // replace it, and step forward
    garble.replace(start, pirate_replace[iReplace][0].length(),
      pirate_replace[iReplace][1]);
    start += pirate_replace[iReplace][1].length();

    // if we end the replace with a space, backup one so that we can overlap
    // word replacements
...
sstring garble_freshprince(TBeing* from, TBeing* to, const sstring& arg,
  ...
  // this function means its global, so 2 people can have the same garble and
  // end up rhyming together
...
sstring garble_fishtalk(TBeing* from, TBeing* to, const sstring& arg,
  ...
  for (sstring word = arg.word(iWord); !word.empty();
       word = arg.word(++iWord)) {
    if (!out.empty())
      out += ' ';
...
sstring garble_lolcats(TBeing* from, TBeing* to, const sstring& arg,
  ...
  for (sstring word = arg.word(iWord); !word.empty();
    ...
    if (chance > number(0, 100)) {
      ...
      for (int iReplace = 0; iReplace < (int)cElements(lolcats_replace);
           iReplace++)
        munged.inlineReplaceString(lolcats_replace[iReplace][0],
          lolcats_replace[iReplace][1]);
...
sstring garble_drunk(TBeing* from, TBeing* to, const sstring& arg,
  ...
  for (sstring word = out.word(iWord); !word.empty();
       word = arg.word(++iWord)) {
    ...
    for (loc = word.length() - 1;
         loc > 0 && (!isalpha(word[loc]) || word[loc - 1] == '<'); loc--)
      tail = word[loc] + tail;
    if (tail.length() > 0)
    ...
    if (word.length() > 8 && (!::number(0, 4) || chance > 14)) {
      if (!::number(0, 1))
        word = sstring("...") +
               word.substr(word.length() - ::number(3, 4), word.length() - 1);
      else
        word = word.substr(0, word.length() - ::number(4, 5)) + sstring("...");
      modified = true;
    }

    // any word which has repeating character subsets will have a chance of
    // repeating the subset agian 1-3 times.  "Banana" has a repeating "an" in
    // it, so if it repeats 1 time, itll go "Bananana".  You do this: take the
    // length, divide by two -> n. From n down to 2 in length, look for
    // substrings in the string of that length which repeat. If so, find the end
    // of the repeating substring and repeat it.
    int iStart = 0, cSub = 0;
    bool match = false;
    for (cSub = (int)word.length() / 2; !match && cSub > 1; cSub--)
      for (iStart = 0; !match && iStart + cSub + cSub <= (int)word.length();
           iStart++) {
        match = true;
        for (int iScan = 0; match && iScan < cSub; iScan++)
          match =
            word.c_str()[iStart + iScan] == word.c_str()[iStart + cSub + iScan];
      }
    if (match) {
      cSub++;
      iStart--;
...
sstring garble_birdtalk(TBeing* from, TBeing* to, const sstring& arg,
  ...
  for (sstring word = arg.word(iWord); !word.empty();
    ...
    if (chance / 4 > number(0, 100)) {
      out +=
        sstring(birdsquak_prefix[number(0, cElements(birdsquak_prefix) - 1)] +
                birdsquak_suffix[number(0, cElements(birdsquak_suffix) - 1)])
          .matchCase(word);
      out += ' ';
    }
...
const sstring RandomWord() {
  static const sstring str[] = {
    ...
    "hussamah",  // 5
    "rodina", "mustafah", "angina", "the",
    "fribble",  // 10 */
    "fnort", "frobozz", "zarp", "ripple",
    "yrk",  // 15 */
    "yid", "yerf", "oork", "beavis",
    "butthead",  // 20 */
    "rod", "johnson", "tool", "ftagn",
    "hastur",  // 25 */
    "brob", "gnort", "lram", "truck",
    "kill",  // 30 */
    "cthulhu", "huzzah", "fish", "chicken",
    "summah",  // 35 */
    "hummah", "cookies", "stan", "will",
    "wadapatang",  // 40 */
    "pterodactyl", "frob", "yuma", "gumma",
    "lo-pan",  // 45 */
    "sushi", "yaya", "yoyodine", "your",
    "mother"  // 50 */
  };
