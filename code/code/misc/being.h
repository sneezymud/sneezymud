...
class TBeing : public TThing {
  ...
  public:
    ...
    void vineBleedLeg(int affLevel);
  ...
  int doTripleKick(const char *, int, TBeing *);
    ...
    bool isStrong(int num = 0) const;
    bool isPerceptive(int num = 0) const;
    bool isDextrous(int num = 0) const;
    bool isAgile(int num = 0) const;
    bool isTough(int num = 0) const;
    bool isBrawny(int num = 0) const;
    bool isIntelligent(int num = 0) const;
    bool isWise(int num = 0) const;
    bool isFast(int num = 0) const;
    bool isFocused(int num = 0) const;
    bool isCharismatic(int num = 0) const;
    bool isKarmic(int num = 0) const;
    bool isUgly(int num = 0) const;
