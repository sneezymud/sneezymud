...
class TBeing : public TThing {
  ...
  public:
    ...
    double plotStat(statSetT, statTypeT, double, double, double,
      double n = 1.4) const;
    int plotStat(statSetT, statTypeT, int a, int b, int c,
      double n = 1.4) const;
    float plotStat(statSetT, statTypeT, float a, float b, float c,
      double n = 1.4) const;
