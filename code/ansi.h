...
const char * const ANSI_BLUE             = "\033[0;34m";
const char * const ANSI_BLUE_BOLD        = "\033[1;34m";
const char * const ANSI_PURPLE           = "\033[0;35m";
const char * const ANSI_PURPLE_BOLD      = "\033[1;35m";
const char * const ANSI_CYAN             = "\033[0;36m";
const char * const ANSI_CYAN_BOLD        = "\033[1;36m";
const char * const ANSI_WHITE            = "\033[0;37m";
