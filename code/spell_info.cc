...
// disc_theology
  ...
  // psionics
discArray[SKILL_PSITELEPATHY] = new spellInfo(SKILL_GENERAL, DISC_PSIONICS, DISC_PSIONICS, "psionic telepathy", TASK_EASY, LAG_0, POSITION_STANDING, MANA_0, LIFEFORCE_0, PRAY_0, 0, SYMBOL_STRESS_0, "", "", "", "", START_1, LEARN_5, START_DO_1, LEARN_DO_1, START_DO_NO, LEARN_DO_NO, LEARN_DIFF_SKILLS, 0.0, 0, 0);

discArray[SKILL_TELE_SIGHT] = new spellInfo(SKILL_GENERAL, DISC_PSIONICS, DISC_PSIONICS, "telepathic sight", TASK_EASY, LAG_0, POSITION_STANDING, MANA_0, LIFEFORCE_0, PRAY_0, 0, SYMBOL_STRESS_0, "", "", "", "", START_1, LEARN_5, START_DO_1, LEARN_DO_1, START_DO_NO, LEARN_DO_NO, LEARN_DIFF_SKILLS, 0.0, 0, 0);

discArray[SKILL_TELE_VISION] = new spellInfo(SKILL_GENERAL, DISC_PSIONICS, DISC_PSIONICS, "telepathic vision", TASK_EASY, LAG_3, POSITION_STANDING, MANA_0, LIFEFORCE_0, PRAY_0, 0, SYMBOL_STRESS_0, "", "", "", "", START_1, LEARN_5, START_DO_1, LEARN_DO_1, START_DO_NO, LEARN_DO_NO, LEARN_DIFF_SKILLS, 0.0, 0, 0);

discArray[SKILL_MIND_FOCUS] = new spellInfo(SKILL_GENERAL, DISC_PSIONICS, DISC_PSIONICS, "mind focus", TASK_EASY, LAG_1, POSITION_STANDING, MANA_0, LIFEFORCE_0, PRAY_0, 0, SYMBOL_STRESS_0, "", "", "", "", START_1, LEARN_5, START_DO_1, LEARN_DO_1, START_DO_NO, LEARN_DO_NO, LEARN_DIFF_SKILLS, 0.0, 0, 0);

discArray[SKILL_PSI_BLAST] = new spellInfo(SKILL_GENERAL, DISC_PSIONICS, DISC_PSIONICS, "psionic blast", TASK_EASY, LAG_3, POSITION_STANDING, MANA_0, LIFEFORCE_0, PRAY_0, 0, SYMBOL_STRESS_0, "", "", "", "", START_1, LEARN_5, START_DO_1, LEARN_DO_1, START_DO_NO, LEARN_DO_NO, LEARN_DIFF_SKILLS, 0.0, 0, 0);

discArray[SKILL_MIND_THRUST] = new spellInfo(SKILL_GENERAL, DISC_PSIONICS, DISC_PSIONICS, "mind thrust", TASK_EASY, LAG_3, POSITION_STANDING, MANA_0, LIFEFORCE_0, PRAY_0, 0, SYMBOL_STRESS_0, "", "", "", "", START_1, LEARN_5, START_DO_1, LEARN_DO_1, START_DO_NO, LEARN_DO_NO, LEARN_DIFF_SKILLS, 0.0, 0, 0);

discArray[SKILL_PSYCHIC_CRUSH] = new spellInfo(SKILL_GENERAL, DISC_PSIONICS, DISC_PSIONICS, "psychic crush", TASK_EASY, LAG_3, POSITION_STANDING, MANA_0, LIFEFORCE_0, PRAY_0, 0, SYMBOL_STRESS_0, "", "", "", "", START_1, LEARN_5, START_DO_1, LEARN_DO_1, START_DO_NO, LEARN_DO_NO, LEARN_DIFF_SKILLS, 0.0, 0, 0);

discArray[SKILL_KINETIC_WAVE] = new spellInfo(SKILL_GENERAL, DISC_PSIONICS, DISC_PSIONICS, "kinetic wave", TASK_EASY, LAG_3, POSITION_STANDING, MANA_0, LIFEFORCE_0, PRAY_0, 0, SYMBOL_STRESS_0, "", "", "", "", START_1, LEARN_5, START_DO_1, LEARN_DO_1, START_DO_NO, LEARN_DO_NO, LEARN_DIFF_SKILLS, 0.0, 0, 0);

discArray[SKILL_MIND_PRESERVATION] = new spellInfo(SKILL_GENERAL, DISC_PSIONICS, DISC_PSIONICS, "mind preservation", TASK_EASY, LAG_0, POSITION_STANDING, MANA_0, LIFEFORCE_0, PRAY_0, 0, SYMBOL_STRESS_0, "", "", "", "", START_1, LEARN_5, START_DO_1, LEARN_DO_1, START_DO_NO, LEARN_DO_NO, LEARN_DIFF_SKILLS, 0.0, 0, 0);

discArray[SKILL_TELEKINESIS] = new spellInfo(SKILL_GENERAL, DISC_PSIONICS, DISC_PSIONICS, "telekinesis", TASK_EASY, LAG_3, POSITION_STANDING, MANA_0, LIFEFORCE_0, PRAY_0, 0, SYMBOL_STRESS_0, "", "", "", "", START_1, LEARN_5, START_DO_1, LEARN_DO_1, START_DO_NO, LEARN_DO_NO, LEARN_DIFF_SKILLS, 0.0, 0, 0);
// end psionics

// MAGE THIEF ********************************************************

  discArray[SKILL_BACKSTAB_MT] = new spellInfo(SKILL_MAGE_TYPES, DISC_MAGE_THIEF, DISC_MAGE_THIEF, "backstab", TASK_NORMAL, LAG_5, POSITION_CRAWLING, MANA_0, LIFEFORCE_0, PRAY_0, 0, SYMBOL_STRESS_0, "", "", "", "", START_1, LEARN_1, START_DO_1, LEARN_DO_2, START_DO_NO, LEARN_DO_NO, LEARN_DIFF_SKILLS, 0.0, 0, 0);
