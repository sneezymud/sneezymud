...
// disc_monk
 ...
 discArray[SKILL_CINTAI] = new spellInfo(SKILL_MONK, DISC_MONK, DISC_FOCUSED_ATTACKS, "cintai", TASK_NORMAL, LAG_0, POSITION_DEAD, MANA_0, LIFEFORCE_0, PRAY_0, 0, SYMBOL_STRESS_0, "", "", "", "", START_5, LEARN_2, START_DO_1, LEARN_DO_1, START_DO_NO, LEARN_DO_NO, LEARN_DIFF_SKILLS, 0.0, 0, 0);
  ...
  discArray[SKILL_CATLEAP] = new spellInfo(SKILL_MONK, DISC_MONK, DISC_MINDBODY, "catleap", TASK_NORMAL, LAG_0, POSITION_STANDING, MANA_0, LIFEFORCE_0, PRAY_0, 0, SYMBOL_STRESS_0, "", "", "", "", START_1, LEARN_2, START_DO_1, LEARN_DO_5, START_DO_NO, LEARN_DO_NO, LEARN_DIFF_SKILLS, 0.0, 0, TOG_HAS_CATLEAP);
