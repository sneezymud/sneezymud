...
// disc_ranger
  ...
  */
  ...
  discArray[SKILL_SACRIFICE] = new spellInfo(SKILL_SHAMAN, DISC_SHAMAN, DISC_SHAMAN, "sacrifice", TASK_NORMAL, LAG_0, POSITION_SITTING, MANA_0, LIFEFORCE_0, PRAY_0, 0, SYMBOL_STRESS_0, "", "", "", "", START_1, LEARN_6, START_DO_35, LEARN_DO_1, START_DO_NO, LEARN_DO_NO, LEARN_DIFF_SKILLS, 0.0, 0, 0);
  ...
  discArray[SPELL_AQUATIC_BLAST] = new spellInfo(SPELL_SHAMAN, DISC_SHAMAN_FROG, DISC_SHAMAN_FROG, "aquatic blast", TASK_NORMAL, LAG_1, POSITION_SITTING, MANA_0, LIFEFORCE_80, PRAY_0, TAR_CHAR_ROOM | TAR_SELF_NONO | TAR_VIOLENT | TAR_FIGHT_VICT , SYMBOL_STRESS_0, "", "", "", "", START_55, LEARN_20, START_DO_40, LEARN_DO_5, START_DO_NO, LEARN_DO_NO, LEARN_DIFF_SPELLS, 0.05, COMP_GESTURAL | COMP_GESTURAL_RANDOM | COMP_VERBAL | COMP_VERBAL_RANDOM | COMP_MATERIAL | COMP_MATERIAL_END | SPELL_TASKED, 0);

  discArray[SPELL_LICH_TOUCH] = new spellInfo(SPELL_SHAMAN, DISC_SHAMAN_SKUNK, DISC_SHAMAN_SKUNK, "lich touch", TASK_DIFFICULT, LAG_3, POSITION_SITTING, MANA_0, LIFEFORCE_125, PRAY_0, TAR_CHAR_ROOM | TAR_SELF_NONO | TAR_VIOLENT | TAR_FIGHT_VICT , SYMBOL_STRESS_0, "", "", "", "", START_50, LEARN_5, START_DO_50, LEARN_DO_2, START_DO_NO, LEARN_DO_NO, LEARN_DIFF_SPELLS, 0.04, COMP_GESTURAL | COMP_VERBAL | COMP_MATERIAL  | COMP_MATERIAL_END | SPELL_TASKED, 0);

  discArray[SPELL_VAMPIRIC_TOUCH] = new spellInfo(SPELL_SHAMAN, DISC_SHAMAN, DISC_SHAMAN_SKUNK, "vampiric touch", TASK_DIFFICULT, LAG_3, POSITION_SITTING, MANA_0, LIFEFORCE_70, PRAY_0, TAR_CHAR_ROOM | TAR_SELF_NONO | TAR_VIOLENT | TAR_FIGHT_VICT , SYMBOL_STRESS_0, "", "", "", "", START_80, LEARN_5, START_DO_50, LEARN_DO_2, START_DO_NO, LEARN_DO_NO, LEARN_DIFF_SPELLS, 0.04, COMP_GESTURAL | COMP_VERBAL | COMP_MATERIAL  | COMP_MATERIAL_END | SPELL_TASKED, 0);
...
// disc_undead
  ...
  discArray[SPELL_LIFE_LEECH] = new spellInfo(SPELL_SHAMAN, DISC_SHAMAN, DISC_SHAMAN_SPIDER, "life leech", TASK_DIFFICULT, LAG_3, POSITION_SITTING, MANA_0, LIFEFORCE_40, PRAY_0, TAR_CHAR_ROOM | TAR_SELF_NONO | TAR_VIOLENT | TAR_FIGHT_VICT , SYMBOL_STRESS_0, "", "", "", "", START_3, LEARN_5, START_DO_25, LEARN_DO_1, START_DO_NO, LEARN_DO_NO, LEARN_DIFF_SPELLS, 0.04, COMP_GESTURAL | COMP_VERBAL | COMP_MATERIAL  | COMP_MATERIAL_END | SPELL_TASKED, 0);
