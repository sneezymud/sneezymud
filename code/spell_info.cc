...
// disc_theology
  ...
  discArray[SPELL_DISTORT] = new spellInfo(SPELL_SHAMAN, DISC_SHAMAN, DISC_SHAMAN_FROG, "distort", TASK_NORMAL, LAG_1, POSITION_SITTING, MANA_0, LIFEFORCE_30, PRAY_0, TAR_CHAR_ROOM | TAR_SELF_NONO | TAR_VIOLENT | TAR_FIGHT_VICT , SYMBOL_STRESS_0, "", "", "", "", START_12, LEARN_25, START_DO_40, LEARN_DO_5, START_DO_NO, LEARN_DO_NO, LEARN_DIFF_SPELLS, 0.04, COMP_GESTURAL | COMP_GESTURAL_RANDOM | COMP_VERBAL | COMP_VERBAL_RANDOM | SPELL_TASKED, 0);

  discArray[SPELL_LEGBA] = new spellInfo(SPELL_SHAMAN, DISC_SHAMAN, DISC_SHAMAN_ARMADILLO, "legba's guidance", TASK_NORMAL, LAG_2, POSITION_CRAWLING, MANA_0, LIFEFORCE_70, PRAY_0, TAR_SELF_ONLY | TAR_FIGHT_SELF | TAR_CHAR_ROOM, SYMBOL_STRESS_0, "", "", "", "", START_80, LEARN_10, START_DO_30, LEARN_DO_5, START_DO_NO, LEARN_DO_NO, LEARN_DIFF_SPELLS, 0.04, COMP_GESTURAL | COMP_GESTURAL_RANDOM | COMP_VERBAL | COMP_VERBAL_RANDOM | COMP_MATERIAL | COMP_MATERIAL_END |SPELL_TASKED, 0);

  discArray[SPELL_DJALLA] = new spellInfo(SPELL_SHAMAN, DISC_SHAMAN, DISC_SHAMAN_ARMADILLO, "djalla's protection", TASK_NORMAL, LAG_2, POSITION_CRAWLING, MANA_0, LIFEFORCE_60, PRAY_0, TAR_SELF_ONLY | TAR_FIGHT_SELF | TAR_CHAR_ROOM, SYMBOL_STRESS_0, "", "", "", "", START_75, LEARN_10, START_DO_30, LEARN_DO_5, START_DO_NO, LEARN_DO_NO, LEARN_DIFF_SPELLS, 0.04, COMP_GESTURAL | COMP_GESTURAL_RANDOM | COMP_VERBAL | COMP_VERBAL_RANDOM | COMP_MATERIAL | COMP_MATERIAL_END |SPELL_TASKED, 0);
  ...
  discArray[SPELL_DETECT_SHADOW] = new spellInfo(SPELL_SHAMAN, DISC_SHAMAN, DISC_SHAMAN_ARMADILLO, "detect shadow", TASK_DIFFICULT, LAG_2, POSITION_CRAWLING, MANA_0, LIFEFORCE_70, PRAY_0, TAR_SELF_ONLY | TAR_FIGHT_SELF | TAR_CHAR_ROOM, SYMBOL_STRESS_0, "Your eyes sting a little.", "$n seems to be having some vision problems.", "", "", START_85, LEARN_10, START_DO_40, LEARN_DO_5, START_DO_NO, LEARN_DO_NO, LEARN_DIFF_SPELLS, 0.04, COMP_GESTURAL | COMP_GESTURAL_RANDOM | COMP_VERBAL | COMP_VERBAL_RANDOM | COMP_MATERIAL | COMP_MATERIAL_END |SPELL_TASKED, 0);
  ...
  discArray[SPELL_STICKS_TO_SNAKES] = new spellInfo(SPELL_SHAMAN, DISC_SHAMAN_SPIDER, DISC_SHAMAN_SPIDER, "sticks to snakes", TASK_NORMAL, LAG_3, POSITION_SITTING, MANA_0, LIFEFORCE_160, PRAY_0, TAR_CHAR_ROOM | TAR_VIOLENT | TAR_FIGHT_VICT | TAR_SELF_NONO, SYMBOL_STRESS_0, "Your snake has reverted into a stick.", "$n's snake has reverted back into sticks.", "", "", START_1, LEARN_3, START_DO_30, LEARN_DO_5, START_DO_NO, LEARN_DO_NO, LEARN_DIFF_SPELLS, 0.04, COMP_GESTURAL | COMP_VERBAL | COMP_MATERIAL, 0);

  discArray[SPELL_STORMY_SKIES] = new spellInfo(SPELL_SHAMAN, DISC_SHAMAN_FROG, DISC_SHAMAN_FROG, "stormy skies", TASK_DANGEROUS, LAG_4, POSITION_SITTING, MANA_0, LIFEFORCE_170, PRAY_0, TAR_CHAR_ROOM | TAR_SELF_NONO | TAR_VIOLENT | TAR_FIGHT_VICT , SYMBOL_STRESS_0, "", "", "", "", START_1, LEARN_3, START_DO_40, LEARN_DO_5, START_DO_NO, LEARN_DO_NO, LEARN_DIFF_SPELLS, 0.05, COMP_GESTURAL | COMP_GESTURAL_RANDOM | COMP_VERBAL | COMP_VERBAL_RANDOM | COMP_MATERIAL | COMP_MATERIAL_END | SPELL_TASKED, 0);
  ...
  discArray[SPELL_ROMBLER] = new spellInfo(SPELL_SHAMAN, DISC_SHAMAN, DISC_SHAMAN, "romble", TASK_NORMAL, LAG_0, POSITION_CRAWLING, MANA_0, LIFEFORCE_20, PRAY_0, TAR_NAME, SYMBOL_STRESS_0, "", "", "", "", START_47, LEARN_15, START_DO_50, LEARN_DO_5, START_DO_NO, LEARN_DO_NO, LEARN_DIFF_SPELLS, 0.04, COMP_GESTURAL | COMP_GESTURAL_RANDOM | COMP_VERBAL | COMP_VERBAL_RANDOM | COMP_MATERIAL | COMP_MATERIAL_END | SPELL_TASKED, 0);
  ...
  discArray[SPELL_DEATH_MIST] = new spellInfo(SPELL_SHAMAN, DISC_SHAMAN_SKUNK, DISC_SHAMAN_SKUNK, "death mist", TASK_DIFFICULT, LAG_3, POSITION_SITTING, MANA_0, LIFEFORCE_260, PRAY_0, TAR_AREA | TAR_FIGHT_VICT | TAR_VIOLENT | TAR_IGNORE, SYMBOL_STRESS_0, "", "", "", "", START_75, LEARN_5, START_DO_50, LEARN_DO_5, START_DO_NO, LEARN_DO_NO, LEARN_DIFF_SPELLS, 0.04, COMP_GESTURAL | COMP_GESTURAL_RANDOM | COMP_VERBAL | COMP_VERBAL_RANDOM | COMP_MATERIAL | COMP_MATERIAL_END | SPELL_TASKED, 0);

  discArray[SPELL_CLARITY] = new spellInfo(SPELL_SHAMAN, DISC_SHAMAN_SPIDER, DISC_SHAMAN_SPIDER, "clarity", TASK_NORMAL, LAG_1, POSITION_CRAWLING, MANA_0, LIFEFORCE_200, PRAY_0, TAR_CHAR_ROOM | TAR_SELF_ONLY, SYMBOL_STRESS_0, "The green film on your eyes disolves.", "The green film on $n's eyes disolves.", "The film in your eyes becomes more transparent.", "", START_27, LEARN_8, START_DO_40, LEARN_DO_5, START_DO_NO, LEARN_DO_NO, LEARN_DIFF_SPELLS, 0.04, COMP_GESTURAL | COMP_GESTURAL_RANDOM | COMP_VERBAL | COMP_VERBAL_RANDOM | COMP_MATERIAL | COMP_MATERIAL_END | SPELL_TASKED, 0);

  discArray[SKILL_SACRIFICE] = new spellInfo(SKILL_SHAMAN, DISC_SHAMAN, DISC_SHAMAN, "sacrifice", TASK_DANGEROUS, LAG_0, POSITION_SITTING, MANA_0, LIFEFORCE_0, PRAY_0, 0, SYMBOL_STRESS_0, "", "", "", "", START_1, LEARN_1, START_DO_35, LEARN_DO_1, START_DO_NO, LEARN_DO_NO, LEARN_DIFF_SKILLS, 0.0, 0, 0);

  discArray[SPELL_AQUALUNG] = new spellInfo(SPELL_SHAMAN, DISC_SHAMAN_ARMADILLO, DISC_SHAMAN_ARMADILLO, "aqualung", TASK_EASY, LAG_2, POSITION_CRAWLING, MANA_0, LIFEFORCE_100, PRAY_0, TAR_CHAR_ROOM | TAR_FIGHT_SELF, SYMBOL_STRESS_0, "The transparent globe around your head disappears.", "The transparent globe around $n's head disappears.", "You begin to wonder how much longer you can breathe water.", "", START_26, LEARN_13, START_DO_45, LEARN_DO_5, START_DO_NO, LEARN_DO_NO, LEARN_DIFF_SPELLS, 0.02, COMP_GESTURAL | COMP_GESTURAL_RANDOM | COMP_VERBAL | COMP_VERBAL_RANDOM | COMP_MATERIAL | COMP_MATERIAL_END | SPELL_TASKED, 0);
  ...
  discArray[SPELL_AQUATIC_BLAST] = new spellInfo(SPELL_SHAMAN, DISC_SHAMAN_FROG, DISC_SHAMAN_FROG, "aquatic blast", TASK_DANGEROUS, LAG_4, POSITION_SITTING, MANA_0, LIFEFORCE_230, PRAY_0, TAR_CHAR_ROOM | TAR_SELF_NONO | TAR_VIOLENT | TAR_FIGHT_VICT , SYMBOL_STRESS_0, "", "", "", "", START_70, LEARN_20, START_DO_40, LEARN_DO_5, START_DO_NO, LEARN_DO_NO, LEARN_DIFF_SPELLS, 0.05, COMP_GESTURAL | COMP_GESTURAL_RANDOM | COMP_VERBAL | COMP_VERBAL_RANDOM | COMP_MATERIAL | COMP_MATERIAL_END | SPELL_TASKED, 0);

  discArray[SPELL_DEATHWAVE] = new spellInfo(SPELL_SHAMAN, DISC_SHAMAN_FROG, DISC_SHAMAN_FROG, "death wave", TASK_DANGEROUS, LAG_4, POSITION_SITTING, MANA_0, LIFEFORCE_160, PRAY_0, TAR_CHAR_ROOM | TAR_SELF_NONO | TAR_VIOLENT | TAR_FIGHT_VICT , SYMBOL_STRESS_0, "", "", "", "", START_35, LEARN_20, START_DO_40, LEARN_DO_5, START_DO_NO, LEARN_DO_NO, LEARN_DIFF_SPELLS, 0.05, COMP_GESTURAL | COMP_GESTURAL_RANDOM | COMP_VERBAL | COMP_VERBAL_RANDOM | COMP_MATERIAL | COMP_MATERIAL_END | SPELL_TASKED, 0);

  discArray[SPELL_CARDIAC_STRESS] = new spellInfo(SPELL_SHAMAN, DISC_SHAMAN_SKUNK, DISC_SHAMAN_SKUNK, "coronary", TASK_DANGEROUS, LAG_4, POSITION_SITTING, MANA_0, LIFEFORCE_240, PRAY_0, TAR_CHAR_ROOM | TAR_SELF_NONO | TAR_VIOLENT | TAR_FIGHT_VICT , SYMBOL_STRESS_0, "", "", "", "", START_55, LEARN_20, START_DO_40, LEARN_DO_5, START_DO_NO, LEARN_DO_NO, LEARN_DIFF_SPELLS, 0.05, COMP_GESTURAL | COMP_GESTURAL_RANDOM | COMP_VERBAL | COMP_VERBAL_RANDOM | COMP_MATERIAL | COMP_MATERIAL_END | SPELL_TASKED, 0);
  ...
  discArray[SPELL_THORNFLESH] = new spellInfo(SPELL_SHAMAN, DISC_SHAMAN_ARMADILLO, DISC_SHAMAN_ARMADILLO, "thornflesh", TASK_DIFFICULT, LAG_3, POSITION_CRAWLING, MANA_0, LIFEFORCE_300, PRAY_0, TAR_SELF_ONLY | TAR_FIGHT_SELF | TAR_CHAR_ROOM, SYMBOL_STRESS_0, "The thorns on your body fade away.", "The thorns on $n's body start to fade.", "The thorns on your body start to fade.", "", START_30, LEARN_4, START_DO_45, LEARN_DO_2, START_DO_NO, LEARN_DO_NO, LEARN_DIFF_SPELLS, 0.02, COMP_GESTURAL | COMP_GESTURAL_RANDOM | COMP_VERBAL | COMP_VERBAL_RANDOM | COMP_MATERIAL | COMP_MATERIAL_END | SPELL_TASKED, 0);

  discArray[SPELL_SHAPESHIFT] = new spellInfo(SPELL_SHAMAN, DISC_SHAMAN_FROG, DISC_SHAMAN_FROG, "shapeshift", TASK_NORMAL, LAG_2, POSITION_CRAWLING, MANA_0, LIFEFORCE_200, PRAY_0, TAR_NAME, SYMBOL_STRESS_0, "You are not able to hold this form any longer.", "", "You do not know how much longer you can hold this form.", "", START_40, LEARN_10, START_DO_50, LEARN_DO_4, START_DO_NO, LEARN_DO_NO, LEARN_DIFF_SPELLS, 0.0, COMP_GESTURAL | COMP_GESTURAL_RANDOM | COMP_VERBAL | COMP_VERBAL_RANDOM | COMP_MATERIAL | COMP_MATERIAL_END | SPELL_TASKED, 0);

  discArray[SPELL_ENTHRALL_SPECTRE] = new spellInfo(SPELL_SHAMAN, DISC_SHAMAN, DISC_SHAMAN, "enthrall spectre", TASK_DIFFICULT, LAG_1, POSITION_CRAWLING, MANA_0, LIFEFORCE_70, PRAY_0, TAR_IGNORE, SYMBOL_STRESS_0, "", "", "", "", START_35, LEARN_15, START_DO_50, LEARN_DO_5, START_DO_NO, LEARN_DO_NO, LEARN_DIFF_SPELLS, 0.00, COMP_GESTURAL | COMP_GESTURAL_RANDOM | COMP_VERBAL | COMP_VERBAL_RANDOM | COMP_MATERIAL | COMP_MATERIAL_END | SPELL_TASKED, 0);

  discArray[SPELL_ENTHRALL_GHOUL] = new spellInfo(SPELL_SHAMAN, DISC_SHAMAN_CONTROL, DISC_SHAMAN_CONTROL, "enthrall ghoul", TASK_DIFFICULT, LAG_1, POSITION_CRAWLING, MANA_0, LIFEFORCE_90, PRAY_0, TAR_IGNORE, SYMBOL_STRESS_0, "", "", "", "", START_63, LEARN_15, START_DO_50, LEARN_DO_5, START_DO_NO, LEARN_DO_NO, LEARN_DIFF_SPELLS, 0.0, COMP_GESTURAL | COMP_GESTURAL_RANDOM | COMP_VERBAL | COMP_VERBAL_RANDOM | COMP_MATERIAL | COMP_MATERIAL_END | SPELL_TASKED, 0);

  discArray[SPELL_ENTHRALL_GHAST] = new spellInfo(SPELL_SHAMAN, DISC_SHAMAN, DISC_SHAMAN, "enthrall ghast", TASK_DIFFICULT, LAG_1, POSITION_CRAWLING, MANA_0, LIFEFORCE_120, PRAY_0, TAR_IGNORE, SYMBOL_STRESS_0, "", "", "", "", START_57, LEARN_13, START_DO_50, LEARN_DO_5, START_DO_NO, LEARN_DO_NO, LEARN_DIFF_SPELLS, 0.0, COMP_GESTURAL | COMP_GESTURAL_RANDOM | COMP_VERBAL | COMP_VERBAL_RANDOM | COMP_MATERIAL | COMP_MATERIAL_END | SPELL_TASKED, 0);
  ...
  discArray[SPELL_SHADOW_WALK] = new spellInfo(SPELL_SHAMAN, DISC_SHAMAN_ARMADILLO, DISC_SHAMAN_ARMADILLO, "shadow walk", TASK_NORMAL, LAG_2, POSITION_CRAWLING, MANA_0, LIFEFORCE_300, PRAY_0, TAR_CHAR_ROOM | TAR_SELF_ONLY, SYMBOL_STRESS_0, "You no longer walk in the shadows.", "$n blinks into view.", "", "", START_15, LEARN_8, START_DO_45, LEARN_DO_5, START_DO_NO, LEARN_DO_NO, LEARN_DIFF_SPELLS, 0.04, COMP_GESTURAL | COMP_GESTURAL_RANDOM | COMP_VERBAL | COMP_VERBAL_RANDOM | COMP_MATERIAL | COMP_MATERIAL_END | SPELL_TASKED, 0);
  ...
  discArray[SPELL_VOODOO] = new spellInfo(SPELL_SHAMAN, DISC_SHAMAN, DISC_SHAMAN_CONTROL, "voodoo", TASK_NORMAL, LAG_2, POSITION_SITTING, MANA_0, LIFEFORCE_50, PRAY_0, TAR_OBJ_ROOM | TAR_SELF_NONO | TAR_VIOLENT | TAR_FIGHT_VICT , SYMBOL_STRESS_0, "", "", "", "", START_21, LEARN_5, START_DO_20, LEARN_DO_2, START_DO_NO, LEARN_DO_NO, LEARN_DIFF_SPELLS, 0.04, COMP_GESTURAL | COMP_VERBAL | COMP_MATERIAL  | COMP_MATERIAL_END | SPELL_TASKED, 0);

  discArray[SPELL_DANCING_BONES] = new spellInfo(SPELL_SHAMAN, DISC_SHAMAN, DISC_SHAMAN_CONTROL, "dancing bones", TASK_DIFFICULT, LAG_3, POSITION_SITTING, MANA_0, LIFEFORCE_110, PRAY_0, TAR_OBJ_ROOM | TAR_SELF_NONO | TAR_VIOLENT | TAR_FIGHT_VICT , SYMBOL_STRESS_0, "", "", "", "", START_70, LEARN_5, START_DO_30, LEARN_DO_5, START_DO_NO, LEARN_DO_NO, LEARN_DIFF_SPELLS, 0.04, COMP_GESTURAL | COMP_VERBAL | COMP_MATERIAL  | COMP_MATERIAL_END | SPELL_TASKED, 0);

  discArray[SPELL_RESURRECTION] = new spellInfo(SPELL_SHAMAN, DISC_SHAMAN_CONTROL, DISC_SHAMAN_CONTROL, "resurrection", TASK_DANGEROUS, LAG_5, POSITION_SITTING, MANA_0, LIFEFORCE_330, PRAY_0, TAR_OBJ_ROOM | TAR_SELF_NONO | TAR_VIOLENT | TAR_FIGHT_VICT , SYMBOL_STRESS_0, "", "", "", "", START_30, LEARN_5, START_DO_30, LEARN_DO_5, START_DO_NO, LEARN_DO_NO, LEARN_DIFF_SPELLS, 0.04, COMP_GESTURAL | COMP_VERBAL | COMP_MATERIAL  | COMP_MATERIAL_END | SPELL_TASKED, 0);
  ...
  discArray[SPELL_SOUL_TWIST] = new spellInfo(SPELL_SHAMAN, DISC_SHAMAN, DISC_SHAMAN_SKUNK, "soul twister", TASK_NORMAL, LAG_1, POSITION_SITTING, MANA_0, LIFEFORCE_70, PRAY_0, TAR_CHAR_ROOM | TAR_SELF_NONO | TAR_VIOLENT | TAR_FIGHT_VICT , SYMBOL_STRESS_0, "", "", "", "", START_60, LEARN_5, START_DO_40, LEARN_DO_1, START_DO_NO, LEARN_DO_NO, LEARN_DIFF_SPELLS, 0.04, COMP_GESTURAL | COMP_VERBAL | COMP_MATERIAL  | COMP_MATERIAL_END | SPELL_TASKED, 0);
