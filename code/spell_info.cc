...
// disc_shaman
  ...
  discArray[SPELL_VOODOO] = new spellInfo(SPELL_SHAMAN, DISC_SHAMAN, DISC_SHAMAN_CONTROL, "voodoo", TASK_DIFFICULT, LAG_3, POSITION_SITTING, MANA_0, LIFEFORCE_80, PRAY_0, TAR_OBJ_ROOM | TAR_SELF_NONO | TAR_VIOLENT | TAR_FIGHT_VICT , SYMBOL_STRESS_0, "", "", "", "", START_21, LEARN_5, START_DO_20, LEARN_DO_2, START_DO_NO, LEARN_DO_NO, LEARN_DIFF_SPELLS, 0.04, COMP_GESTURAL | COMP_VERBAL | COMP_MATERIAL  | COMP_MATERIAL_END | SPELL_TASKED, 0);
  ...
  discArray[SPELL_RESURRECTION] = new spellInfo(SPELL_SHAMAN, DISC_SHAMAN_CONTROL, DISC_SHAMAN_CONTROL, "resurrection", TASK_DIFFICULT, LAG_3, POSITION_SITTING, MANA_0, LIFEFORCE_200, PRAY_0, TAR_OBJ_ROOM | TAR_SELF_NONO | TAR_VIOLENT | TAR_FIGHT_VICT , SYMBOL_STRESS_0, "", "", "", "", START_30, LEARN_5, START_DO_30, LEARN_DO_5, START_DO_NO, LEARN_DO_NO, LEARN_DIFF_SPELLS, 0.04, COMP_GESTURAL | COMP_VERBAL | COMP_MATERIAL  | COMP_MATERIAL_END | SPELL_TASKED, 0);
