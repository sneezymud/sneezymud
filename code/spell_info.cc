...
// disc_warrior
  ...
  discArray[SKILL_DISARM] = new spellInfo(SKILL_WARRIOR, DISC_WARRIOR, DISC_HTH, "disarm", TASK_DANGEROUS, LAG_2, POSITION_CRAWLING, MANA_0, LIFEFORCE_0, PRAY_0, 0, SYMBOL_STRESS_0, "", "", "", "", START_35, LEARN_3, START_DO_1, LEARN_DO_2, START_DO_NO, LEARN_DO_NO, LEARN_DIFF_SKILLS, 0.0, 0, 0);
...
// disc_theology
  ...
  discArray[SPELL_CLARITY] = new spellInfo(SPELL_SHAMAN, DISC_SHAMAN_SPIDER, DISC_SHAMAN_SPIDER, "clarity", TASK_NORMAL, LAG_1, POSITION_CRAWLING, MANA_0, LIFEFORCE_150, PRAY_0, TAR_CHAR_ROOM | TAR_SELF_ONLY, SYMBOL_STRESS_0, "The green film on your eyes dissolves.", "The green film on $n's eyes dissolves.", "The film in your eyes becomes more transparent.", "", START_10, LEARN_8, START_DO_40, LEARN_DO_5, START_DO_NO, LEARN_DO_NO, LEARN_DIFF_SPELLS, 0.04, COMP_GESTURAL | COMP_GESTURAL_RANDOM | COMP_VERBAL | COMP_VERBAL_RANDOM | COMP_MATERIAL | COMP_MATERIAL_END | SPELL_TASKED, 0);
