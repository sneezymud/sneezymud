...
// disc_theology
  ...
  // psionics
discArray[SKILL_PSITELEPATHY] = new spellInfo(SKILL_GENERAL, DISC_PSIONICS, DISC_PSIONICS, "psionic telepathy", TASK_NORMAL, LAG_0, POSITION_STANDING, MANA_10, LIFEFORCE_0, PRAY_0, 0, SYMBOL_STRESS_0, "", "", "", "", START_1, LEARN_5, START_DO_1, LEARN_DO_1, START_DO_NO, LEARN_DO_NO, LEARN_DIFF_SKILLS, 0.0, 0, 0);
