...
// disc_theology
  ...
  discArray[SPELL_STUPIDITY] = new spellInfo(SPELL_SHAMAN, DISC_SHAMAN, DISC_SHAMAN_SPIDER, "stupidity", TASK_EASY, LAG_2, POSITION_SITTING, MANA_0, LIFEFORCE_30, PRAY_0, TAR|VIOLENT | TAR_FIGHT_VICT | TAR_CHAR_ROOM | TAR_SELF_NONO | TAR_SELF_NONO, SYMBOL_STRESS_0, "You suddenly feel brighter.", "$n seems a little more intelligent than before.", "The fog surrounding you lifts a little.", "The fog surrounding $n lifts a little.", START_15, LEARN_14, START_DO_35, LEARN_DO_7, START_DO_NO, LEARN_DO_NO, LEARN_DIFF_SPELLS, 0.03, COMP_GESTURAL | COMP_GESTURAL_RANDOM | COMP_VERBAL | COMP_VERBAL_RANDOM | COMP_MATERIAL | COMP_MATERIAL_END | SPELL_TASKED, 0);
