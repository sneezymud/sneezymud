...
// disc_theology
  ...
  discArray[SPELL_CACAODEMON] = new spellInfo(SPELL_SHAMAN, DISC_SHAMAN_CONTROL, DISC_SHAMAN_CONTROL, "cacaodemon", TASK_DIFFICULT, LAG_3, POSITION_CRAWLING, MANA_0, LIFEFORCE_0, PRAY_400, TAR_NAME, SYMBOL_STRESS_75, "","", "", "", START_85, LEARN_5, START_DO_30, LEARN_DO_5, START_DO_NO, LEARN_DO_NO, LEARN_DIFF_SPELLS, 0.0, COMP_GESTURAL | COMP_VERBAL , 0);

  discArray[SPELL_CREATE_GOLEM] = new spellInfo(SPELL_SHAMAN, DISC_SHAMAN_CONTROL, DISC_SHAMAN_CONTROL, "create golem", TASK_DANGEROUS, LAG_3, POSITION_CRAWLING, MANA_0, LIFEFORCE_0, PRAY_500, TAR_IGNORE, SYMBOL_STRESS_100, "", "", "", "", START_99, LEARN_1, START_DO_30, LEARN_DO_5, START_DO_NO, LEARN_DO_NO, LEARN_DIFF_SPELLS, 0.0, COMP_GESTURAL | COMP_VERBAL , 0);
