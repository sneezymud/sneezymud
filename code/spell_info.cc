...
// disc_physical
  ...
  discArray[SKILL_DUAL_WIELD] = new spellInfo(SKILL_WARRIOR, DISC_PHYSICAL, DISC_PHYSICAL, "dual wield", TASK_NORMAL, LAG_0, POSITION_CRAWLING, MANA_0, LIFEFORCE_0, PRAY_0, 0, SYMBOL_STRESS_0, "", "", "", "", START_1, LEARN_5, START_DO_1, LEARN_DO_1, START_DO_NO, LEARN_DO_NO, LEARN_DIFF_UNUSUAL, 0.0, 0, 0);
