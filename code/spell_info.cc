...
// disc_theology
  ...
  discArray[SPELL_STUPIDITY] = new spellInfo(SPELL_SHAMAN, DISC_SHAMAN, DISC_SHAMAN_SPIDER, "stupidity", TASK_EASY, LAG_2, POSITION_SITTING, MANA_0, LIFEFORCE_30, PRAY_0, TAR_FIGHT_VICT | TAR_CHAR_ROOM | TAR_SELF_NONO | TAR_SELF_NONO, SYMBOL_STRESS_0, "You suddenly feel brighter.", "$n seems a little more intelligent than before.", "The fog surrounding you lifts a little.", "The fog surrounding $n lifts a little.", START_15, LEARN_14, START_DO_35, LEARN_DO_7, START_DO_NO, LEARN_DO_NO, LEARN_DIFF_SPELLS, 0.03, COMP_GESTURAL | COMP_GESTURAL_RANDOM | COMP_VERBAL | COMP_VERBAL_RANDOM | COMP_MATERIAL | COMP_MATERIAL_END | SPELL_TASKED, 0);
  ...
  discArray[SPELL_ROMBLER] = new spellInfo(SPELL_SHAMAN, DISC_SHAMAN, DISC_SHAMAN, "romble", TASK_NORMAL, LAG_1, POSITION_CRAWLING, MANA_0, LIFEFORCE_20, PRAY_0, TAR_NAME, SYMBOL_STRESS_0, "", "", "", "", START_47, LEARN_15, START_DO_50, LEARN_DO_5, START_DO_NO, LEARN_DO_NO, LEARN_DIFF_SPELLS, 0.04, COMP_GESTURAL | COMP_GESTURAL_RANDOM | COMP_VERBAL | COMP_VERBAL_RANDOM | COMP_MATERIAL | COMP_MATERIAL_END | SPELL_TASKED, 0);
  ...
  discArray[SPELL_ENTHRALL_SPECTRE] = new spellInfo(SPELL_SHAMAN, DISC_SHAMAN, DISC_SHAMAN_CONTROL, "enthrall spectre", TASK_DIFFICULT, LAG_1, POSITION_CRAWLING, MANA_0, LIFEFORCE_70, PRAY_0, TAR_IGNORE, SYMBOL_STRESS_0, "", "", "", "", START_35, LEARN_15, START_DO_50, LEARN_DO_5, START_DO_NO, LEARN_DO_NO, LEARN_DIFF_SPELLS, 0.00, COMP_GESTURAL | COMP_GESTURAL_RANDOM | COMP_VERBAL | COMP_VERBAL_RANDOM | COMP_MATERIAL | COMP_MATERIAL_END | SPELL_TASKED, 0);

  discArray[SPELL_ENTHRALL_GHAST] = new spellInfo(SPELL_SHAMAN, DISC_SHAMAN, DISC_SHAMAN_CONTROL, "enthrall ghast", TASK_DIFFICULT, LAG_1, POSITION_CRAWLING, MANA_0, LIFEFORCE_90, PRAY_0, TAR_IGNORE, SYMBOL_STRESS_0, "", "", "", "", START_57, LEARN_13, START_DO_50, LEARN_DO_5, START_DO_NO, LEARN_DO_NO, LEARN_DIFF_SPELLS, 0.0, COMP_GESTURAL | COMP_GESTURAL_RANDOM | COMP_VERBAL | COMP_VERBAL_RANDOM | COMP_MATERIAL | COMP_MATERIAL_END | SPELL_TASKED, 0);
  ...
  discArray[SPELL_CREATE_ROCK_GOLEM] = new spellInfo(SPELL_SHAMAN, DISC_SHAMAN_CONTROL, DISC_SHAMAN_CONTROL, "create rock golem", TASK_DIFFICULT, LAG_1, POSITION_CRAWLING, MANA_0, LIFEFORCE_190, PRAY_0, TAR_IGNORE, SYMBOL_STRESS_0, "", "", "", "", START_70, LEARN_10, START_DO_50, LEARN_DO_5, START_DO_NO, LEARN_DO_NO, LEARN_DIFF_SPELLS, 0.0, COMP_GESTURAL | COMP_GESTURAL_RANDOM | COMP_VERBAL | COMP_VERBAL_RANDOM | COMP_MATERIAL | COMP_MATERIAL_END | SPELL_TASKED, 0);

  discArray[SPELL_CREATE_IRON_GOLEM] = new spellInfo(SPELL_SHAMAN, DISC_SHAMAN_CONTROL, DISC_SHAMAN_CONTROL, "create iron golem", TASK_DIFFICULT, LAG_1, POSITION_CRAWLING, MANA_0, LIFEFORCE_190, PRAY_0, TAR_IGNORE, SYMBOL_STRESS_0, "", "", "", "", START_75, LEARN_10, START_DO_50, LEARN_DO_5, START_DO_NO, LEARN_DO_NO, LEARN_DIFF_SPELLS, 0.0, COMP_GESTURAL | COMP_GESTURAL_RANDOM | COMP_VERBAL | COMP_VERBAL_RANDOM | COMP_MATERIAL | COMP_MATERIAL_END | SPELL_TASKED, 0);

  discArray[SPELL_CREATE_DIAMOND_GOLEM] = new spellInfo(SPELL_SHAMAN, DISC_SHAMAN_CONTROL, DISC_SHAMAN_CONTROL, "create diamond golem", TASK_DIFFICULT, LAG_1, POSITION_CRAWLING, MANA_0, LIFEFORCE_210, PRAY_0, TAR_IGNORE, SYMBOL_STRESS_0, "", "", "", "", START_85, LEARN_10, START_DO_50, LEARN_DO_5, START_DO_NO, LEARN_DO_NO, LEARN_DIFF_SPELLS, 0.0, COMP_GESTURAL | COMP_GESTURAL_RANDOM | COMP_VERBAL | COMP_VERBAL_RANDOM | COMP_MATERIAL | COMP_MATERIAL_END | SPELL_TASKED, 0);
  ...
  discArray[SPELL_CONTROL_UNDEAD] = new spellInfo(SPELL_SHAMAN, DISC_SHAMAN_SPIDER, DISC_SHAMAN_SPIDER, "control undead", TASK_DANGEROUS, LAG_1, POSITION_CRAWLING, MANA_0, LIFEFORCE_240, PRAY_0, TAR_CHAR_ROOM | TAR_SELF_NONO, SYMBOL_STRESS_0, "", "", "", "", START_86, LEARN_5, START_DO_30, LEARN_DO_3, START_DO_NO, LEARN_DO_NO, LEARN_DIFF_SPELLS, 0.04, COMP_GESTURAL | COMP_GESTURAL_RANDOM | COMP_VERBAL | COMP_VERBAL_RANDOM | COMP_MATERIAL | COMP_MATERIAL_END | SPELL_TASKED, 0);
  ...
  discArray[SKILL_TURN] = new spellInfo(SKILL_SHAMAN, DISC_SHAMAN_SKUNK, DISC_SHAMAN_SKUNK, "turn", TASK_NORMAL, LAG_3, POSITION_STANDING, MANA_0, LIFEFORCE_0, PRAY_0, 0, SYMBOL_STRESS_0, "", "", "", "", START_99, LEARN_5, START_DO_1, LEARN_DO_1, START_DO_NO, LEARN_DO_NO, LEARN_DIFF_SKILLS, 0.0, 0, 0);


  // shaman armadillo

  discArray[SPELL_CELERITE] = new spellInfo(SPELL_SHAMAN, DISC_SHAMAN_ARMADILLO, DISC_SHAMAN_ARMADILLO, "celerite", TASK_DIFFICULT, LAG_2, POSITION_CRAWLING, MANA_0, LIFEFORCE_260, PRAY_0, TAR_SELF_ONLY | TAR_FIGHT_SELF | TAR_CHAR_ROOM, SYMBOL_STRESS_0, "You dont seem to be as protected as you once were.", "$n seems to be slowing down.", "", "", START_30, LEARN_5, START_DO_40, LEARN_DO_5, START_DO_NO, LEARN_DO_NO, LEARN_DIFF_SPELLS, 0.04, COMP_GESTURAL | COMP_GESTURAL_RANDOM | COMP_VERBAL | COMP_VERBAL_RANDOM | COMP_MATERIAL | COMP_MATERIAL_END |SPELL_TASKED, 0);
