...
// disc_advanced_adventuring
  ...
  discArray[SKILL_TROLLISH] = new spellInfo(SKILL_GENERAL, DISC_ADVANCED_ADVENTURING, DISC_ADVANCED_ADVENTURING, "trollish", TASK_NORMAL, LAG_0, POSITION_SITTING, MANA_0, LIFEFORCE_0, PRAY_0, 0, SYMBOL_STRESS_0, "", "", "", "", START_55, LEARN_2, START_DO_25, LEARN_DO_1, START_DO_NO, LEARN_DO_NO, LEARN_DIFF_SKILLS, 0.0, 0, 0);

  discArray[SKILL_BULLYWUG] = new spellInfo(SKILL_GENERAL, DISC_ADVANCED_ADVENTURING, DISC_ADVANCED_ADVENTURING, "bullywug", TASK_NORMAL, LAG_0, POSITION_SITTING, MANA_0, LIFEFORCE_0, PRAY_0, 0, SYMBOL_STRESS_0, "", "", "", "", START_55, LEARN_2, START_DO_25, LEARN_DO_1, START_DO_NO, LEARN_DO_NO, LEARN_DIFF_SKILLS, 0.0, 0, 0);

  discArray[SKILL_AVIAN] = new spellInfo(SKILL_GENERAL, DISC_ADVANCED_ADVENTURING, DISC_ADVANCED_ADVENTURING, "avian", TASK_NORMAL, LAG_0, POSITION_SITTING, MANA_0, LIFEFORCE_0, PRAY_0, 0, SYMBOL_STRESS_0, "", "", "", "", START_55, LEARN_2, START_DO_25, LEARN_DO_1, START_DO_NO, LEARN_DO_NO, LEARN_DIFF_SKILLS, 0.0, 0, 0);

  discArray[SKILL_KALYSIAN] = new spellInfo(SKILL_GENERAL, DISC_ADVANCED_ADVENTURING, DISC_ADVANCED_ADVENTURING, "kalysian", TASK_NORMAL, LAG_0, POSITION_SITTING, MANA_0, LIFEFORCE_0, PRAY_0, 0, SYMBOL_STRESS_0, "", "", "", "", START_55, LEARN_2, START_DO_25, LEARN_DO_1, START_DO_NO, LEARN_DO_NO, LEARN_DIFF_SKILLS, 0.0, 0, 0);
