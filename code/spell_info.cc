...
// disc_theology
  ...
  discArray[SPELL_STORMY_SKIES] = new spellInfo(SPELL_SHAMAN, DISC_SHAMAN_FROG, DISC_SHAMAN_FROG, "stormy skies", TASK_NORMAL, LAG_3, POSITION_SITTING, MANA_0, LIFEFORCE_200, PRAY_0, TAR_CHAR_ROOM, SYMBOL_STRESS_0, "", "", "", "", START_33, LEARN_3, START_DO_40, LEARN_DO_5, START_DO_NO, LEARN_DO_NO, LEARN_DIFF_SPELLS, 0.04, COMP_GESTURAL | COMP_VERBAL | COMP_MATERIAL, 0);
  ...
  discArray[SPELL_AQUATIC_BLAST] = new spellInfo(SPELL_SHAMAN, DISC_SHAMAN_FROG, DISC_SHAMAN_FROG, "aquatic blast", TASK_DANGEROUS, LAG_4, POSITION_SITTING, MANA_0, LIFEFORCE_230, PRAY_0, TAR_CHAR_ROOM | TAR_SELF_NONO | TAR_VIOLENT | TAR_FIGHT_VICT , SYMBOL_STRESS_0, "", "", "", "", START_55, LEARN_20, START_DO_40, LEARN_DO_5, START_DO_NO, LEARN_DO_NO, LEARN_DIFF_SPELLS, 0.05, COMP_GESTURAL | COMP_GESTURAL_RANDOM | COMP_VERBAL | COMP_VERBAL_RANDOM | COMP_MATERIAL | COMP_MATERIAL_END | SPELL_TASKED, 0);
