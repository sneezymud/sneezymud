...
// disc_theology
  ...
  discArray[SPELL_CONTROL_UNDEAD] = new spellInfo(SPELL_SHAMAN, DISC_SHAMAN_SPIDER, DISC_SHAMAN_SPIDER, "control undead", TASK_DANGEROUS, LAG_3, POSITION_CRAWLING, MANA_0, LIFEFORCE_0, PRAY_150, TAR_CHAR_ROOM, SYMBOL_STRESS_45, "", "", "", "", START_86, LEARN_5, START_DO_30, LEARN_DO_3, START_DO_NO, LEARN_DO_NO, LEARN_DIFF_SPELLS, 0.0, COMP_GESTURAL | COMP_VERBAL, 0);
