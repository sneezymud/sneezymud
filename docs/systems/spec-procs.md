...
keywords: [spec procs, special procedures, mob_specials, objSpecials, roomSpecials, CMD_GENERIC_PULSE, CMD_GENERIC_QUICK_PULSE, act_ptr, swapToStrung, DELETE_THIS, DELETE_VICT, triggerSpecial, checkSpec]
